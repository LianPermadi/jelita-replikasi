...
class Jdih extends CI_Controller
{
    ...
    {   
         ...
         $data["jdih"] = $this->jdih_model->getAll();
         //$data["test"] = $this->jdih_model->get_kategori(5);
         //var_dump($data["test"]);die();
        $this->load->view("v_jdih/index", $data);
    }
    public function detail_jdih($id){
        $data["detailjdih"] = $this->jdih_model->getdetail_jdih($id);
        $this->load->view("v_jdih/v_detailjdih", $data);
    }

    public function kategori($id){
        $data["jdih"] = $this->jdih_model->getfilterkategori($id);
         $this->load->view("v_jdih/index", $data);
    }

    public function download($id){
        $jdih = $this->jdih_model->getdetail_jdih2($id);
    //var_dump($pajak);die();
  //  $nip = $jdih->nip;
    ...
    force_download($this->jdih_model->get_kategori($jdih->kategori)." Nomor ".$jdih->nomor. " Tahun ".$jdih->tahun.".pdf", $data);
    }

    public function downloadabstrak($id){
            $jdih = $this->jdih_model->getdetail_jdih2($id);
        $file = "ABSTRAK_".$id;
