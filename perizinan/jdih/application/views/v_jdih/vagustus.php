                    ...
                    <div class="row">
                        <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                            <div class="page-header text-center">
                                ...
                                <h3 class="pageheader-title">(s.d 30 Agustus 2021)</h3>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php $coba = ($dpa_seluruhagustus->real_total/$dpa_seluruhagustus->dpa_total)*100; ?>
                                                    ...
                                                    <tr>                                                 
                                                        ...
                                                        <th><?php echo "Rp" . number_format($dpa_seluruhagustus->dpa_total,0,',','.'); ?></th>
                                                        <th><?php echo  "Rp" . number_format($dpa_seluruhagustus->real_total,0,',','.'); ?></th>
                                                        <th><?php echo round($coba,2); ?></td>
                                                        <th><?php echo  "Rp" . number_format($dpa_seluruhagustus->sisa_total,0,',','.'); ?></th>
                                                        <th></th>
                                                    </tr>
                                                ...
                                                <tbody>
                                                    <tr>
                                                      <?php foreach ($sekretariatagustus as $sekretariat): ?>
                                                ...
                                                <?php $psek = ($dpa_sekreagustus->realisasi_sekre/$dpa_sekreagustus->dpa_sekre)*100; ?>
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        ...
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_sekreagustus->dpa_sekre,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_sekreagustus->realisasi_sekre,0,',','.'); ?></th>
                                                        <th class="border-0" id="psek"><?php echo round($psek,2);?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_sekreagustus->sisa_sekre,0,',','.'); ?></th>
                                                        <th class="border-0" align="text-center"></th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody>
                                                    <tr>
                                                      <?php foreach ($bangpromagustus as $bangprom): ?>
                                                ...
                                                <?php $pbang = ($dpa_bangpromagustus->realisasi_bangprom/$dpa_bangpromagustus->dpa_bangprom)*100; ?>
                                                 <thead class="bg-light">
                                                    <tr class="border-0">
                                                        <th class="border-0" align="text-center"></th>
                                                        <th  class="border-0" align="text-center"></th>
                                                        ...
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_bangpromagustus->dpa_bangprom,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_bangpromagustus->realisasi_bangprom,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo round($pbang,2); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_bangpromagustus->sisa_bangprom,0,',','.'); ?></th>
                                                        <th class="border-0" align="text-center"></th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody>
                                                    <tr>
                                                      <?php foreach ($esdaagustus as $esda): ?>
                                                ...
                                                <?php $pesda = ($dpa_esdaagustus->realisasi_esda/$dpa_esdaagustus->dpa_esda)*100; ?>
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                         <th class="border-0" align="text-center"></th>
                                                        <th  class="border-0" align="text-center"></th>
                                                        ...
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_esdaagustus->dpa_esda,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_esdaagustus->realisasi_esda,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo round($pesda,2); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_esdaagustus->sisa_esda,0,',','.'); ?></th>
                                                        <th class="border-0" align="text-center"></th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody>
                                                    <tr>
                                                      <?php foreach ($pengendalianagustus as $pengendalian): ?>
                                                ...
                                                <?php $pdal = ($dpa_pengendalianagustus->realisasi_pengendalian/$dpa_pengendalianagustus->dpa_pengendalian)*100; ?>
                                                 <thead class="bg-light">
                                                    <tr class="border-0">
                                                        <th class="border-0" align="text-center"></th>
                                                        <th  class="border-0" align="text-center"></th>
                                                        ...
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_pengendalianagustus->dpa_pengendalian,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_pengendalianagustus->realisasi_pengendalian,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo round($pdal,2); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_pengendalianagustus->sisa_pengendalian,0,',','.'); ?></th>
                                                        <th class="border-0" align="text-center"></th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody>
                                                    <tr>
                                                      <?php foreach ($datinagustus as $datin): ?>
                                                ...
                                                <?php $pdatin = ($dpa_datinagustus->realisasi_datin/$dpa_datinagustus->dpa_datin)*100; ?>
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        <th class="border-0" align="text-center"></th>
                                                        <th  class="border-0" align="text-center"></th>
                                                        ...
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_datinagustus->dpa_datin,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_datinagustus->realisasi_datin,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo round($pdatin,2); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_datinagustus->sisa_datin,0,',','.'); ?></th>
                                                        <th class="border-0" align="text-center"></th>
                                                    </tr>
                                                </thead>

                                                <?php $ptotal = ($realisasi_gaji+$dpa_seluruhagustus->real_total)/($jumlah_gaji+$dpa_seluruhagustus->dpa_total)*100; ?>
                                                <tbody>
                                                    <tr>                                                 
                                                        <th colspan="4">JUMLAH TOTAL</th>
                                                        
                                                        <th><?php echo  "Rp" . number_format($jumlah_gaji+$dpa_seluruhagustus->dpa_total,0,',','.'); ?></th>
                                                        <th><?php echo  "Rp" . number_format($realisasi_gaji+$dpa_seluruhagustus->real_total,0,',','.'); ?></th>
                                                        <th><?php echo round($ptotal,2); ?></td>
                                                        <th><?php echo  "Rp" . number_format(($jumlah_gaji-$realisasi_gaji)+$dpa_seluruhagustus->sisa_total,0,',','.'); ?></th>
                                                        <th></th>
                                                    </tr>
                                                </tbody>
