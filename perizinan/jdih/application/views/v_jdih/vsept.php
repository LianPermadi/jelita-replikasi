                    ...
                    <div class="row">
                        <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                            <div class="page-header text-center">
                                ...
                                <h3 class="pageheader-title">(s.d 24 September 2021)</h3>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php $coba = ($dpa_seluruhSeptember->real_total/$dpa_seluruhSeptember->dpa_total)*100; ?>
                                                    ...
                                                    <tr>                                                 
                                                        ...
                                                        <th><?php echo "Rp" . number_format($dpa_seluruhSeptember->dpa_total,0,',','.'); ?></th>
                                                        <th><?php echo  "Rp" . number_format($dpa_seluruhSeptember->real_total,0,',','.'); ?></th>
                                                        <th><?php echo round($coba,2); ?></td>
                                                        <th><?php echo  "Rp" . number_format($dpa_seluruhSeptember->sisa_total,0,',','.'); ?></th>
                                                        <th></th>
                                                    </tr>
                                                ...
                                                <tbody>
                                                    <tr>
                                                      <?php foreach ($sekretariatSeptember as $sekretariat): ?>
                                                ...
                                                <?php $psek = ($dpa_sekreSeptember->realisasi_sekre/$dpa_sekreSeptember->dpa_sekre)*100; ?>
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        ...
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_sekreSeptember->dpa_sekre,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_sekreSeptember->realisasi_sekre,0,',','.'); ?></th>
                                                        <th class="border-0" id="psek"><?php echo round($psek,2);?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_sekreSeptember->sisa_sekre,0,',','.'); ?></th>
                                                        <th class="border-0" align="text-center"></th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody>
                                                    <tr>
                                                      <?php foreach ($bangpromSeptember as $bangprom): ?>
                                                ...
                                                <?php $pbang = ($dpa_bangpromSeptember->realisasi_bangprom/$dpa_bangpromSeptember->dpa_bangprom)*100; ?>
                                                 <thead class="bg-light">
                                                    <tr class="border-0">
                                                        <th class="border-0" align="text-center"></th>
                                                        <th  class="border-0" align="text-center"></th>
                                                        ...
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_bangpromSeptember->dpa_bangprom,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_bangpromSeptember->realisasi_bangprom,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo round($pbang,2); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_bangpromSeptember->sisa_bangprom,0,',','.'); ?></th>
                                                        <th class="border-0" align="text-center"></th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody>
                                                    <tr>
                                                      <?php foreach ($esdaSeptember as $esda): ?>
                                                ...
                                                <?php $pesda = ($dpa_esdaSeptember->realisasi_esda/$dpa_esdaSeptember->dpa_esda)*100; ?>
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                         <th class="border-0" align="text-center"></th>
                                                        <th  class="border-0" align="text-center"></th>
                                                        ...
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_esdaSeptember->dpa_esda,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_esdaSeptember->realisasi_esda,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo round($pesda,2); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_esdaSeptember->sisa_esda,0,',','.'); ?></th>
                                                        <th class="border-0" align="text-center"></th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody>
                                                    <tr>
                                                      <?php foreach ($pengendalianSeptember as $pengendalian): ?>
                                                ...
                                                <?php $pdal = ($dpa_pengendalianSeptember->realisasi_pengendalian/$dpa_pengendalianSeptember->dpa_pengendalian)*100; ?>
                                                 <thead class="bg-light">
                                                    <tr class="border-0">
                                                        <th class="border-0" align="text-center"></th>
                                                        <th  class="border-0" align="text-center"></th>
                                                        ...
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_pengendalianSeptember->dpa_pengendalian,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_pengendalianSeptember->realisasi_pengendalian,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo round($pdal,2); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_pengendalianSeptember->sisa_pengendalian,0,',','.'); ?></th>
                                                        <th class="border-0" align="text-center"></th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody>
                                                    <tr>
                                                      <?php foreach ($datinSeptember as $datin): ?>
                                                ...
                                                <?php $pdatin = ($dpa_datinSeptember->realisasi_datin/$dpa_datinSeptember->dpa_datin)*100; ?>
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        <th class="border-0" align="text-center"></th>
                                                        <th  class="border-0" align="text-center"></th>
                                                        ...
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_datinSeptember->dpa_datin,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_datinSeptember->realisasi_datin,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo round($pdatin,2); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_datinSeptember->sisa_datin,0,',','.'); ?></th>
                                                        <th class="border-0" align="text-center"></th>
                                                    </tr>
                                                </thead>

                                                <?php $ptotal = ($realisasi_gaji+$dpa_seluruhSeptember->real_total)/($jumlah_gaji+$dpa_seluruhSeptember->dpa_total)*100; ?>
                                                <tbody>
                                                    <tr>                                                 
                                                        <th colspan="4">JUMLAH TOTAL</th>
                                                        
                                                        <th><?php echo  "Rp" . number_format($jumlah_gaji+$dpa_seluruhSeptember->dpa_total,0,',','.'); ?></th>
                                                        <th><?php echo  "Rp" . number_format($realisasi_gaji+$dpa_seluruhSeptember->real_total,0,',','.'); ?></th>
                                                        <th><?php echo round($ptotal,2); ?></td>
                                                        <th><?php echo  "Rp" . number_format(($jumlah_gaji-$realisasi_gaji)+$dpa_seluruhSeptember->sisa_total,0,',','.'); ?></th>
                                                        <th></th>
                                                    </tr>
                                                </tbody>
