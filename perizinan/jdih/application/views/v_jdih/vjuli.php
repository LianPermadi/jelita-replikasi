                    ...
                    <div class="row">
                        <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                            <div class="page-header text-center">
                                ...
                                <h3 class="pageheader-title">(s.d 30 Juli 2021)</h3>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php $coba = ($dpa_seluruhjuli->real_total/$dpa_seluruhjuli->dpa_total)*100; ?>
                                                    ...
                                                    <tr>                                                 
                                                        ...
                                                        <th><?php echo "Rp" . number_format($dpa_seluruhjuli->dpa_total,0,',','.'); ?></th>
                                                        <th><?php echo  "Rp" . number_format($dpa_seluruhjuli->real_total,0,',','.'); ?></th>
                                                        <th><?php echo round($coba,2); ?></td>
                                                        <th><?php echo  "Rp" . number_format($dpa_seluruhjuli->sisa_total,0,',','.'); ?></th>
                                                        <th></th>
                                                    </tr>
                                                ...
                                                <tbody>
                                                    <tr>
                                                      <?php foreach ($sekretariatjuli as $sekretariat): ?>
                                                ...
                                                <?php $psek = ($dpa_sekrejuli->realisasi_sekre/$dpa_sekrejuli->dpa_sekre)*100; ?>
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        ...
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_sekrejuli->dpa_sekre,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_sekrejuli->realisasi_sekre,0,',','.'); ?></th>
                                                        <th class="border-0" id="psek"><?php echo round($psek,2);?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_sekrejuli->sisa_sekre,0,',','.'); ?></th>
                                                        <th class="border-0" align="text-center"></th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody>
                                                    <tr>
                                                      <?php foreach ($bangpromjuli as $bangprom): ?>
                                                ...
                                                <?php $pbang = ($dpa_bangpromjuli->realisasi_bangprom/$dpa_bangpromjuli->dpa_bangprom)*100; ?>
                                                 <thead class="bg-light">
                                                    <tr class="border-0">
                                                        <th class="border-0" align="text-center"></th>
                                                        <th  class="border-0" align="text-center"></th>
                                                        ...
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_bangpromjuli->dpa_bangprom,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_bangpromjuli->realisasi_bangprom,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo round($pbang,2); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_bangpromjuli->sisa_bangprom,0,',','.'); ?></th>
                                                        <th class="border-0" align="text-center"></th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <?php $pesda = ($dpa_esdajuli->realisasi_esda/$dpa_esdajuli->dpa_esda)*100; ?>
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                         <th class="border-0" align="text-center"></th>
                                                        <th  class="border-0" align="text-center"></th>
                                                        ...
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_esdajuli->dpa_esda,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_esdajuli->realisasi_esda,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo round($pesda,2); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_esdajuli->sisa_esda,0,',','.'); ?></th>
                                                        <th class="border-0" align="text-center"></th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody>
                                                    <tr>
                                                      <?php foreach ($pengendalianjuli as $pengendalian): ?>
                                                ...
                                                <?php $pdal = ($dpa_pengendalianjuli->realisasi_pengendalian/$dpa_pengendalianjuli->dpa_pengendalian)*100; ?>
                                                 <thead class="bg-light">
                                                    <tr class="border-0">
                                                        <th class="border-0" align="text-center"></th>
                                                        <th  class="border-0" align="text-center"></th>
                                                        ...
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_pengendalianjuli->dpa_pengendalian,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_pengendalianjuli->realisasi_pengendalian,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo round($pdal,2); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_pengendalianjuli->sisa_pengendalian,0,',','.'); ?></th>
                                                        <th class="border-0" align="text-center"></th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody>
                                                    <tr>
                                                      <?php foreach ($datinjuli as $datin): ?>
                                                ...
                                                <?php $pdatin = ($dpa_datinjuli->realisasi_datin/$dpa_datinjuli->dpa_datin)*100; ?>
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        <th class="border-0" align="text-center"></th>
                                                        <th  class="border-0" align="text-center"></th>
                                                        ...
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_datinjuli->dpa_datin,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_datinjuli->realisasi_datin,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo round($pdatin,2); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_datinjuli->sisa_datin,0,',','.'); ?></th>
                                                        <th class="border-0" align="text-center"></th>
                                                    </tr>
                                                </thead>

                                                <?php $ptotal = ($realisasi_gaji+$dpa_seluruhjuli->real_total)/($jumlah_gaji+$dpa_seluruhjuli->dpa_total)*100; ?>
                                                <tbody>
                                                    <tr>                                                 
                                                        <th colspan="4">JUMLAH TOTAL</th>
                                                        
                                                        <th><?php echo  "Rp" . number_format($jumlah_gaji+$dpa_seluruhjuli->dpa_total,0,',','.'); ?></th>
                                                        <th><?php echo  "Rp" . number_format($realisasi_gaji+$dpa_seluruhjuli->real_total,0,',','.'); ?></th>
                                                        <th><?php echo round($ptotal,2); ?></td>
                                                        <th><?php echo  "Rp" . number_format(($jumlah_gaji-$realisasi_gaji)+$dpa_seluruhjuli->sisa_total,0,',','.'); ?></th>
                                                        <th></th>
                                                    </tr>
                                                </tbody>
