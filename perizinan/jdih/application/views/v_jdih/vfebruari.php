                    ...
                    <div class="row">
                        <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                            <div class="page-header text-center">
                                ...
                                <h3 class="pageheader-title">(s.d 26 Februari 2021)</h3>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php $coba = ($dpa_seluruhfeb->real_total/$dpa_seluruhfeb->dpa_total)*100; ?>
                                                    ...
                                                    <tr>                                                 
                                                        ...
                                                        <th><?php echo "Rp" . number_format($dpa_seluruhfeb->dpa_total,0,',','.'); ?></th>
                                                        <th><?php echo  "Rp" . number_format($dpa_seluruhfeb->real_total,0,',','.'); ?></th>
                                                        <th><?php echo round($coba,2); ?></td>
                                                        <th><?php echo  "Rp" . number_format($dpa_seluruhfeb->sisa_total,0,',','.'); ?></th>
                                                        <th></th>
                                                    </tr>
                                                ...
                                                <tbody>
                                                    <tr>
                                                      <?php foreach ($sekretariatfeb as $sekretariat): ?>
                                                ...
                                                <?php $psek = ($dpa_sekrefeb->realisasi_sekre/$dpa_sekrefeb->dpa_sekre)*100; ?>
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        ...
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_sekrefeb->dpa_sekre,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_sekrefeb->realisasi_sekre,0,',','.'); ?></th>
                                                        <th class="border-0" id="psek"><?php echo round($psek,2);?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_sekrefeb->sisa_sekre,0,',','.'); ?></th>
                                                        <th class="border-0" align="text-center"></th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody>
                                                    <tr>
                                                      <?php foreach ($bangpromfeb as $bangprom): ?>
                                                ...
                                                <?php $pbang = ($dpa_bangpromfeb->realisasi_bangprom/$dpa_bangpromfeb->dpa_bangprom)*100; ?>
                                                 <thead class="bg-light">
                                                    <tr class="border-0">
                                                        <th class="border-0" align="text-center"></th>
                                                        <th  class="border-0" align="text-center"></th>
                                                        ...
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_bangpromfeb->dpa_bangprom,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_bangpromfeb->realisasi_bangprom,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo round($pbang,2); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_bangpromfeb->sisa_bangprom,0,',','.'); ?></th>
                                                        <th class="border-0" align="text-center"></th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <?php $pesda = ($dpa_esdafeb->realisasi_esda/$dpa_esdafeb->dpa_esda)*100; ?>
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                         <th class="border-0" align="text-center"></th>
                                                        <th  class="border-0" align="text-center"></th>
                                                        ...
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_esdafeb->dpa_esda,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_esdafeb->realisasi_esda,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo round($pesda,2); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_esdafeb->sisa_esda,0,',','.'); ?></th>
                                                        <th class="border-0" align="text-center"></th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody>
                                                    <tr>
                                                      <?php foreach ($pengendalianfeb as $pengendalian): ?>
                                                ...
                                                <?php $pdal = ($dpa_pengendalianfeb->realisasi_pengendalian/$dpa_pengendalianfeb->dpa_pengendalian)*100; ?>
                                                 <thead class="bg-light">
                                                    <tr class="border-0">
                                                        <th class="border-0" align="text-center"></th>
                                                        <th  class="border-0" align="text-center"></th>
                                                        ...
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_pengendalianfeb->dpa_pengendalian,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_pengendalianfeb->realisasi_pengendalian,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo round($pdal,2); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_pengendalianfeb->sisa_pengendalian,0,',','.'); ?></th>
                                                        <th class="border-0" align="text-center"></th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <?php $pdatin = ($dpa_datinfeb->realisasi_datin/$dpa_datinfeb->dpa_datin)*100; ?>
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        <th class="border-0" align="text-center"></th>
                                                        <th  class="border-0" align="text-center"></th>
                                                        ...
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_datinfeb->dpa_datin,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_datinfeb->realisasi_datin,0,',','.'); ?></th>
                                                        <th class="border-0"><?php echo round($pdatin,2); ?></th>
                                                        <th class="border-0"><?php echo "Rp" . number_format($dpa_datinfeb->sisa_datin,0,',','.'); ?></th>
                                                        <th class="border-0" align="text-center"></th>
                                                    </tr>
                                                </thead>

                                                <?php $ptotal = ($realisasi_gaji+$dpa_seluruhfeb->real_total)/($jumlah_gaji+$dpa_seluruhfeb->dpa_total)*100; ?>
                                                <tbody>
                                                    <tr>                                                 
                                                        <th colspan="4">JUMLAH TOTAL</th>
                                                        
                                                        <th><?php echo  "Rp" . number_format($jumlah_gaji+$dpa_seluruhfeb->dpa_total,0,',','.'); ?></th>
                                                        <th><?php echo  "Rp" . number_format($realisasi_gaji+$dpa_seluruhfeb->real_total,0,',','.'); ?></th>
                                                        <th><?php echo round($ptotal,2); ?></td>
                                                        <th><?php echo  "Rp" . number_format(($jumlah_gaji-$realisasi_gaji)+$dpa_seluruhfeb->sisa_total,0,',','.'); ?></th>
                                                        <th></th>
                                                    </tr>
                                                </tbody>
