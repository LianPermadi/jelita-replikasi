...
|
*/
// $config['base_url'] = 'https://dpmptsp.jabarprov.go.id/kehadiran/';
...
*/
$config['uri_protocol']	= 'REQUEST_URI';// File: application/config/config.php
$config['openai_api_key'] = 'sk-proj-vQAA8ZGMkBxRa4yL6z7WT3BlbkFJEpdgC13EwDI9OeL5mhe3';
// $config['openai_api_key'] = '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';
