...
<html>
  ...
  center: new google.maps.LatLng(-1.336115, 133.174716),
  zoom: 15,
  draggable:true,
  styles:
      ...
      var marker1 = createMarker({
        position: new google.maps.LatLng(-1.336115, 133.174716),
        draggable:true,
        map: map
      });
  ...
  <body>
   ...
   <img src="<?php echo base_url(). 'assets/ajax-loader.gif' ?>" alt="Harap Tunggu..." />
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
      ...
      <div class="attribution">Copyright © 2015 DPMPTSP Kabupaten Cirebon</div>
    </div><!--/.sidebar-->
    <link rel="stylesheet" type="text/css" href="<?php echo $base_urls;?>/dt/css/dt/jquery.dataTables.min.css">
    <script src="<?php echo $base_urls;?>/dt/js/dt/jquery.dataTables.min.js"></script>
    <!-- Main Content -->	
