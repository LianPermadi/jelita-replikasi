  ...
  <body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
      <ul class="nav menu">
        ...
        <li><?php echo anchor('main/user/history', '<span class="glyphicon glyphicon-list-alt"></span> History Permohonan</a>') ?></li>
        <li><?php echo anchor('main/formulir/step1', '<span class="glyphicon glyphicon-list-alt"></span> Download Formulir</a>') ?></li>
      </ul>
