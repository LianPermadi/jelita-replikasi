    ...
    if($cp_as == $cp_kt){
      ...
      if($this->db->insert('tm_pemohon', $data)){
        ...
        if($this->kdmail == 1){
          ...
          $isi .= "<p>".$token."</p>";
          $isi .= "<p>Silahkan Masukkan Nomor Token Anda Pada Halaman Berikut : <a href='dpmptsp.jabarprov.go.id/sicantik/main/pendaftaranbaru/konfirm'>Verifikasi          Permohonan Proposal</a></p>";
          $isi .= "<p>Terima kasih atas perhatiannya<br>- DPMPTSP JAWA BARAT</p>";
          $isi .= "<br><p><small>Harap jangan membalas e-mail ini, karena e-mail ini dikirimkan secara otomatis oleh sistem.</small></p>";
          $mailer->Body = $isi;
          $mailer->AltBody = $isi;
    ...
    if(count($query)==0){
      ...
      if(count($query)==1){
        ...
        if($this->kdmail == 1){			    
          ...
          $isi .= "<p>Silahkan Login Untuk Melengkapi Data anda, <a href='dpmptsp.jabarprov.go.id/sicantik/main/login'>Login Disini</a></p>";
          $isi .= "<p>Terima kasih atas perhatiannya<br>- DPMPTSP JAWA BARAT</p>";
          $isi .= "<br><p><small>Harap jangan membalas e-mail ini, karena e-mail ini dikirimkan secara otomatis oleh sistem.</small></p>";
          $mailer->Body = $isi;
          $mailer->AltBody = $isi;
