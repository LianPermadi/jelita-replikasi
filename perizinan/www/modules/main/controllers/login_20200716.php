...
class Login extends MY_Controller {
  ...
  //       $password         	= "~jabarjuara2019";
		...
		$mailer->Subject = 'Reset Password DPMPTSP Jawa Barat';
		  ...
		  $isi .= "<p><a href='https://dpmptsp.jabarprov.go.id/sicantik/main/login/reset/".$query->uuid_perusahaan."'>Reset Password</a></p>";
		  $isi .= "<p>Jika link tidak bisa di klik, silahkan copy paste link berikut untuk mereset password anda : https://dpmptsp.jabarprov.go.id/sicantik/main/login/reset/".$query->uuid_perusahaan."</p>";
