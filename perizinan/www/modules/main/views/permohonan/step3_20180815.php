                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      ...
                      if($array[9]=="TextBox"){ ?>
                        ...
                        <input class="form-control" name="var_teknis<?php echo $array[0]; ?>" value="<?php echo $dt_teknis1; ?>" autocomplete="off"><br>
                        <?php
                      }else{
                        if($array[9]=="Integer"){ ?>
                          ...
                          <input class="form-control numberonly" name="var_teknis<?php echo $array[0]; ?>" value="<?php echo $dt_teknis1; ?>" autocomplete="off"><br>
                          <?php
                        }else{
                          if($array[9]=="ComboBox"){ 
                            ...
                            if($array[9]=="Tanggal"){ ?>
                              ...
                              <input class="form-control datepicker" name="var_teknis<?php echo $array[0]; ?>" value="<?php echo $dt_teknis1; ?>" autocomplete="off"><br>
                              <?php
                            }else{ ?>
                              <?php echo $array[9];?>
                              <?php
