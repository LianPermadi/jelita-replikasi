              ...
              <div class="form-group" >
                <div class="col-md-12" style="padding-bottom:25px">
                  ...
                  <div class="row" style="border-style:solid;border-width:1px 0px 0px;padding:10px 5px 10px">
                    ...
                    <div class="col-md-5">
                      Berkas Persyaratan<input type="file" name="<?php echo "file_".$data->id; ?>" class="form-control FilUploader" accept=".pdf,.PDF" onchange="ValidateSingleInput(this);" required>
