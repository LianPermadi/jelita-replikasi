    ...
    <div class="col-lg-12">
     <div class="panel panel-default">
        <div class="panel-heading">
          <div class="row">
            <div class="col-md-9">Informasi</div>
          </div>
        </div>
        <div class="panel-body">
          <div class="col-md-12">
            ...
            <!-- <h4 style="text-align: center; color: red;">Untuk Permohonan Izin Air Tanah CAT Lintas Provinsi Jakarta belum bisa dilakukan verifikasi, dikarenakan akan diadakannya peralihan penerbitan rekomendasi teknis dari Badan Geologi ke Badan Konservasi Air Tanah (BKAT) Jakarta. </h4> -->
          </div>
        </div>
      </div>
      <div class="panel panel-default">
            ...
            <form role="form">
              ...
              <div class="form-group">
                <div class="col-md-12">
                  ...
                  <label class="col-md-1 text"> : </label>
                  <label class="col-md-8 text">
                    <?php echo $bidang; ?>
                  </label>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="col-md-12">
                <label class="col-md-3 text">Pilih Perizinan</label>
                <label class="col-md-1 text"> : </label>
                <div class="col-md-8">
                  <select id="basic" class="selectpicker form-control" data-live-search="true" style="background:white;">
                    ...
                    <option value="<?php echo $row->id; ?>" style="white-space: normal;"><?php echo $row->n_perizinan; ?></option>
                    <?php } ?>
                  </select>
                  <br><span style="color: red;">*Satu Permohonan Untuk Satu Jenis Izin/Objek Izin</span><br>
                </div>
                </div>
              </div>
