				...
				<div class="panel-body">
					<div class="col-md-12">
						...
						<form role="form" method="post" action="<?php echo base_url() . 'main/permohonan/step4/'.$id.''; ?>">
							...
							<center class="notif" ><h4>Data boleh diisi atau dikosongkan, setelah itu silahkan klik tombol Lanjutkan</h4></center><br>
							<?php 
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											...
											<?php if($array[9]=="TextBox"){ ?>
												...
												<input class="form-control" name="var_teknis<?php echo $array[0]; ?>" value="" autocomplete="off"><br>
											<?php }else if($array[9]=="Integer"){ ?>
												...
												<input class="form-control numberonly" name="var_teknis<?php echo $array[0]; ?>" value="" autocomplete="off"><br>
											<?php }else if($array[9]=="ComboBox"){ 
												$option = explode(";",$array[10]);
											?>
													<!--<select class="form-control" name="var_teknis<?php echo $array[0]; ?>" required>-->
													<select class="form-control" name="var_teknis<?php echo $array[0]; ?>">
											...
											<?php 
												...
												<input class="form-control datepicker" name="var_teknis<?php echo $array[0]; ?>" value="" autocomplete="off"><br>
											<?php }else{ ?>
												<?php echo $array[9];?>
											<?php } ?>
										</div>
