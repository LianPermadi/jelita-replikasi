										...
										<label class="col-md-9">
											<?php 
												if(!empty($data->scan_akta_pemohon)){
													echo anchor("".strtolower($base_url.$data->scan_akta_pemohon)."", "Preview",array("target"=>"_blank"));
												}
											?>
										&nbsp;</label>
									...
									<label class="col-md-9">
										<?php 
											if(!empty($data->scan_npwp_pemohon)){
												echo anchor("".strtolower($base_url.$data->scan_npwp_pemohon)."", "<img src='".strtolower($base_url.$data->scan_npwp_pemohon)."' height=100px>",array("target"=>"_blank"));
											}
										?>
										&nbsp;</label>
								</div>
									...
									<label class="col-md-9">
										<?php 
											if(!empty($data->scan_ktp_pemegang_kuasa)){
												echo anchor("".strtolower($base_url.$data->scan_ktp_pemegang_kuasa)."", "<img src='".strtolower($base_url.$data->scan_ktp_pemegang_kuasa)."' height=100px>",array("target"=>"_blank")); 
											}
										?>
									</label>
								</div>
