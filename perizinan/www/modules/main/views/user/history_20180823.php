              ...
              foreach($permohonan as $data){
                ...
                if($permohonan == 0) {
                  ...
                  <tr>
                    ...
                    <td><?php echo date("d - M - Y H:i:s",strtotime($data->d_entry)); ?></td>
                    <td>
                      <?php 
                      $status = $data->status;
                    ...
                    <td>
                      ...
                      ?>
                      <?php echo anchor('main/permohonan/detail/'.$data->uuid.'/his', $text,array("style"=>"background:#1ebfae;color:white","class"=>"btn")) ?>
                    </td>
                  </tr>
                  <?php
                }
