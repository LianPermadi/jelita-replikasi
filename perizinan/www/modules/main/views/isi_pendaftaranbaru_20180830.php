...
<form method="post" class="form-horizontal" action="<?php echo base_url() . 'main/pendaftaranbaru/dopendaftaran'; ?>">
    ...
    <label  class="col-sm-3 control-label">Jenis Pemohon : </label>
    <div class="col-sm-9">
    	<div class="radio">
		  <label>
	...
	<div class="form-group">
		...
		<div class="form-group" style="display:none" id="direktur">
			<label class="col-sm-3 control-label">Nama Direktur :</label>
			<div class="col-sm-6">
	...
	<div class="form-group">
		<label class="col-sm-3 control-label">Nama Pemegang Kuasa :</label>
		<div class="col-sm-6">
	...
	<div class="form-group">
		<label class="col-sm-3 control-label">No HP Pemohon :</label>
		<div class="col-sm-6">
	...
	<div class="form-group">
		<label class="col-sm-3 control-label">No HP Pemegang Kuasa :</label>
		<div class="col-sm-6">
	...
	<div class="form-group">
		<label class="col-sm-3 control-label">E-mail Pemohon :</label>
		<div class="col-sm-6">
			<input type="text" id="" name="email_pemohon" class="validate[required] form-control text-input" style="width:80%" value="" required>
		</div>
	</div>		
					
<hr />
<h4>Alamat Pemohon</h4>
<hr />
...
<div class="form-group">
		...
		<div class="col-sm-6">
						<textarea name="alamat_pemohon" class="validate[required] form-control text-input" style="width:80%;resize:vertical" rows="5" placeholder="Alamat Pemohon" required></textarea>
                ...
                <span id="isi_capca_error" style="color: red;"> </span>
					...
					<div class="form-group">
						    <div class="col-sm-offset-3 col-sm-10">
						      <input type="submit" value="Simpan" class='button button-blue'  onclick="return ajaxFileUpload();" style="float: left; margin-right: 5px; margin-left: 0px;"/>
						    </div>
						  </div>
