		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="row">
						<div class="col-md-10">Download Formulir Step 3</div>
						<div class="col-md-2">
							<?php echo anchor('main/formulir/step2/'.$sektor->id, 'Kembali',array("class"=>"btn btn-block btn-primary")) ?>
						</div>
					</div>
				</div>
					...
					<div class="col-md-12">
						<form role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url() . 'main/permohonan/addpermohonanbaru'; ?>" onsubmit="return beforeSubmit()">
							...
							<div class="form-group">
								...
								<label class="col-md-9" class="text2"  ><?php echo $sektor->n_sektor; ?></label>
								</div>
							</div>
							...
							<div class="form-group" >
								<div class="col-md-12" style="padding-bottom:25px">
									<table style="padding-bottom:100px">
										...
										<?php } 
										$c_foto = $this->db->query("SELECT c_foto FROM db_sicantik_backoffice.trperizinan WHERE id LIKE '$id'")->result();
										// var_dump();
										if($c_foto[0]->c_foto == 1){
										?>
										<tr>
												<td class="col-md-4 syarat justify">
													Upload Foto Pemohon
