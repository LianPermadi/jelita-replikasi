...
<div class="main-login col-sm-4 col-sm-offset-4">
	...
	<!-- start: LOGIN BOX -->
	 <?php 
		...
		$sql1 = "SELECT * FROM $backoffice.settings WHERE name = 'app_right'";
	 	$nama1 = $this->db->query($sql1)->first_row();
	 ?>
	<div class="box-login">
		<center>
			<h3>Login Perizinan Online<br><?php echo $nama->value; ?></h3>
		</center>
		<br>
		<?php 
	...
	<!-- start: COPYRIGHT -->
	<div class="copyright">
		Copyright © <?= date('Y') ?> <?php echo $nama1->value; ?>
	</div>
	<!-- end: COPYRIGHT -->
</div>