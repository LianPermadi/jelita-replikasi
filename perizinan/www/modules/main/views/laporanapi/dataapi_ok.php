...
<form role="form" method="post" action="<?php echo base_url() . 'main/laporanapiuser/cari_dataapi'; ?>">

           
 
<div class="form-group">
								<label class="col-md-2 text">Tanggal PIB</label>
							
								<input type="text" class="tanggal"  placeholder="" name="tgl1" value="<?php echo $tgl1;?>" readonly="true" required>
								<input type="text" readonly name="tgl2" value="<?php echo $tgl2;?>" class="tanggal" />
						
								
									<input type="hidden" class="form-control" value="<?php echo $no_api;?>" name="no_api" required>
							...
							if($tgl1 || $tgl1 == null){
echo base_url() . 'main/laporanapiuser/download_dataapiall'; 
							}else{
							echo base_url() . 'main/laporanapiuser/download_dataapi'; 
						}
							?>" target="_blank">
<div class="form-group">
...
<center>DATA LAPORAN API YANG SUDAH DIVALIDASI ADMIN</center>
								<div class="form-group">
