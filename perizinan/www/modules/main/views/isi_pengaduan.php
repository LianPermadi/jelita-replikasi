...
<tr>
    ...
    <td>:</td>
    <td>
        <select name="jenis" id="jenis" class="validate[required] form-control text-input">
            <option value="">Pilih Jenis Pengaduan</option>
            <?php
            foreach ($list_status as $row) {
                if ($row['status'] == 1)
                    echo "<option value=".$row['id']." data-durasi=".$row['durasi']." data-satuan=".$row['satuan'].">".$row['n_status']."</option>";
            }
            ?>
        </select>
        <!-- <span id="durasi"></span> -->
...
<tr>
    <td width="200">Keterangan Penyelesaian</td>
    <td>:</td>
    <td>
        <span id="durasi" style="color:red"></span>
    </td>
</tr>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var durasiElement = document.getElementById('durasi');
    ...
    selectElement.addEventListener('change', function () {
        ...
        if (durasi && satuan) {
            durasiElement.textContent = " Durasi " + durasi + " " + satuan;
        } else {
          ...
          <td>:</td>
          <td>
            <input type="text" name="nomor" id="nomor" class="validate[required] form-control text-input" style="width: 300px"/>
          ...
          <td>:</td>
          <td><input type="text" name="nama" id="nama" class="validate[required] form-control text-input" style="width: 300px"/> </td>
        </tr>
        
    	  <tr>
          <td width="200">Kontak Person/Telp </td>
          <td>:</td>
          <td><input type="text" name="kontak_person" id="kontak" class="validate[required] form-control text-input" style="width: 300px"/> </td>
        </tr>
          ...
          <td>:</td>
          <td>
            <input type="text" name="no_hp" id="no_hp" class="validate[required] form-control text-input" style="width: 300px"/>
            * Mohon informasikan no yang mendukung WA untuk menerima jawaban langsung
          </td>
        </tr>
          ...
          <td>:</td>
          <td><input type="email" name="n_email" id="n_email" class="validate[required] form-control email-input" style="width: 300px"/> </td>
        </tr>
              
    	  <tr>
          <td>Alamat </td>
          <td>:</td>
          <td><input type="text" name="alamat" id="alamat" class="validate[required] form-control text-input" style="width: 100%"/> </td>
        </tr>
          ...
          <td>:</td>
          <td>
            <select name="propinsi1" id="provinsi2" class="validate[required] form-control text-input">
        ...
        <tr>
          ...
          <td>:</td>
          <td>
            <select name="kabupaten1" id="kabupaten2" class="validate[required] form-control text-input">
          ...
          <td>:</td>
          <td>
            <select name="kecamatan1" id="kecamatan2" class="validate[required] form-control text-input">
          ...
          <td>:</td>
          <td>
            <select name="kelurahan1" id="kelurahan2" class="validate[required] form-control text-input">
        ...
        <tr>
          ...
          <td>
            <textarea cols="40" rows="7" name="e_pesan" id="e_pesan" class="validate[required] form-control text-input"></textarea>
          </td>
    	  </tr>
