...
<div class="isi">
    <div id="entry">
        ...
        <div class="kiri">
            <form  method="post" action="<?php echo base_url() . '/main/bws/save' ?>" enctype="multipart/form-data" id="formID" class="formular">
                <table  style="margin-left: 15px;" width="95%" class="my_table_font table">
                    <tr>
                        <td colspan="3">
			    		    <p>
							    Layanan untuk ini disediakan bagi anda yang memiliki informasi dan ingin melaporkan suatu perbuatan / tindakan yang berindikasi pelanggaran yang terjadi dilingkungan Dinas PMPTSP Jawa Barat  : <br/> <br/>
                            </p>
    					</td>
                    </tr>
					...
					<tr>
					<input type="hidden" name="jenis" value="14" id="jenis" class="validate[required] text-input" style="width: 200px" value="WBS"/>
						
					<input type="hidden" name="nomor" id="nomor" class="validate[required] text-input" style="width: 200px" value="WBS"/>
                    ...
                    <tr>
                        <td style="vertical-align:top;">Deskripsi Pelaporan</td>
                    ...
                    <tr>
                        ...
                        <td style="vertical-align:top;">
		    			    Mohon isi data dengan benar dan selengkap mungkin, agar Kami dapat menindaklanjuti laporan dengan cepat.
    					</td>
                    </tr>

                    <tr>
                        <td></td>
                        <td><input type="hidden" id="error_data" ></td>
                        <td><input type="submit" value="Kirim" class='button button-blue'  style="float: left; margin-right: 5px; margin-left: 0px;"/> </td>
                    </tr>
                </table>
            </form>
        </div>
