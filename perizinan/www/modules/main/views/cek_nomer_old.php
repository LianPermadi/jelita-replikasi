      ...
      if($xvalid) { //$jumlah > 0
        ...
        foreach ($list as $row) {
          ...
          if($n == 1){
            ...
            if($point6 == 'Abu.png'){ 
            	 $txt6 = 'PENANDATANGANAN NASKAH IZIN DISETUJUI/DITOLAK';
            }else{
              $txt6 = 'PENANDATANGANAN NASKAH IZIN - '.$sts_berkas;
            ...
            echo     "<td width='97%' style='vertical-align:top'>PENYUSUNAN NASKAH IZIN</td>"; 
            echo   "</tr>"; 
    	      echo "</table>";
          ...
          $file = str_replace(' ', '','SK_'.$no_pendaftaran);
  	      ...
  	      if(file_exists($lok_esign.$file.'.pdf')){        // cek PDF yang sudah SE
	          ...
	          if($indeks == 'AKDP'){ // Jika AKDP
  	          ...
  	          if(file_exists($lok_skpdf.$file.'.pdf')){        // cek PDF yang sudah SE
  	      	    echo form_button($unduh_izin);
  	      	  }
	          }
	        } 
