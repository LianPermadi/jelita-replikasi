			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="alert bg-success" role="alert" style="background:#7EB332;font-size:20px;text-align:center">
						<span class="glyphicon glyphicon-check"></span> Selamat Permohonan Anda Telah Berhasil Diajukan, silahkan menunggu konfirmasi penerimaan dari BPMPT.<br>Permohonan diterima setelah mendapatkan nomor pendaftaran dari BPMPT.<br>Terima Kasih
					</div>
