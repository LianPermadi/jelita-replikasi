    ...
    <div id="entry">
        ...
        <div class="kiri">
            <form  method="post" action="<?php echo base_url() . '/main/pengaduan/save' ?>" enctype="multipart/form-data" id="formID" class="formular">
                <table border="1" style="margin-left: 15px;" width="95%" class="my_table_font">
                    <tr>
                        <td colspan="3">
			    		    <p>
			...
			-->
					...
					<tr>
                        ...
                        <td>:</td>
                        <td><input type="text" name="nomor" id="nomor" class="validate[required] text-input" style="width: 200px"/> </td>
						<td>* Nomor Pendaftaran sesuai lembaran ceklist</td>
                    </tr>
