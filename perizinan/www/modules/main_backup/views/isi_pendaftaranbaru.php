...
<div class="isi">
    <div id="entry">
        <h2></h2>
		<div id="pesan" style="font-size: 20px; margin-bottom: 3px; font-weight: bold;"><center>Pendaftaran Pemohon Online</center></div>
		<div id="pesan" style="font-size: 12px; margin-bottom: 15px;"><center>( Untuk Pemohon yang belum memiliki Akun )</center></div>
		<div id="pesan" style="font-size: 13px; margin-bottom: 15px; font-weight: bold;" align="center">
		     klik <?php echo anchor('main/login', 'Login') ?> untuk pemohon yang telah memiliki akun
		</div>
        ...
        <div class="kiri" style="margin-left:40px;width:660px">
			...
			<div id="pesan" style="font-size: 12px; margin-bottom: 10px; font-weight: bold;"><center>Silahkan Lengkapi Data Berikut</center></div>
				<form method="post" action="<?php echo base_url() . 'main/pendaftaranbaru/dopendaftaran'; ?>">
					...
					<div class="form-group">
						<text class="text">Nama Pemohon :</text>
						<div class="form">
					...
					<div class="form-group">
						<text>No HP Pemegang Kuasa :</text>
						<div class="form">
					...
					<div class="form-group">
						<text id="email">E-mail Pemohon :</text>
						<div class="form">
					...
					<div class="form-group">
						...
						<div class="form">
							...
							<!--<input type="submit" value="Simpan" class='button button-blue' onclick="return ajaxFileUpload();" style="float:left;cursor:pointer!important"/>-->
