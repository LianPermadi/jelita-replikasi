...
function proses_login(){
       ...
       // $jumlah_dt = $this->main_model->where("c_user = '$username'")->count();
       // if ($jumlah_dt == 1) {
            $gt_dt = $this->main_model->where("c_user = '$username' ")->get();

            if(password_verify($password, $gt_dt->c_password)) {
