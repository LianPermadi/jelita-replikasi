<div class="isi">
    ...
    echo form_open_multipart('admin_download/'.$action, $atr);
    echo $error;
    ?>
    ...
    <table border="1" style="margin-left: 20px;">
        <tr>
            <td width="200">Berkas File</td>
            <td>:</td>
            <td> <input type="file" name="xfile" id="file"/>
                <?php
                if ($file != NULL) {
                    echo anchor(base_url() . 'uploads/admin_upload/' . $file, 'Download');
                }
                ?>
            </td>
        </tr>
        <tr>
            ...
            <td><input type="text" size="40"  id="keterangan" name="keterangan" value="<?php echo $keterangan; ?>" class="validate[required] text-input"/></td>
        </tr>   
    ...
    <a href="<?php echo site_url('admin_download'); ?>" class='button button-blue' style="float: left;" >Batal</a>
</form>
</div>
