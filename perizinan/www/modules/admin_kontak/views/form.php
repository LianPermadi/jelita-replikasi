<div class="isi">
    ...
    $atr=array('id'=>'formID',
                'class'=>'formular');
    echo form_open('admin_kontak/save', $atr);?>    
    
    <table border="1" style="margin-left: 20px;">
        <tr>
            <td width="200">Nama Kontak</td>
            <td>:</td>
            <td><input type="text" size="60" name="judul_informasi" value="<?php echo $judul_informasi; ?>"/> </td>
        </tr>
        <tr>
            <td style="vertical-align: top">Isi Kontak</td>
...
<br/><br/>
        <input type="submit" value="Ubah Data Kontak" class='button button-blue'  style="float: left; margin-right: 5px; margin-left: 20px;"/> &nbsp; &nbsp;
