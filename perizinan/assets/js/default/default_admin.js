$(document).ready(function() {
    ...
    $("#ajax_load").hide();
    $('.menu_klik').bind('click',function(){
        var page = site+$(this).attr('rel');
        $("#ajax_load").html('Menunggu Respon Dari Server...<span id="ajax_loadr">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>').fadeTo(900,1,function()
        {
            $(".isi").load(page,
                function(){
                    $("#ajax_load").hide();
    ...
    $(function() {
        ...
        $("#tanggal").change(function() {
         ...
         $("#tanggal2").datepicker("option", "minDate", testm);
         $( "#tanggal" ).focus();
        });
