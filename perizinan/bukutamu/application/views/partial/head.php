...
<head>
    ...
    <title>BUKUTAMU DPMPTSP JABAR</title>
     <link rel="icon" href="<?php echo base_url('assets/logo-dinas.gif') ?>" type="image/gif">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-6 log-det">
                            <div class="small-logo">
                                <!-- <i class="fab fa-asymmetrik"> --></i><img src="<?php echo base_url('assets/images/logo-dinas.png') ?>"><p>BUKUTAMU DINAS PMPTSP JAWA BARAT</p>
                            </div>
