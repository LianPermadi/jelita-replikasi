...
class Pengisian_Survey extends CI_Controller
{
    ...
    public function add(){
        ...
        if($tujuan = '5'){
            $isi  = "<img src = 'https://dpmptsp.jabarprov.go.id/bukutamu/uploads_registrasi/qr_code/rg_".md5($simpan).".png' style = 'max-width:35%; max-height:35%; line-height: 100%; outline: none; text-decoration: none; border: 0 none;'><br>";
        ...
        header( "refresh:1;url=https://dpmptsp.jabarprov.go.id/bukutamu/" );
    }
