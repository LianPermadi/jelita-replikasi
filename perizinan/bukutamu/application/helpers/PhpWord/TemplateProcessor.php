...
class TemplateProcessor{
	...
	/* ZipArchive object. @var mixed */
    protected $zipClass;

    /* @var string Temporary document filename (with path). */
    protected $tempDocumentFilename;

    /* Content of main document part (in XML format) of the temporary document. @var string */
    protected $tempDocumentMainPart;

    /* Content of headers (in XML format) of the temporary document.  @var string[] */
    protected $tempDocumentHeaders = array();

    /* Content of footers (in XML format) of the temporary document.  @var string[] */
    protected $tempDocumentFooters = array();

    /* Content of document rels (in XML format) of the temporary document.  @var string */
    ...
    */
    public function __construct($documentTemplate){
		...
		$this->_countRels=100; //start id for relationship between image and document.xml          //PBS
    }
