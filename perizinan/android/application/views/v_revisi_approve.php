...
<p>';
  ...
  ?> 
  <form action="<?php echo site_url('approve_permohonan/update_revisi'); ?>" method="post">
<div class="row">
    <form class="col s12" >
      <div class="row">
        ...
        $kode = '';
        if(!empty($kode_tmsk)){
foreach ($kode_tmsk as $data) {
  $kode = $data->id;
}
}
         ?>
        <input type="hidden" name="kode_tmsk" value="<?php echo $kode;?>">
...
<button type="submit" class="waves-effect waves-light btn">Revisi</button> <a href="<?php echo site_url('approve_permohonan'); ?> " class="btn" >Kembali</a>
</form>
    </form>
  </div>
