...
<html>
  ...
  <body>
    ...
    $filename  = "$local/backoffice/assets/file_mohon_sartek/$n_file_draft";   //Lokasi File Tanpa WaterMark
    $filenameW = "$local/backoffice/assets/file_mohon_sartekWM/$n_file_draft"; //Lokasi File WaterMark
    ...
    <center>
      ...
      $file_iframe = $_SERVER['DOCUMENT_ROOT'].$clean_url.'/backoffice/assets/file_mohon_sartekWM/'.$n_file;
      if(file_exists($file_iframe)){
        $url_iframe = '/backoffice/assets/file_mohon_sartekWM/'.$n_file;
      }else{
        $url_iframe = '/backoffice/assets/file_mohon_sartek/'.$n_file;
      }
      ?>
            <p>
    <a href="<?php echo $link . $_SERVER['HTTP_HOST'] . $clean_url. $url_iframe; ?>" target="_blank">
        📥 Unduh PDF
    </a>
    </p>
<embed 
    src="<?php echo $link . $_SERVER['HTTP_HOST'] . $clean_url. $url_iframe; ?>" 
