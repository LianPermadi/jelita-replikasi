        ...
        <div class="section">
          ...
          $i=1;
    			if (count($detail_cetak)>0) {
  				...
  				?>
    					<!---asli <form action="<?php echo site_url('approve_esign/update_multiple'); ?>" method="post">
                           ...
                           // if ( $iduser == 48 || $iduser == 257 || $iduser == 178){
                            ...
                            if($h==4 || $h==3){
                            ?>
                               <a href="<?php echo site_url('approve_esign/revisi_approve/').'/'.$data->id; ?> " class="btn" >Revisi</a>&nbsp;&nbsp;
                                <?php
                            }
                                ?>
