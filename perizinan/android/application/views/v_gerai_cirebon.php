    ...
    <div class="section">
      ...
      <div class="row">
        <div class="col s12">
          <div class="card">
            <div class="card-image">
              <img src="<?php echo base_url(); ?>assets/img/cirebon.png">
              <span class="card-title gerai-title">Gerai Layanan Cirebon</span>
              <span class="card-title gerai-description">Jl. Siliwangi Nomor 14, Cirebon</span>
            </div>
            <div class="card-content">
              ...
              <ol>
                ...
                <li>Surat Izin Kapal Pengangkut Ikan (SIKPI).</li>
              </ol>
            </div>
