              ...
              <tbody>
                ...
                if(count($hasilakdp_cetak)>0) {
                  foreach ($hasilakdp_cetak as $data){
                	    ...
                	    <tr>
                	      ...
                	      if($h==4 || $h==3 || $h==2){
                	        ...
                	        <td rowspan="3" style="border-bottom: 1px solid silver;border-collapse: none;">
                	        	<?php if (file_exists('../backoffice/assets/skpdf/SK_'.$data->pendaftaran_id.".pdf")) { ?>
                        ...
                        <!--   </form>      	    -->
                        <!--</form>--> <!--kalo error coba switch dg /form 2 dibawah--> 
                        <td rowspan="3" style="border-bottom: 1px solid silver;border-collapse: none;"><?php //echo $data->n_perizinan; ?>
                          <form action="<?php echo site_url('approve_esign/detail_permohonan').'/'.$data->id; ?>" method="post">
                            <input type="submit" name="submit"  value="Detail"  class="btn">
                            </br></br><a href="<?php echo site_url('approve_esign').'/preview/'.$data->pendaftaran_id.'/'.$data->id; ?>" class="btn">preview sk</a>
                          </form>	
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td style="border-bottom: 1px solid silver;border-collapse: none;">
                          ...
                          <?php echo '<br>'.$data->d_terima_berkas; ?>
                        </td>
                      </tr>
                      <?php
  					      }
