    ...
    <div class="section">
      ...
      <div class="row">
        <div class="col s12">
          <div class="card">
            <div class="card-image">
              <img src="<?php echo base_url(); ?>assets/img/garut.png">
              <span class="card-title gerai-title">Gerai Layanan Garut</span>
              <span class="card-title gerai-description">Jl. A. Yani Nomor 21, Garut</span>
            </div>
