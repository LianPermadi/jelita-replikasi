    ...
    <div class="section">
      ...
      <div class="row">
        <div class="col s12">
          <div class="card">
            <div class="card-image">
              <img src="<?php echo base_url(); ?>assets/img/purwakarta.png">
              <span class="card-title gerai-title">Gerai Layanan Purwakarta</span>
              <span class="card-title gerai-description">Jl. Siliwangi Nomor 1, Purwakarta</span>
            </div>
            <div class="card-content">
              ...
              <ol>
                ...
                <li>Izin Serah Pakai Tanah Pemerintah Provinsi (ISPTPP) Bantaran Sungai.</li>
                <li>Surat Izin Pengambilan dan Pemanfaatan Air (SIPPA) Permukaan.</li>
                <li>Surat Izin Usaha Perikanan (SIUP).</li>
                <li>Surat Izin Penangkapan Ikan (SIPI).</li>
                <li>Surat Izin Pembudidayaan Ikan (SPbI).</li>
              </ol>
            </div>
