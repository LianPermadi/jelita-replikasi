    ...
    <div class="section">
      ...
      <div class="row">
        <div class="col s12">
          <div class="card">
            <div class="card-image">
              <img src="<?php echo base_url(); ?>assets/img/bandung.png">
              <span class="card-title gerai-title">Gerai Layanan Bandung</span>
              <span class="card-title gerai-description">Jl. Sumatra No. 50, Bandung</span>
            </div>
            <div class="card-content">
              Jenis Layanan Perizinan
              <ol>
                <li>Pengesahan Rencana Penggunaan Tenaga Kerja Asing (RPTKA)</li>
                <li>Izin Mempekerjakan Tenaga Kerja Asing ( IMTA ).</li>
                <li>Izin Pendirian Kantor Cabang Pelaksana Penempatan Tenaga Kerja Indonesia Swasta (PPTKIS).</li>
                <li>Izin Pendirian Lembaga Penempatan Tenaga Kerja Swasta Antar Kerja Lokal  (LPTKS-AKL).</li>
                <li>Surat Persetujuan Penempatan Tenaga Kerja Antar Kerja Antar Daerah (SPP-AKAD)</li>
                <li>Izin Pendirian Lembaga Bursa Kerja  (LBK).</li>
                <li>Izin Tempat Penampungan Tenaga Kerja Indonesia ke Luar Negeri.</li>
              </ol>
            </div>
