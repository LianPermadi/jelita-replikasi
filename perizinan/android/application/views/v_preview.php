...
?>
   	...
   	<br><br><center><a href="<?php echo base_url('approve_permohonan/');?>" class="btn red">Kembali</a></center>
    ...
    <form action="<?php echo site_url('approve_permohonan/update_multiple'); ?>" method="post">
                  ...
                  ?>
                           ...
                           // if ( $iduser == 48 || $iduser == 257 || $iduser == 178){
                            ...
                            ?>
                             <center><input type="submit" name="submit"  value="Approve"  class="btn">&nbsp;&nbsp;
                               <a href="<?php echo site_url('approve_permohonan/revisi_approve/').'/'.$no_id; ?> " class="btn" >Revisi</a>&nbsp;&nbsp;
                                <?php
                            }else if($h==2){
                              ?>
                              <center>
...
<a href="<?php echo "/manokwari/perizinan/backoffice/assets/download/SK_$no_pendaftaran.docx";?>" target="_blank" class="btn red">Download</a>
...
?>
<h6><b>SK</b></h6>
  <iframe src='<?php echo $link.$_SERVER['HTTP_HOST'].$clean_url; ?>/backoffice/assets/skpdf/SK_<?php echo $no_pendaftaran;?>.pdf' width='90%' height='688px'></iframe>
 </center>
<br><br>
<?php
       if (file_exists($local .'/backoffice/assets/pertek/PT_'.$no_pendaftaran.".pdf")) { ?>
  <h6><b>Pertek</b></h6>
  <iframe src='<?php echo $link.$_SERVER['HTTP_HOST'].$clean_url; ?>/backoffice/assets/pertek/PT_<?php echo $no_pendaftaran;?>.pdf' width='90%' height='688px'></iframe>
<?php } ?>
<br><br>
<form action="<?php echo site_url('approve_permohonan/update_multiple'); ?>" method="post">
                  ...
                  ?>
                        ...
                        <?php
                            ...
                            <a href="<?php echo site_url('approve_permohonan'); ?> " class="btn" >Kembali</a></center>
              </form>
