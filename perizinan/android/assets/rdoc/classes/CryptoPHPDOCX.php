 ...
 * documents. It comes bundled exclusively with the CORPORATE version of PHPDocX 
 * 
 * @category   Phpdocx
 * @package    crypto
...
class CryptoPHPDOCX {
     ...
     * 
     * @access public
     * @example ../examples/intermediate/EncryptDocx.php
    ...
    public function encryptDocx($source, $target, $options)
    {
        ...
        $sizeIV = mcrypt_get_iv_size(MCRYPT_CAST_256, MCRYPT_MODE_ECB);
        $verifier = mcrypt_create_iv($sizeIV, MCRYPT_RAND);
        $encrypted_verifier = @mcrypt_encrypt(MCRYPT_RIJNDAEL_128, $this->_hash, $verifier, MCRYPT_MODE_ECB);
        $sha_verifier = sha1($verifier, true);
        $encrypted_sha_verifier = @mcrypt_encrypt(MCRYPT_RIJNDAEL_128, $this->_hash, $sha_verifier, MCRYPT_MODE_ECB);
        ...
        while (!feof($source)) {
            ...
            $stream .= @mcrypt_encrypt(MCRYPT_RIJNDAEL_128, $this->_hash, $block, MCRYPT_MODE_ECB);
        }
        fclose($source);
     ...
     * 
     * @access public
     * @example ../examples/intermediate/EncryptPDF.php
     * @param string $source path to the source document
     * @param string $target path to the protected document
     * @param array $options, 
     *      password: string
     ...
     * 
     * @access public
     * @example ../examples/intermediate/ProtectDocx.php
     ...
     * 
     * @access public
     * @example ../examples/intermediate/ProtectPDF.php
     * @param string $source path to the source document
     * @param string $target path to the protected document
     * @param array $options, 
     ...
     * 
     * @access public
     * @example ../examples/intermediate/RemoveProtection.php
     * @param string $sourcet path to the source document
     * @param string $target path to the protected document
     * @return boolean
     */
