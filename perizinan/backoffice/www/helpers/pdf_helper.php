...
function prep_pdf($orientation = 'landscape') {
	...
	if($orientation == 'portrait') {
		...
		//$CI->cezpdf->addText(50,22,8,'Copyright 2013. Badan Pelayanan Perijinan Terpadu Provinsi Jawa Barat');
		$CI->cezpdf->addText(50,22,8,'Copyright 2014. Dinas Penanaman Modal dan Pelayanan Terpadu Satu Pintu Provinsi Jawa Barat');
	} else {
