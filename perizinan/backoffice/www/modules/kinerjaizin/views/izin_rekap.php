...
<!---------------------------------------------------------------------------------------------------.-->
 ...
 //                           $bidangizin=$this->input->post('id');
                   	        $i = NULL;
                            $query_data = "select a.id,a.n_perizinan, a.v_perizinan jumlah from trperizinan a
                            ...
                            while ($data = mysql_fetch_assoc(@$results)){
						        ...
						        if( $jumlah_terbit != 0  or $jumlah_tolak != 0 or $jumlah_masuk!=0){
							        ...
							        if( $jumlah_terbit == 0  && $jumlah_tolak == 0 ){
                                        $persen = 0;
	                                } ;
                            ?>
                            <tr>
