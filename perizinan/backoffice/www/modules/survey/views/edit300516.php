        ...
        <div class="entry">
            ...
            <table>
                <tr>
                    ...
                    <td>
                        <?php
                        $berkas_input = array('name' => 'berkas', 'value' => $berkas, 'id' => 'berkas');
                ...
                <tr>
                    ...
                    <td>
                        <select name="petugas" id="petugas" class="input-wrc required">
                            <?php
                            $selected = NULL;
                                ...
                                foreach ($list as $data) {
                                    foreach ($idp as $data_p) {
                                        ...
                                        if ($selected=="selected") {
                                            ...
                                            echo "<option value='".$data->id."'" . $selected . ">".$data->n_pegawai."  ".$data->nip." ".$data->pangkat_gol." | ".$data->n_jabatan." </option>";
                                        } else {
                                            $data->trunitkerja->get();
                                            echo "<option value='".$data->id."'>".$data->n_pegawai." | ".$data->nip." |".$data->pangkat_gol." | ".$data->n_jabatan. "</option>";
                                        }   
                                }
                            } else {
                                foreach ($list as $data) {
