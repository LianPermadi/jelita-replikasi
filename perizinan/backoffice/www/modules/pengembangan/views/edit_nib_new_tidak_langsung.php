        ...
        <div id="tabs">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display">
                ...
                <tr>
                    ...
                    <td>
                    <input type="date" class="input-wrc" style="width:100%" name="tanggal_lahir" value="<?php echo $row->tanggal_lahir; ?>">
                    </td>
                </tr>
                <tr>
                    <td align="left" width="15%">
                    ...
                    <td>
                    <input type="text" class="input-wrc" style="width:100%" name="alamat" value="<?php echo $row->alamat; ?>">
                    </td>
                </tr>
                <tr>
                    <td align="left" width="15%">
                    ...
                    <td>
                    <input type="text" class="input-wrc" style="width:100%" name="kecamatan" value="<?php echo $row->kecamatan; ?>">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                    <input type="text" class="input-wrc" style="width:100%" name="kelurahan" value="<?php echo $row->kelurahan; ?>">
                    </td>
                </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if(file_exists($_SERVER['DOCUMENT_ROOT'] . "/nib/uploads/ktp/" . $row->file)){ ?>
                                            <img 
                                            src="https://dpmptsp.jabarprov.go.id/nib/uploads/ktp/<?= $row->file ?>"
                    ...
                    <tr>
                        ...
                        <td>
                        <?php if(!file_exists($_SERVER['DOCUMENT_ROOT']. '/nib/uploads/pdf/'. $row->file_nib_pdf) || $row->file_nib_pdf != NULL || $row->file_nib_pdf != ''){ ?>
                                <!-- Link untuk melihat PDF -->
                                <a href="http://dpmptsp.jabarprov.go.id/jelita/backoffice/pengembangan/nib/download_pdf/<?= $row->file_nib_pdf ?>" target="_blank" style="border: 1px;"><button type="button" class="btn btn-primary">Lihat PDF</button></a>
                                <br>
                    ...
                    <tr class="form-elements" id="nib_input">
                        <td align="left" width="15%"><b>User NIB Pemohon</b></td>
                        <td>
                            <input type="text" class="input-wrc" style="width:100%" name="user_nib_pemohon" value="<?= $row->user_nib_pemohon ?>">
                        </td>
                    </tr>
                    <tr class="form-elements" id="nib_input">
                        <td align="left" width="15%"><b>Password NIB Pemohon</b></td>
                        <td>
                            <input type="text" class="input-wrc" style="width:100%" name="password_nib_pemohon" value="<?= $row->password_nib_pemohon ?>">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <!-- <tr>
                        <td align="left" width="15%"><b>Nama Petugas Input KBLI</b></td>
                        <td> -->
                            <!-- <input type="text" class="input-wrc" style="width:100%" name="petugas_kbli" value="<?php if(!empty($row->input_kbli)){ echo $row->input_kbli; } ?>"> -->
                            <!-- <select class="pilihan" style="width:100%" name="petugas_kbli">
                                <option value="-" selected disabled>-</option>
                                <?php foreach ($pegawai as $rows) { ?>
                                <option value="<?php echo $rows->id; ?>" <?php if($rows->id == $row->petugas_kbli){ echo 'selected'; } ?>><?= $rows->n_pegawai ?></option>
                            <?php } ?>
                    ...
                    <tr class="form-elements" id="nib_input">
                    `   <td>
                            <b><label for="j_usaha">Jenis Usaha:</label></b>
                        </td>
                        <td>
                            <input type="text" class="input-wrc" style="width:100%" id="j_usaha" name="j_usaha" value="<?php echo $row->j_usaha; ?>">
                        </td>
                    </tr>
                    <tr class="form-elements" id="nib_input">
                        <td>
                    ...
                    <tr class="form-elements" id="nib_input">
                    `   <td>
                            <b><label for="kecamatan_tempat_usaha">Kecamatan Tempat Usaha:</label></b>
                        </td>
                        <td>
                            <input type="text" class="input-wrc" style="width:100%" id="kecamatan_tempat_usaha" name="kecamatan_tempat_usaha" value="<?php echo $row->kecamatan_usaha; ?>">
                        </td>
                    </tr>
                    <tr class="form-elements" id="nib_input">
                    `   <td>
                            <b><label for="kelurahan_tempat_usaha"> Kelurahan Tempat Usaha:</label></b>
                        </td>
                        <td>
                            <input type="text" class="input-wrc" style="width:100%" id="kelurahan_tempat_usaha" name="kelurahan_tempat_usaha" value="<?php echo $row->kelurahan_usaha; ?>">
                        </td>
                    </tr>
                    <tr class="form-elements" id="nib_input">
                    `   <td>
                            <b><label for="kode_pos_tempat_usaha"> Kode Pos Tempat Usaha:</label></b>
                        </td>
                        <td>
                            <input type="text" class="input-wrc" style="width:100%" id="kode_pos_tempat_usaha" name="kode_pos_tempat_usaha" value="<?php echo $row->kode_pos_tempat_usaha; ?>">
                        </td>
                    </tr>
...
<script>
    ...
    function toggleNibInput() {
        ...
        // Jika nilai dropdown yang dipilih adalah 'Pelayanan Pembuatan Nomor Induk Berusaha(NIB)(Tidak Langsung)', tampilkan elemen HTML dengan ID 'nib_input'
