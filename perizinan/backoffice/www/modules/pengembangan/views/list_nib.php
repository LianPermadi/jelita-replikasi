  ...
  <div class="post">
    ...
    <div id="tabs">
      <ul>
        ...
        <li><a href="#tabs-3">Grafik dan Chart Data (NIB Langsung)</a></li>
        <li><a href="#tabs-4">Grafik dan Chart Data (NIB Tidak Langsung)</a></li>
      </ul>
...
if (strpos($request_uri, 'index.php') !== false) {
    ...
    $clean_uri = str_replace('index.php', '', $request_uri);
                      ...
                      ?>
                    <form action="<?php echo $clean_uri; ?>/pengembangan/nib/status_mic/<?php echo $row->id; ?>/<?php echo $row->no_antri; ?>" method="POST">
...
// var_dump($_SERVER['REQUEST_SCHEME'].'://'.$_SERVER['HTTP_HOST'] .$clean_uri. "nib/uploads/ktp/" . $file);die();
                if(file_exists($_SERVER['DOCUMENT_ROOT'] .$clean_uri_luar. "/nib/uploads/ktp/" . $file)){
                  ?>
                  <button class="openModalBtn" data-modal="<?php echo $i; ?>" style="background-color: transparent; border: 0;">
                  <img src="<?php echo $_SERVER['REQUEST_SCHEME'].'://'.$_SERVER['HTTP_HOST'] .$clean_uri_luar. "nib/uploads/ktp/" . $file; ?>" width="100px">
                  </button>
                  <!-- Modal -->
                  <div id="modal<?php echo $i; ?>" class="modal">
                    <div class="modal-content">
                      ...
                      <center>
                      <img src="<?php echo $_SERVER['REQUEST_SCHEME'].'://'.$_SERVER['HTTP_HOST'] .$clean_uri_luar. "nib/uploads/ktp/" . $file; ?>" width="1050px">
                      </center>
                    </div>
                  </div>
                  <?php
              ...
              <td>
                ...
                <a href="<?php echo $clean_uri_luar; ?>backoffice/pengembangan/nib/edit_nib/<?php echo $row->id; ?>"><img src="https://cdn-icons-png.flaticon.com/512/266/266146.png" alt="" width="20px"></a>
                <?php } ?>
                <?php
                if($this->All){ 
    ...
    <div class="entry">
      <fieldset>
        ...
        $img_cetak_excel = array(
            ...
            'alt' => 'Cetak Excel',
            'title' => 'Cetak Excel',
            // Uncomment this line if you want to enable onclick functionality
            // 'onclick' => 'window.open(\''.site_url('pengembangan/cetak_excel').'\')'
        );
        ?>
