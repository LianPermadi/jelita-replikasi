      ...
      <table cellpadding="0" cellspacing="0" border="0" class="display" id="pendataan">
        ...
        <tbody>
          ...
          foreach ($list_pengembangan as $row) {
            ...
            ?>
              <td>
                <a href="pengembangan/hapus/<?php echo $row->id; ?>" onclick="return confirm('Apa Anda Yakin Hapus permintaan dari <?php echo $row->nama_pengaju; ?>?')">
                <button class="button-wrc">Hapus</button></a>
                <a href="pengembangan/edit/<?php echo $row->id; ?>">
                <button class="button-wrc">Edit</button>
              </a>
              </td>
            <?php
            }
