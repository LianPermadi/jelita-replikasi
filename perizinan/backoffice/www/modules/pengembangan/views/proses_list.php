  ...
  <div class="post">
    ...
    <div class="entry">
      <fieldset>
        ...
        <?php
        echo form_open('pengembangan/proses');
        ...
        <tbody>
          ...
          foreach ($list_pengembangan as $row) {
            if($row->status == '1' || $row->status == '4'){ 
              ?>
            <tr>
              <td><span style="color:blue"><?php echo $i; ?></span></td>
              <td><span style="color:blue"><?php echo $row->isi_pengajuan; ?></span></td>
              <td><span style="color:blue"><?php echo $row->deskripsi_pengembangan; ?></span></td>
              <td><span style="color:blue"><?php echo $row->tanggal; ?></span></td>
              <td><span style="color:blue"><?php 
              ...
              ?></td>
              <td><span style="color:blue"><?php echo $row->bidang; ?></span></td>
              <td><span style="color:blue"><?php 
              $nama_user = $this->m_pengembangan->get_nama_user($row->nama_pengaju);
              if($nama_user == ' - '){
                echo $row->nama_pengaju;
              }else{
                echo $nama_user; 
              }
              ?></span></td>
              <td><?php 
                if ($row->status == '0') {
                  ...
                  echo '<span style="color:orange">In Proses</span>';
                }elseif($row->status == '2'){
                  echo '<span style="color:green">Siap Testing</span>';
                }elseif($row->status == '4'){
                  echo '<span style="color:green">Revisi</span>';
                }else{
                  echo '<span style="color:green">Telah selesai</span>';
                }
              ?></td>
              <td><span style="color:blue"><?php echo $row->keterangan; ?></span></td>
            <?php
            if($this->All){
            ?>
              <td>
              
                <a href="pengembangan/detail/<?php echo $row->id; ?>" onclick="return confirm('Apa Anda Yakin Hapus permintaan dari <?php echo $row->nama_pengaju; ?>?')" title="detail">
                <img src="https://upload.wikimedia.org/wikipedia/commons/4/43/Minimalist_info_Icon.png" alt="" width="10px">
                </a>
                <a href="pengembangan/done/<?php echo $row->id; ?>" title="Done">
                <img src="https://cdn-icons-png.flaticon.com/512/8683/8683794.png" alt="" width="10px">
                </a>
                <a href="pengembangan/edit/<?php echo $row->id; ?>" title="edit">
                <img src="https://cdn-icons-png.flaticon.com/512/764/764599.png" alt="" width="10px">
                </a>
                <a href="pengembangan/hapus/<?php echo $row->id; ?>" onclick="return confirm('Apa Anda Yakin Hapus permintaan dari <?php echo $row->nama_pengaju; ?>?')" title="hapus">
                <img src="https://cdn-icons-png.flaticon.com/512/542/542724.png" alt="" width="10px">
                </a>
              </td>
            <?php
            }
