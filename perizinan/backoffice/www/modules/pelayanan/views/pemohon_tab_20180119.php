<style>
    .read_only{ border: 1px solid black; }
    #no_refer1{ background: #DDDFFD; }
    #namapemohon_input{ background: #DDDFFD; }
    #cmbsource{ background: #DDDFFD; }
</style>
...
<script language="javascript" type="text/javascript">
	...
	$(document).ready(function() {
        $('#kabupaten_lok_id').change(function(){
            $.post('<?php echo base_url(); ?>pelayanan/pendaftaran/kecamatan_lok', { kabupaten_id: $('#kabupaten_lok_id').val() },
            function(data) {
    ...
    <div id="contentright">    <!-- Sisi Kanan -->
        ...
        <div style="clear: both" ></div>
            ...
            <div class="contentForm">
				...
				if ($kabupaten_lok == " ") {
                    echo form_dropdown('kabupaten_lok', $opsi_kabupaten, '0', 'class = "input-select-wrc notSelect" id="kabupaten_lok_id"');
                } else {
                    echo form_dropdown('kabupaten_lok', $opsi_kabupaten, $kabupaten_lok, 'class = "input-select-wrc notSelect" id="kabupaten_lok_id"');
                }
                ?>
            </div>
