...
if ($_REQUEST['data_no_refer']=="")
    ...
    {
        if ($_REQUEST['data_no_refer']!==$mantra['CallDataWNIbyNIKResult']['nilaiNIK'])
    {
     $id_perusahaan = '';
     $refer = "";
     $nama = "";
     ...
     $id_perusahaan = '';
     $refer = "";
     $nama = $mantra['CallDataWNIbyNIKResult']['nilainamaLengkap'];
     $tlp = "";
     $alamat = $mantra['CallDataWNIbyNIKResult']['nilaiPropNo']."-".$mantra['CallDataWNIbyNIKResult']['nilaiKabNo']."-".$mantra['CallDataWNIbyNIKResult']['nilaiKecNo']."-".$mantra['CallDataWNIbyNIKResult']['nilaiKelNo'];
     $luar = "";
