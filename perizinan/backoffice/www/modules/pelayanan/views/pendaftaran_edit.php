        ...
        if($real_id){
          ...
          <div id="tabs-1">
            <div id="contentleft">
              ...
              <div class="contentForm">
                <?php
                $antrian_input = array('name' => 'no_antri',
              ...
              <div class="contentForm" >
                <?php
                $tgldaftar_input = array('name' => 'tgl_daftar',
                                         'value' => $tgl_daftar,
              ...
              <div class="contentForm"> 
                <?php
                $sumberID_input = array('name' => 'cmbsource',
                                        'value' => $cmbsource,
                                        'class' => 'input-wrc required',
                                        'readonly' => "readonly"
                                       );
              ...
              <div class="contentForm">
                ...
                $norefer_input = array('name' => 'no_refer',
                                       'value' => $no_refer,
                                       'class' => 'input-wrc',
              ...
              <div class="contentForm">
                <?php
                $namapemohon_input = array('name' => 'nama_pemohon',
                                           'value' => $nama_pemohon,
                                           'class' => 'input-wrc required'
                                          );
              ...
              <div class="contentForm">
                <?php
                $notelp_input = array('name' => 'no_telp',
                                      'value' => $no_telp,
              ...
              <div class="contentForm">
                <?php
                $alamatdata_input = array('name' => 'alamat_pemohon',
              ...
              <div class="contentForm">
                <?php
                $In_kd_kontak = array('name'  => 'kd_kontak',
                                      'value' => $kd_kontak,
                                      'class' => 'input-wrc required'
                                     );
          ...
          <div id="tabs-2">
            ...
            <div id="contentleft">
              ...
              <div class="contentForm">
                <?php
                $nodaftar_input = array('name' => 'nodaftar',
                                        'id' => 'nodaftar_id',
                                        'value' => $nodaftar,
                                        'class' => 'input-wrc'
                                       );
              ...
              <div class="contentForm">
                <?php
                $namaperusahaan_input = array('name' => 'nama_perusahaan',
              ...
              <div class="contentForm">
                <?php
                $telp_input = array('name' => 'telp_perusahaan',
            ...
            <div id="contentright">
              <div class="contentForm">
                <?php echo "<b>".form_label('Provinsi ')."</b>"; ?> </b>
                <?php
                $opsi_propinsi = array('0' => '-------Pilih data-------');
                foreach($list_propinsi as $row){
                  $opsi_propinsi[$row->id] = $row->n_propinsi;
              ...
              <div class="contentForm">
                <?php
                $alamatusaha_input = array('name' => 'alamat_usaha',
                                           'value' => $alamat_usaha,
                                           'class' => 'input-area-wrc',
                                          );
