...
//        $this->output->cache(-1);
        ...
        $data['nama_pemohon'] = "";
        $data['no_telp'] = "";
        $data['propinsi_pemohon'] = 'ok';
        $data['check_ctr'] = 0;
        $data['kabupaten_pemohon'] = 'ok';
        $data['kecamatan_pemohon'] = 'ok';
        $data['kelurahan_pemohon'] = 'ok';
        $data['tgl_daftar'] = "";
        $data['tgl_survey'] = "";
        $data['lokasi_izin'] = "";
        $data['keterangan'] = "";
...
//        var_dump($_POST);
    ...
    if ($this->form_validation->run() == TRUE && $izin_len == $wajib_len)
    {
...
//        }
        ...
        $this->form_validation->set_rules('npwp','Npwp', 'required');
        $this->form_validation->set_rules('tgl_daftar','Tanggal', 'required');
        if ($this->form_validation->run() == TRUE && $update && $izin_len == $wajib_len)
	{
            if ($id_link == '1')
                redirect('pendataan');
            else
