<script type="text/javascript">
    $(document).ready(
	    function(){
            $('#kecamatan_usaha_id').change(
			    function(){
                    $.post('<?php echo  base_url() ;?>perusahaan/kelurahan_usaha', { kecamatan_id: $('#kecamatan_usaha_id').val() },
                        function(data) {$('#show_kelurahan_usaha').html(data);}
                    );
                }
            );
        }
