...
if (count($tbl_perusahaan_approve)>0) {
                  ...
                  $namaPerusahaan = $data_perusahaan->namaPerusahaan;
                  $almtPerusahaan = $data_perusahaan->almtPerusahaan;
                  $telpPerusahaan = $data_perusahaan->telpPerusahaan;
                       endforeach;
                     }
                     ?>
<form action="<?php echo site_url('pengenalimpor/c_pengenalimpor/update_multiple'); ?>" method="post">
<label>Nama Perusahaan : </label>
<input type="text" value="<?php echo $namaPerusahaan;?>" class ="input-wrc" readonly>
<br style="clear: both" />
<label>Alamat Perusahaan : </label>
<input type="text" style="width:500px;" value="<?php echo $almtPerusahaan;?>" class ="input-wrc" readonly>
<br style="clear: both" />
<label>Telepon Perusahaan : </label>
<input type="text" value="<?php echo $telpPerusahaan;?>" class ="input-wrc" readonly>
<br style="clear: both" />

<br>
<input type="submit" name="submit"  value="Approve"  class="submit-wrc">
<input type="submit" name="submit"  value="Revisi"  class="submit-wrc">
