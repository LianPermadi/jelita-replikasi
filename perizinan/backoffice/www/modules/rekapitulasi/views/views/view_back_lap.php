    ...
    <div class="post">
     ...
     <fieldset>
         <legend style="color: #045000" align="bottom">
             <?php
            echo 'Rekapitulasi Berkas Kembali Periode '. $this->lib_date->mysql_to_human($tgla)." - ".$this->lib_date->mysql_to_human($tglb);
            ?>
          </legend>
         <table align=left>
                <tr>
                  ...
                  $img_cetak = array(
                                    ...
                                    'onclick' => 'parent.location=\''. site_url('rekapitulasi/back_lap/cetak').'/'.$tgla.'/'.$tglb. '\''
                                );
       ...
       <table align="center" width="800" border="1" class="display" cellpadding="1" cellspacing="0" id="rev">
            <tr class="title">
                ...
                <td align="center"><font  size="1" color="#1A1A1A"><b>Alasan Kembali</b></font></td>
                <td align="center"><font  size="1" color="#1A1A1A"><b>Tanggal Pengembalian</b></font></td>
                   ...
                   <?php
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo $data['c_pesan']; ?></td>
                            <td align="center"><?php
                                $tgl_ambil = $data['d_ambil_izin'];
                                if($tgl_ambil){
                                    echo $this->lib_date->mysql_to_human($tgl_ambil);
                                }
                                ?>
                            </td>
