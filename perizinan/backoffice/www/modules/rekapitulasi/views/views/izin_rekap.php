                            ...
                            <fieldset>
                                ...
                                <table align=right>
                                    <tr>
                                        <td align="center">
                                            ...
                                            //    'title' => 'Kembal'
                                            //);
											//echo anchor(site_url('rekapitulasi/izin'), img($Back_data));
											$back_data = array(
                                                'name' => 'button',
                                                'content' => 'Kembali',
                                                'value' => 'Kembali',
                                            ...
                                            //echo anchor(site_url('rekapitulasi/izin/cetak') .'/'. $tgla.'/'.$tglb.'/'.$ctk_asal, img($img_cetak));
								...
								<table align="center" width="90%" border="1" class="display" cellpadding="1" cellspacing="0" id="rev">
                                    ...
                                    <tr>
                                        ...
                                        ?>
                                                <tr bgcolor="#FEF9BF">
                                                    <td width="3%"  align="right"><font size="2" color="#1A1A1A"><?php echo $i; ?></td>
												    <td width="43%" align="left"> <font size="2" color="#1A1A1A"><?php echo $data['n_sektor']; ?></font></td>
                                                    <td width="6%"  align="right">
												        <font size="2" color="#1A1A1A">
												            <?php
											                $img_jml_masuk = array(
											                    'alt' => number_format($jumlah_masuk,0,'.','.'),
                                                                'title' => 'Lihat Detail',
                                                                'border' => '0'
                                                            );
														    if($jumlah_masuk == 0 )
												    ...
												    <td width="6%"  align="right">
												        <font size="2" color="#1A1A1A">
													        <?php
														    $img_jml_tolak_FO = array(
											                    'alt' => number_format($jml_tolak_FO,0,'.','.'),
                                                                'title' => 'Lihat Detail',
                                                                'border' => '0'
                                                            );
														    if($jml_tolak_FO == 0 )
                                                    ...
                                                    <td width="6%"  align="right">
												        <font size="2" color="#1A1A1A">
													        <?php
    														$img_jml_terbit = array(
	    										                'alt' => number_format($jumlah_terbit,0,'.','.'),
                                                                'title' => 'Lihat Detail',
                                                                'border' => '0'
                                                            );
					    									if($jumlah_terbit == 0 )
                                                    ...
                                                    <td width="6%"  align="right">
			    									    <font size="2" color="#1A1A1A">
				    									    <?php
					    									$img_terbit_ambil = array(
						    					                'alt' => number_format($terbit_ambil,0,'.','.'),
                                                                'title' => 'Lihat Detail',
                                                                'border' => '0'
                                                            );
										    				if($terbit_ambil == 0 )
                                                    ...
                                                    <td width="6%"  align="right">
				    								    <font size="2" color="#1A1A1A">
    				    									<?php 
						    								$img_terbit_proses = array(
							    				                'alt' => number_format($terbit_proses,0,'.','.'),
                                                                'title' => 'Lihat Detail',
                                                                'border' => '0'
                                                            );
											    			if($terbit_proses == 0 )
                                                    ...
                                                    <td width="6%"  align="right">
			    									    <font size="2" color="#1A1A1A">
				    									    <?php
					    									$img_jml_tolak = array(
						    					                'alt' => number_format($jumlah_tolak,0,'.','.'),
                                                                'title' => 'Lihat Detail',
                                                                'border' => '0'
                                                            );
										    				if($jumlah_tolak == 0 )
                                                    ...
                                                    <td width="6%"  align="right"><font size="2" color="#1A1A1A"><?php echo number_format($tolak_ambil); ?></font></td>
                                                    <td width="6%"  align="right"><font size="2" color="#1A1A1A"><?php echo number_format($tolak_proses); ?></font></td>

				    								<td width="6%"  align="right">
					    							    <font size="2" color="#1A1A1A">
						    							    <?php 
                                                            $img_jml_proses = array(
								    			                'alt' => number_format($jumlah_proses,0,'.','.'),
                                                                'title' => 'Lihat Detail',
                                                                'border' => '0'
                                                            );
												    		if($jumlah_proses == 0 )
									...
									<tr bgcolor="#BFCFFE">
										<td width="47%" align="right" colspan="2"> <font size="2" color="#1A1A1A"><b><?php echo 'TOTAL    '; ?></b></font></td>
                                        <td width="6%"  align="right"><font size="2" color="#1A1A1A"><b><?php echo number_format($t_jumlah_masuk,0,'.','.'); ?></b></font></td>
										<td width="6%"  align="right"><font size="2" color="#1A1A1A"><b><?php echo number_format($t_jml_tolak_FO,0,'.','.'); ?></b></font></td>
                                        <td width="6%"  align="right"><font size="2" color="#1A1A1A"><b><?php echo number_format($t_jumlah_terbit,0,'.','.'); ?></b></font></td>
                                        <td width="6%"  align="right"><font size="2" color="#1A1A1A"><b><?php echo number_format($t_terbit_ambil,0,'.','.'); ?></b></font></td>
                                        <td width="6%"  align="right"><font size="2" color="#1A1A1A"><b><?php echo number_format($t_terbit_proses,0,'.','.'); ?></b></font></td>
                                        <td width="6%"  align="right"><font size="2" color="#1A1A1A"><b><?php echo number_format($t_jumlah_tolak,0,'.','.'); ?></b></font></td>
                                        <td width="6%"  align="right"><font size="2" color="#1A1A1A"><b><?php echo number_format($t_tolak_ambil,0,'.','.'); ?></b></font></td>
                                        <td width="6%"  align="right"><font size="2" color="#1A1A1A"><b><?php echo number_format($t_tolak_proses,0,'.','.'); ?></b></font></td>
                                        <td width="6%"  align="right"><font size="2" color="#1A1A1A"><b><?php echo number_format($t_jumlah_proses,0,'.','.'); ?></b></font></td>
                                    </tr>
                                </table>
                            </fieldset>
							<?php
                                ...
                                <table align=right>
                                    <tr>
                                        <td align="center">
                                            ...
                                            //    'title' => 'Kembali',
                                            //    'onclick' => 'parent.location=\''. site_url('rekapitulasi/izin/rekap_next'). '\''
                                            //);
                                            //echo img($Back_data);
											$back_data = array(
                                                'name' => 'button',
                                            ...
                                            //    'onclick' => 'parent.location=\''. site_url('rekapitulasi/izin/cetak_perjenis').'/'.$tgla.'/'.$tglb. '\''
                                            //);
                                            //echo img($img_cetak);
