          ...
          foreach($obj as $xlist) {
            ...
            <tr>
              ...
              <td>
                ...
                echo $list->kd_gerai.'<br>'.$this->lib_date->mysql_to_human($list->d_terima_berkas).'<br>'.$this->lib_date->mysql_to_human($list->d_selesai_proses).'<br>'.$this->lib_date->mysql_to_human($tmsk->tgl_penetapan);
                ?>
              </td>
