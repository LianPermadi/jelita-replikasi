          ...
          <div id="tabs">
            ...
            if(!$back){ 
              ...
              while($data = mysql_fetch_assoc(@$results)){
                ...
                $query = "select A.id, A.pendaftaran_id, A.c_izin_selesai, A.status_berkas, A.d_ambil_izin, B.trperizinan_id from tmpermohonan A
                ...
                switch($list_kat){
                  ...
                  case 2: // untuk tanggal terima Berkas dan tanggal selesai
                    // or (G.tgl_surat between '$tgla' and '$tglb')";
                    if($list_state === '0') { // Untuk Seluruh Data
                      $query .= "and (A.d_terima_berkas between '$tgla' and '$tglb') 
                ...
                if($list_kat === '0'){  // untuk tanggal terima Berkas
                  if($list_state === '0') { // Untuk Seluruh Data
                    $query = "select a.id, a.pendaftaran_id, a.c_izin_selesai, a.status_berkas, a.d_ambil_izin, b.trperizinan_id from tmpermohonan a
                              ...
                              LEFT JOIN trperizinan_trsektor as t8 on c.id = t8.trperizinan_id
                              where t8.trsektor_id = '".$data['id']."'
                              and c.kd_izin NOT LIKE '99999'
                              and t7.id <> 1
                  ...
                  if($list_state === '0') { // Untuk Seluruh Data
                    $query = "select a.id, a.pendaftaran_id, a.c_izin_selesai, a.status_berkas, a.d_ambil_izin, b.trperizinan_id from tmpermohonan a
                              ...
                              LEFT JOIN trperizinan_trsektor as t10 on c.id = t10.trperizinan_id
                              where t10.trsektor_id = '".$data['id']."'
                              and c.kd_izin NOT LIKE '99999'
                              and t7.id <> 1 
