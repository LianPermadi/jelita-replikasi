    ...
    <div class="post">
        ...
        <div class="entry">
            <fieldset id="half">
                ...
                <?php 
				echo form_open('rekapitulasi/izin/rekap');
                
				//$asal_permohonan = array('0' => '------ Seluruhnya ------','Pusat' => 'Pusat'); // Untuk daerah lain
			    $asal_permohonan = array('0' => '-------- Seluruhnya --------','BPPT Prov. tasikmalaya' => 'BPPT Prov. tasikmalaya','BPMPT Prov. tasikmalaya' => 'BPMPT Prov. tasikmalaya','DPMPTSP Prov. tasikmalaya' => 'DPMPTSP Prov. tasikmalaya',
