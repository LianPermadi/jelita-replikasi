...
//        $data = $this->_funcwilayah();
        ...
        $this->session_info['page_name'] = "Rekapitulasi Izin Tercetak";
        $this->template->build('list_lap_izin', $this->session_info);
    }
     ...
     public function filterData() {
        ...
        $this->session_info['page_name'] = "Rekapitulasi Izin Tercetak";
        $this->template->build('view_lap_izin', $this->session_info);
    }
...
//            $alamat =  $permohonan->tmpemohon->a_pemohon;
        ...
        $odf->setVars('title','Rekapitulasi Izin Tercetak Periode '.$this->lib_date->mysql_to_human($tgla).' s/d '.$this->lib_date->mysql_to_human($tglb));
        ...
        while ($data = mysql_fetch_assoc(@$hasil_data)){
            ...
            $listeArticles3 = array(
                    array(	'property' =>  $i,
                            ...
                            'content3' =>  $this->lib_date->mysql_to_human($tgl_surat),
                            'content4' =>  $data['n_pemohon']." ".$data['a_pemohon'],
                            'content5' =>  $n_perusahaan." ".$data['a_izin'],
                            'content7' =>  $dicetak." kali",
                            'content6' =>  $data['n_perizinan'],
                    ),
