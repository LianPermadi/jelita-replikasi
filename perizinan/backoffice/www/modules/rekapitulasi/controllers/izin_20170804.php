...
//        $data['jum3'] = $this->mohonstatus->where('trstspermohonan_id',14)->count();
    ...
    public function list_data($id_key = null, $menu = null) {
        ...
        $tglb = $username->gvar2;
		$gerai = $username->gvar3;
		$this->lib_date->post_variable($username->id, $tgla, $tglb, $gerai, $id_key, '', '', '', '', '', $menu);   // post variable
...
//                ->get();
        ...
        $this->template->set_metadata_javascript($js);
        $this->session_info['page_name'] = "List Data Perizinan";
...
//		$pdf = new FPDF({p/l},{pt/mm/cm/in},{a3/a4/a5/letter/legal});
		...
		$judul = array('NO','NOMOR PENDAFTARAN','TANGGAL DAFTAR','NAMA PEMOHON / PERUSAHAAN','OBJEK IZIN','NOMOR SK',
			           'TANGGAL SK','TANGGAL DITERIMA ADM','TANGGAL DIAMBIL','KONTAK PERSON');
        ...
        if ($obj){
            foreach ($obj as $list) {
				...
				//$sektor = new trsektor();
				//$n_sektor = $sektor->get_by_id($list->trsektor_id)->n_sektor;
    ...
    public function cetak_OLD($tgla = null, $tglb = null) {
...
//		$sql=" select t1.pendaftaran_id, t3.n_perizinan, t1.a_izin, t1.trsektor_id, t1.d_terima_berkas, t1.kd_gerai, t1.status_berkas, t1.trsektor_id,
//			   t1.d_ambil_izin, t5.n_pemohon, t13.n_permohonan ,t7.n_sts_permohonan, t1.id, t15.n_perusahaan,
//			   t17.no_surat, t17.no_surat_edit, t17.tgl_surat, t17.tgl_surat_edit, t17.tgl_ambil1, t17.kontak 
//			   FROM tmpermohonan as t1
//		       LEFT JOIN tmpermohonan_trperizinan as t2 on t1.id = t2.tmpermohonan_id
  //             LEFT JOIN trperizinan as t3 on t3.id = t2.trperizinan_id
	//		   LEFT JOIN tmpemohon_tmpermohonan as t4 on t4.tmpermohonan_id = t1.id
	...
	//		   LEFT JOIN tmpermohonan_trjenis_permohonan as t12 on t1.id = t12.tmpermohonan_id
      //         LEFT JOIN trjenis_permohonan as t13 on t12.trjenis_permohonan_id = t13.id
        //     ";
//			 RIGHT JOIN tmpermohonan_tmperusahaan as t14 on t14.tmpermohonan_id = t1.id
//               LEFT JOIN tmperusahaan as t15 on t15.id = t14.tmperusahaan_id
//  			   RIGHT JOIN tmpermohonan_tmsk as t16 on t16.tmpermohonan_id = t1.id
//               LEFT JOIN tmsk as t17 on t17.id = t16.tmsk_id
