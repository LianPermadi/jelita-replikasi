  ...
  <div class="post">
    ...
    <div class="entry">
      <fieldset id="half">
        ...
        echo form_open("arsip/arsip", $attr);
        ?>
        <div id="statusRail">
          <div id="leftRail">
            <?php
        ...
        <div id="statusRail">
          ...
          <div id="rightRail">
            ...
            $ctk_arsip = array('name' => 'button',
                               'content' => 'Cetak Arsip',
                               'value' => 'Cetak Arsip',
                               'class' => 'button-wrc',
                               'onclick' => 'parent.location=\''. site_url('arsip/arsip/cetak_arsip') . '\''
                              );
            echo form_button($ctk_arsip);
            $ctk_excl = array('name' => 'button',
                               'content' => 'Cetak Rekap Excel',
                               'value' => 'Cetak Rekap Excel',
                               'class' => 'button-wrc',
                               'onclick' => 'parent.location=\''. site_url('arsip/arsip/cetak_excel') . '\''
                              );
            echo form_button($ctk_excl);
            ?>
          </div>
        </div>
        <?php
          ...
          while($rows = mysql_fetch_assoc(@$results)){
            ...
            <tr>
              ...
              <td valign='top' nowrap="nowrap">
                ...
                echo anchor(site_url('arsip/edit') .'/E/'. $rows['id'].'/0/', img($img_edit))."&nbsp;";   // E:edit; L:List, 0:Menu Asal
	  	          echo anchor(site_url('info/infotracking/detail') .'/'. $rows['id'].'/1', img($img_info));    // 1 = Asal Menu
                ?>
              </td>
            </tr>
            <?php
