<style type="text/css">
.gambar { -webkit-transform: scale(0.5); /* Saf3.1+, Chrome */
      ...
      <fieldset id="half">
        ...
        //cek Mengisi SKM
          ...
          switch($list_daftar->approve){
            case 1 : $vaprove = FALSE; $ket_skm = 'Naskah Dalam Proses Paraf ESL IV'; break;
            ...
            if($save_method == "update") {
              ...
              // $durasi = $lama_hari - $hari_libur;
                ...
                <div id="rightRail">
                  ...
                  if($vhari < $ldurasi){
                    $statdurasi = 'Melebihi Durasi';
                    $b = '<span style="color: Red">';
                    $be = '</span>';
                  }else{
                  	if($vhari > $ldurasi){
                      $statdurasi =  'Kurang dari Durasi';
                      $b = '<span style="color: Green">';
                      $be = '</span>';
                    }else{
                      $statdurasi =  'Sesuai Durasi';
    ...
    <div class="entry">
      <div id="tabs">
        <ul>
          ...
          <li><a href="#tabs-8"><b>DATA SURVEY</b></a></li>
        </ul>
        <?php
        if($paralel == "yes")
        ...
        if($real_id) {
          ...
          <div id="tabs-3">
            <table cellpadding="0" cellspacing="0" border="0" class="display">
              ...
              <tr>
                ...
                <td>
                  <?php if (file_exists('assets/pertekSE/PT_'.$list_daftar->pendaftaran_id.'.pdf') || file_exists('assets/pertek/PT_'.$list_daftar->pendaftaran_id.'.pdf')) { ?>
                    <a href="https://dpmptsp.jabarprov.go.id/jelita/backoffice/arsip/download_pertek/<?php echo $list_daftar->pendaftaran_id; ?>" class="link-wrc">Download</a>
                  <?php } ?>
                </td>
              </tr>
			      </table>
          ...
          <div id="tabs-6">
            ...
            echo '<br>';
            echo '<center>';
            echo '<b>Status Penandatanganan</b>'.'<br>';
            echo '<br>';
      ...
      switch ($asal_menu) {
        ...
        case 14; // dari menu monitoring/approve_izin
          $link = site_url('monitoring/approve_izin');
    			$text = 'Kembali';
          break;    
				case 15; // belum dipakai {buat case berurutan}
          break;
      }
