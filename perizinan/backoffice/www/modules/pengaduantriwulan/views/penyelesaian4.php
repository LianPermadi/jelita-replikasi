...
<form name="form1" method="post">
     ...
     <fieldset>
         <legend style="color: #045000" align="center"><b>
             <?php
			 echo br();
            echo 'Rekap Penyelesaian Pegaduan Triwulan IV Tahun'. $tgla;
             echo br(2);
			?>
          </legend></b>
 <table  width="100%">
        <tr align="center">
          ...
          $img_cetak = array(
                           ...
                           'onclick' => 'parent.location=\''. site_url('pengaduantriwulan/lwpenyelesaian4').'/'.$tgla.'\''
                        );
           ...
           $img_cetak = array(
                           ...
                           'onclick' => 'parent.location=\''. site_url('pengaduantriwulan/lepenyelesaian4').'/'.$tgla.'\'');
...
inner join trsumber_pesan e on e.id=d.trsumber_pesan_id where YEAR(d_entry) = '$thn' and MONTH(d_entry) between'10' and '12' and c_tindak_lanjut='Ya'";
