...
<form name="form1" method="post">
     ...
     <fieldset>
         <legend style="color: #045000" align="center"><b>
             <?php
			 echo br();
            echo 'Rekap Pengaduan Triwulan III Tahun'. $tgla;
             echo br(2);
			?>
          </legend></b>
 <table  width="100%">
        <tr align="center">
          ...
          $img_cetak = array(
                           ...
                           'onclick' => 'parent.location=\''. site_url('pengaduantriwulan/lwrekaptriwulan3').'/'.$tgla.'\''
                        );
           ...
           $img_cetak = array(
                           ...
                           'onclick' => 'parent.location=\''. site_url('pengaduantriwulan/lerekaptriwulan3').'/'.$tgla.'\'');
...
inner join trsumber_pesan e on e.id=d.trsumber_pesan_id where YEAR(d_entry) = '$thn' and MONTH(d_entry) between'07' and '09'";
