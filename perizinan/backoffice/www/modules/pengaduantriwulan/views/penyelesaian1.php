...
<form name="form1" method="post">
     ...
     <fieldset>
         <legend style="color: #045000" align="center"><b>
             <?php
			 echo br();
            echo 'Rekap Penyelesaian Pegaduan Triwulan I Tahun '. $tgla;
             echo br(2);
			?>
          </legend></b>
 <table  width="100%">
        <tr align="center">
          ...
          $img_cetak = array(
                           ...
                           'onclick' => 'parent.location=\''. site_url('pengaduantriwulan/lwpenyelesaian1').'/'.$tgla.'\'');
           ...
           $img_cetak = array(
                           ...
                           'onclick' => 'parent.location=\''. site_url('pengaduantriwulan/lepenyelesaian1').'/'.$tgla.'\'');
     ...
     <table cellpadding="1" cellspacing="0" border="0" class="display" id="reportgrid">
		...
		<tr class="title">
           ...
           <th rowspan="2"><font  size="1" color="#1A1A1A"><b>Isi Pengaduan</b></font></th>
           <th rowspan="2"><font  size="1" color="#1A1A1A"><b>Nama Pengirim</b></font></th>
           <th rowspan="2"><font  size="1" color="#1A1A1A"><b>Telepon</b></font></th>
          
           
           <th rowspan="2"><font  size="1" color="#1A1A1A"><b>Alamat</b></font></th>
		   <!--<th rowspan="2"><font  size="1" color="#1A1A1A"><b>Jmlh Tidak Sesuai Durasi</b></font></th>-->
		   <th rowspan="2"><font  size="1" color="#1A1A1A"><b>Tanggal Pengaduan</b></font></th>
		    <th rowspan="2"><font  size="1" color="#1A1A1A"><b>Sumber Pengaduan</b></font></th>
			 <th rowspan="2"><font  size="1" color="#1A1A1A"><b>Tindakan</b></font></th>
			 <th rowspan="2"><font  size="1" color="#1A1A1A"><b>Status Pengaduan</b></font></th>
...
inner join trsumber_pesan e on e.id=d.trsumber_pesan_id where YEAR(d_entry) = '$thn' and MONTH(d_entry) between'01' and '03' and c_tindak_lanjut='Ya'";
...
<td align="center"><?php echo $tindakan ;?></td>
