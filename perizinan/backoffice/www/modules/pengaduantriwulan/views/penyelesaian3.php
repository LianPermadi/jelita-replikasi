 ...
 <table  width="100%">
        <tr align="center">
          ...
          $img_cetak = array(
                           ...
                           'onclick' => 'parent.location=\''. site_url('pengaduantriwulan/lwpenyelesaian3').'/'.$tgla.'\'' );
           ...
           $img_cetak = array(
                         ...
                         'onclick' => 'parent.location=\''. site_url('pengaduantriwulan/lepenyelesaian3').'/'.$tgla.'\'');
                        echo img($img_cetak);
		 ?>
</td><td>
			 <?php
     ...
     <table cellpadding="1" cellspacing="0" border="0" class="display" id="reportgrid">
		...
		<tr class="title">
		   ...
		   <th rowspan="2"><font  size="1" color="#1A1A1A"><b>Tangga</b></font></th>
