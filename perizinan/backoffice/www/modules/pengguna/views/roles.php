                            ...
                            ?>
                                <li>
                                    ...
                                    if($showed) {
										...
										//$perizinan_trunitkerja->get_by_id($data_izin->id);
										$perizinan_trunitkerja->where('trperizinan_id', $data_izin->id)->get();
                                        $kd_unitkerja = $perizinan_trunitkerja->trunitkerja_id;
                                        $unitkerja = new trunitkerja();
                                        $unitkerja->get_by_id($kd_unitkerja);
										$data_izin->trsektor->get();
										// EOF PBS
                                        $set = array(
                                            'name' => 'izin[]',
                                            'id' => 'izin',
                                        ...
                                        echo form_checkbox($set);
										echo $data_izin->kd_izin.'. BIDANG '.$data_izin->trsektor->n_sektor.'. '.'<b>'.$data_izin->n_perizinan.'</b>';
										// Create PBS
										echo " [ ";
										echo $unitkerja->n_unitkerja;
										echo " ] ";
										// EOF PBS
									}
                                    ?>
