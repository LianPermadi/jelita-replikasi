  ...
  <div class="post">
    ...
    <div class="entry">
      ...
      if($save_method === 'save') {       // Untuk Tambah Pengguna Baru
        ...
        $realname_input = array('name' => 'real_name',
        ...
        $username_input = array('name' => 'user_name_',
                                'class' => 'input-wrc required'
                               );
        ...
        $lokasi_input = array('' => '------ Pilih Salah Satu ------','Pusat' => 'Pusat','Surat' => "Surat",'OPD Teknis' => "OPD Teknis");
        ...
        <div id="tabs">
          ...
          <div id="tabs-2">
            ...
            echo "<br />";
            $edit_realname = array('name' => 'submit',
                                   'class' => 'submit-wrc',
                                   'content' => 'Simpan',
                                   'type' => 'submit',
                                   'value' => 'Simpan Nama'
          ...
          <div id="tabs-3">
            ...
            $password_lbl = array('class' => 'label-wrc',);
              ...
              echo form_label('OLD Password','',$password_lbl);
   				    ...
   				    echo "<br style='clear:both' />";
						...
						$password_input = array('name' => 'password1',
                                    'class' => 'input-wrc required'
                                   );
            ...
            $edit_password = array('name' => 'submit',
                                   'class' => 'submit-wrc',
                                   'content' => 'Simpan',
                                   'type' => 'submit',
            ...
            if($usr_login == '5'){
              $reset = array('name' => 'button',
                             'class' => 'button-wrc',
                             'content' => 'Reset Password',
                             'onclick' => 'parent.location=\''. site_url('pengguna') . '/reset/'.$id.'\''
                            );
