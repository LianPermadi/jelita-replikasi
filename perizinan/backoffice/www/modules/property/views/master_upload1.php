      ...
      <fieldset id="half">
        ...
        <form action="<?php echo site_url('property/master/upload2/' .$id); ?>" method="post" enctype="multipart/form-data">
          <select name="jenis" class="input-select-wrc valid">
            <option value="kadis">Template SK</option>
            <option value="pertek">Template Pertek</option>
            <option value="cabut">Template Pencabutan</option>
          </select><br>
          <input type="file" name="fileToUpload" id="fileToUpload" class="submit-wrc" value="Pilih file" required>
          <input type="submit" class="submit-wrc" style="text-decoration:none; float:right; width:100px;" name="submit" value="NEXT" />
        </form>        
      </fieldset>
