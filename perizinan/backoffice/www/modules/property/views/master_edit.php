...
<div id="content">
  <div class="post">
    ...
    <div class="entry">
      <?php
      if($method !== 'editing') {   // Jika edit property
        ?>
        <div id="tabs">
          <ul>
          ...
          <div id="tabs-1">
            ...
            <fieldset>
              <div id="statusMain">
                ...
                <div id="rightMain">
                  <?php
                  $user_name_input = array('name' => 'n_property',
                                           'value' => $n_property,
              ...
              <div id="statusMain">
                ...
                <div id="rightMain">
                  <?php
                  $parent_order_input = array('name' => 'c_parent_order',
              ...
              <div id="statusMain">
                ...
                <div id="rightMain" class="bg-grid">
                  <?php
                  $order_input = array('name' => 'c_order',
                                       'value' => $c_order,
                                       'class' => 'input-wrc required digits',
                                       'id' => 'c_order');
              ...
              <div id="statusMain">
                ...
                <div id="rightMain">
                  <?php
                  $data_0 = array('name' => 'c_tmp_sk',
                                  'type' => 'radio',
                                  'checked'=>TRUE,
                                  'value'=> 'Tidak');
                  $data_1 = array('name' => 'c_tmp_sk',
                                  'type' => 'radio',
                                  'value'=> 'Ada');
              ...
              <div id="statusMain">
                <div id="leftMain" class="bg-grid">
                  <label class="label-wrc">Tampilkan di Pemohon Online</label>
                </div>
                <div id="rightMain" class="bg-grid">
                  <?php
                  $data_0a = array('name' => 'c_tmp_ol',
                                   'type' => 'radio',
                                   'checked'=>TRUE,
                                   'value'=> 'Tidak');
                  $data_1a = array('name' => 'c_tmp_ol',
                                   'type' => 'radio',
                                   'value'=> 'Ya');
              ...
              <div id="statusMain">
                <div id="leftMain">
                  <label class="label-wrc">Tampilkan di Pencabutan</label>
                </div>
                <div id="rightMain">
                  <?php
                  $data_0ab = array('name' => 'c_skrd_id', //eks SKRD jadi Pencabutan
                                    'type' => 'radio',
                                    'checked'=>TRUE,
                                    'value'=> 'Tidak');
                  $data_1ab = array('name' => 'c_skrd_id',
                                    'type' => 'radio',
                                    'value'=> 'Ya');
              ...
              <div id="statusMain">
                ...
                <div id="rightMain">
                  <?php
                  $add_property = array('name' => 'submit',
                                        'class' => 'submit-wrc',
                                        'content' => 'Simpan',
                                        'type' => 'submit',
                                        'value' => 'Simpan');
        ...
        <?php
      }else{       // Jika Tambah Property Baru, mulai tampil di edit
        $attr = array('id' => 'form');
        echo form_open('property/master/save_property',$attr);
        echo form_hidden('id_izin', $id_izin);
        echo form_hidden('id_property', $id_property);
        ...
        <fieldset>
          ...
          <div id="statusMain">
            ...
            <div id="rightMain" class="bg-grid">
              <?php
              $c_parent_input = array('name' => 'c_parent',
                                      'value' => $c_parent,
                                      'class' => 'input-wrc required',
                                      'id' => 'c_parent');
          ...
          <div id="statusMain">
            ...
            <div id="rightMain" class="bg-grid">
              <?php
              $combo_item_input = array('name' => 'combo_item',
                                        'value' => $combo_item,
                                        'class' => 'input-wrc required',
                                        'id' => 'combo_item');
          ...
          <div id="statusMain">
            ...
            <div id="rightMain">
              ...
              $data_0b = array('name' => 'c_aktif',
                               'type' => 'radio',
                               'checked' => $code_choise_0,
                               'value' => 'Tidak');
              $data_1b = array('name' => 'c_aktif',
                               'type' => 'radio',
                               'checked' => $code_choise_1,
                               'value' => 'Ya');
              echo form_checkbox($data_0b); echo "Tidak";
