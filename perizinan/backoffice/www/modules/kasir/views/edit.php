      ...
      <fieldset>
        ...
        <div id="statusMain">
          ...
          <div id="rightMain"class="bg-grid">
            ...
            echo $ctk_no_surat .' '. $ctk_no_surat1;
            ?>
          </div>
          ...
          <?php
          if($ctk_no_surat1 != ''){  // Hanya Untuk AKDP
	          ...
	          if($berlaku_kp_lama == '0000-00-00'){
	          	...
	          	$dt_kend = $dbakdp->query("select * from akdpkendaraan_history
                                         where no_uji ='".$akdp_cetak->no_uji."' ORDER BY id DESC")->first_row();
              $berlaku_kp_lama = $dt_kend->tgl_kp_akhir;
              if($berlaku_kp_lama == '0000-00-00'){
            ...
            ?>
            <div id="leftMain">
              <?php echo form_label('Masa Berlaku KP Lama', 'tgl_kp_lama'); ?>
            </div>
            <div id="rightMain">
              <?php
              echo $this->lib_date->mysql_to_human($berlaku_kp_lama);
              ?>
            </div>
            <?php
          }
