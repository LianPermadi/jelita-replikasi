      ...
      <table cellpadding="0" cellspacing="0" border="0" class="display" id="permohonan">
        ...
        <tbody>
          ...
          while ($rows = mysql_fetch_assoc(@$results)){
            ...
            if(($idkelompok == '3' || $idkelompok == '4') && ($rows['c_tinjauan'] === "1")){    
              ...
              if($showed){
                ...
                <tr>
                  ...
                  <td valign='top'>
                    <?php
                    $img_skrd = array('src' => 'assets/images/icon/clipboard-doc.png',
                                      'alt' => 'Penetapan SKRD',
                                      'title' => 'Penetapan SKRD',
                                      'border' => '0');
  	                echo anchor(site_url('kasir/create_skrd') .'/'. $rows['id'] .'/'. $rows['retribusi_id'], img($img_skrd))."&nbsp;";
