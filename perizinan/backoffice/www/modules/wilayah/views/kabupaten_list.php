            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="kegiatan">
                ...
                <tbody>
                    ...
                    <center>
                        ...
                        echo anchor(site_url('wilayah/kabupaten/edit') . '/' . $data->id, img($img_edit)) . '&nbsp;';
                        $confirm_text = 'Apakah Anda yakin akan menghapusnya?';

                        if (in_array($data->id, $my_excep)) {
                            
                        } else {
                            echo anchor(site_url('wilayah/kabupaten/delete') . '/' . $data->id, img($img_delete), ' onClick="return confirm_link(\'' . $confirm_text . '\');"');
                        }
                        ?>
                    </center>
                    </td>
