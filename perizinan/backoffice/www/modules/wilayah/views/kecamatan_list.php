    ...
    <div class="post">
        ...
        <div class="entry">
            ...
            $add_holiday = array(
                'name' => 'button',
                'class' => 'button-wrc',
                'content' => 'Tambah Kecamatan',
                'onclick' => 'parent.location=\'' . site_url('wilayah/kecamatan/create') . '\''
            );
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="kegiatan">
                ...
                <tbody>
                    ...
                    foreach ($list_kecamatan as $data) {
                        ...
                        <tr>
                            <td><?php echo $i; ?></td>
                            <td><?php echo $data->n_kecamatan; ?></td>
                            <td><?php echo $data->n_kabupaten; ?></td>
                    ...
                    <center>
                            ...
                            echo anchor(site_url('wilayah/kecamatan/edit') . '/' . $data->id, img($img_edit)) . '&nbsp;';
                            $confirm_text = 'Apakah Anda yakin akan menghapusnya?';
                            if (in_array($data->id, $my_excep)) {

                            } else {
                                echo anchor(site_url('wilayah/kecamatan/delete') . '/' . $data->id, img($img_delete), ' onClick="return confirm_link(\'' . $confirm_text . '\');"');
                            }
                            ?>
                    </center>
                    </td>
