...
//                                                $kec  = $data->trkecamatan->get();
//						$kab  = $data->trkabupaten->get();
//						$prov = $data->trpropinsi->get();

						//$kec_kel = new trkecamatan_trkelurahan();
						//$kec_kel->where('trkeluruhan_id',$data->id)->get();
                        //$kec = new trkecamatan();
						//$kec->where('id',$kec_kel->trkecamatan_id)->get();
						//$kab = $kec->trkabupaten->get();
						//$prov = $kab->trpropinsi->get();
