...
<div id="content">
    <div class="post">
        ...
        if ($list_propinsi->id) {
            foreach ($list_propinsi as $row) {
                $opsi_propinsi[] = '--------Pilih salah satu-------';
    ...
    <?php
        ...
        {
            echo form_dropdown('propinsi', $opsi_propinsi,'0','class = "input-select-wrc required min" id="propinsi_pemohon_id" ');
        }
    ?>
                        </div>
    ...
    <?php
        ...
        echo "<div id='show_kabupaten'>".form_label('Kabupaten')." Data Tidak Tersedia</div><br>";
