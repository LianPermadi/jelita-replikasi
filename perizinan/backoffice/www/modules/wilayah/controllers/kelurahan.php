...
//        }
        ...
        $sql ="update trkelurahan set n_kelurahan='".$kelurahan."' where id='".$id."'";
    ...
    public function sql()
    {
        $query = "select a.id, a.n_kelurahan, b.n_kecamatan, d.n_kabupaten, f.n_propinsi from trkelurahan as a
                  ...
                  left join trkecamatan as b on c.trkecamatan_id=b.id
                  left join trkabupaten_trkecamatan as e on e.trkecamatan_id = b.id
                  left join trkabupaten as d on e.trkabupaten_id=d.id
                  left join trkabupaten_trpropinsi as g on g.trkabupaten_id=d.id
                  left join trpropinsi as f on g.trpropinsi_id = f.id";
        //$query = "select a.id, a.n_kelurahan from trkelurahan as a
        //          ";
