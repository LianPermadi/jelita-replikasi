              ...
              <tr>
                ...
                <td>
                  <select class="pilihan" name="id_ruangan" id="ruanganSelect" style="width:40%">
                    ...
                    <?php
                    $base_url = "https://dpmptsp.jabarprov.go.id/jelita/backoffice/assets/ruangan/image/";
                    foreach ($ruangan as $rowRuangan) {
                      if ($rowRuangan->status == 0) {
                        $b = '<span style="color: Blue">';
                        $be = '</span>';
                      ...
                      if($foto == NULL){
                        ...
                        if($this->id == 941){ // id ini sedang dipaksa biar isi foto ruangan 
                ...
                <td class="bg-grid">
                  <select class="pilihan" name="seksi" style="width:25%">
                      <?php foreach ($koor as $tim): ?>
                        <option value="<?php echo $tim->id; ?>" <?php echo ($seksi == $tim->id ? "selected" : ""); ?>><?php echo $tim->nama_tim; ?></option>
                      <?php endforeach ?>
                  </select>
                </td>
                <!-- <td class="bg-grid">
