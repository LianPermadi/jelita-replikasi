      ...
      <table cellpadding="0" cellspacing="0" border="0" class="display" id="pendataan">
        ...
        <tbody>
          ...
          ?>
            <tr>
              <td><?php echo $i; ?></td>
              <td><?php echo $b.$this->m_perdin->get_n_pegawai($row->id_pegawai)." <br> ".$this->m_perdin->get_n_nip($row->id_pegawai)." <br> ".$this->m_perdin->get_n_jabatan($row->id_pegawai)." <br> ".$be; ?></td>
              ...
              <td><?php echo $b.$this->m_perdin->get_n_user($row->user_id)." <br> ".$row->uraian.$be; ?></td>
               ...
               <td><?php echo '<a href="'.base_url().'perdin/ubah/'.$row->id.'"><img src="'.
                           base_url().'assets/images/icon/property.png" alt="Edit Perdin" title="Edit Perdin" border="0"></a>
                           &nbsp;';
                  ...
                  //                      );
                  //   echo anchor(site_url('perdin/hapus/')."/".$row->id, img($img_delete))."&nbsp;";
      ...
      <div class="entry">
        ...
        ?>
             <div id="statusRail">
              ...
              <div id="rightRail">
                <?php
                $periodeawal_input = array('name'  => 'tglc',
                                           'value' => $tglc,
                                           'class' => 'input-wrc',
                                           'readOnly'=>TRUE,
                                           'class' => 'monbulan'
            ...
            <div id="statusRail">
              ...
              <div id="rightRail">
                <?php
                $periodeakhir_input = array('name'  => 'tgld',
                                            'value' => $tgld,
                                            'class' => 'input-wrc',
                                            'readOnly'=>TRUE,
                                            'class' => 'monbulan'
