  ...
  <table cellpadding="0" cellspacing="0" border="0" class="display" id="pendataan">
      <thead>
        <tr>
          ...
          <th width="10%">No Surat Perintah</th>
          <!-- <th width="10%">id tim</th> -->
          <th width="10%">Kabupaten/Kota Tujuan</th>

          <th width="10%">Tanggal Berangkat <br> Tanggal Kembali</th>
          <th width="15%">List Pegawai Perdin</th>
          <th width="15%">Preview/Download SP pegawai </th>
          <th width="15%">Preview/Download SP Kepala Dinas</th>
          <th width="15%">Preview/Download SP Sekretaris Dinas</th>
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td><?php echo $b . $row->no__sppd . " <br> ". $be; ?></td>
            <!-- <td><?php echo $b . $row->id_tim . " <br> ". $be; ?></td> -->
            <td>
                    <?php
                        ...
                        // var_dump($tujuan_keberangkatan_perdin);
            ...
            <td>
                ...
                <?php echo $b . $this->lib_date->mysql_to_human($row->tanggal_berangkat) . "<br>" . $this->lib_date->mysql_to_human($row->tanggal_kembali) . $be; ?>
            </td>
            ...
            <?php
                ...
                $perdin_no_grup = $this->m_perdin->get_perdin($row->no_grup_perdin, $row->id_tim);
                ...
                <td>
                    ...
                    ?>
                        ...
                        <?php elseif ($preview->id_pegawai == 1061): ?>
                            <!-- Condition for id_pegawai 1061 -->
                        <?php else: ?>
                            <?php 
            ...
            <td>
              ...
              <?php foreach ($search_preview as $preview) { 
                        if ($preview->no_grup_perdin == $row->no_grup_perdin && $preview->id_tim == $row->id_tim ) { 
                ?>
                    <?php if ($preview->id_pegawai == 1061): ?>
                        <!-- Kondisi untuk id_pegawai 1061 -->
