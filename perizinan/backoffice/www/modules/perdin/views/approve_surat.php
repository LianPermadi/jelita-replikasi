  ...
  <div class="post">
    ...
    <div class="entry">
      ...
      <!-- <span style="color:red;">*</span><h3>Tambahkan ${no_surat} pada SP Perjalanan Dinas untuk menambahkan Nomor Surat</h3> -->
        <div id="tabs">
          <ul>
                    <li><a href="#tabs-<?php echo $perdin_grup->id_pegawai?>">Approve Surat Perintah Perjalanan Dinas</a></li>

          </ul>
                
                    <div id="tabs-<?php echo $perdin_grup->id_pegawai?>">
                        <h2>Detail Pemberangkatan</h2>
                        <form method="post" action="<?php echo site_url().'perdin/update_approve_surat/'.$perdin_grup->no_grup_perdin.'/'.$perdin_grup->id_tim; ?>" enctype="multipart/form-data">
                            ...
                            <div class="entry" style="text-align: center;">
                              <div style="margin-bottom: 30px;">
                                <h2>Approve Surat Perintah</h2>
                                   
                                        <?php 
                                        // Jika user_id == 182, tampilkan select disabled dan hidden input
                                        if ($user_id == 57 || $admin == 1) {
                                            // Select disabled untuk dinas lain
                                            if ($perdin_grup->status_approve == 1 || $admin == 1) {
                                                echo '<select class="pilihan" name="status_approve" id="status_approve" style="width: 100%;">';
                                            }else {
                                                echo '<select class="pilihan" name="status_approve" id="status_approve" onchange="file_surat()" style="width: 100%" disabled>';
                                            }
                                            // Menentukan nilai selected berdasarkan kondisi
                                            echo '<option value="2" ' . ($perdin_grup->status_approve == 2 ? 'selected' : '') . '>Ya, Approve Surat</option>';
                                            echo '<option value="1" ' . ($perdin_grup->status_approve == 1 ? 'selected' : '') . '>Tidak, Approve Surat</option>';
                                            echo '</select>';
