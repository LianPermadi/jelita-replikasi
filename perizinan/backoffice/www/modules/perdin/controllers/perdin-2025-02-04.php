...
// }
  ...
  public function update_penomoran($id, $id_tim) {
    ...
    $srt_instansi_undangan = $this->input->post('srt_instansi_undangan');
        ...
        \PhpOffice\PhpWord\Autoloader::register();
          foreach ($data as $key => $data_file) {
            ...
            if ($data_file->id_pegawai == "31") {
              $filename = 'assets/file_surat_perdin/kadis_sekdis/SPPD_' . date('Ymd') . '_' . $data_file->no_grup_perdin . '_' . $kode_tim_file->kode_tim_koor . '_sekdis.docx';
              $filename_simpan = 'SPPD_' . date('Ymd') . '_' . $data_file->no_grup_perdin . '_' . $kode_tim_file->kode_tim_koor . '_sekdis.docx';
      
            }else{
              $filename = 'assets/file_surat_perdin/SPPD_' . date('Ymd') . '_' . $data_file->no_grup_perdin . '_' . $kode_tim_file->kode_tim_koor . '_penomoran_pegawai.docx';
              $filename_simpan = 'SPPD_' . date('Ymd') . '_' . $data_file->no_grup_perdin . '_' . $kode_tim_file->kode_tim_koor . '_penomoran_pegawai.docx';
            }
        ...
        $simpan = $this->m_perdin->update_e_perdin_by_no_grup_perdin($id, $data);
...
public function update ($id,$id_tim) {
  ...
  // var_dump($pkepada);die();
  // var_dump($this->input->post('kode_rek_sub_req'));die();
    ...
    if (count($tujuan) > 3) {
      ...
      \PhpOffice\PhpWord\Autoloader::register();
        ...
        $test = $this->m_perdin->hapus_perdin_by_no_grup_perdin($id,$id_tim);
        // // var_dump($test);die();
        // $no_grup_terakhir = $this->m_perdin->get_no_grup_terakhir();
        // if ($no_grup_terakhir) {
        //     // Jika ada nomor grup terakhir, tambahkan 1
        //     $no_grup_perdin = $no_grup_terakhir + 1;
        // } else {
        //     // Jika belum ada nomor grup, mulai dari 1
        //     $no_grup_perdin = 1;
        // }
        ...
        if (in_array("31", $pkepada) || in_array("1061", $pkepada)) {
          ...
          if (in_array("31", $pkepada)) {
            ...
            if ($tipe_undangan == 1) {
              ...
              $filename_pa_sekdis = 'assets/file_surat_perdin/kadis_sekdis/SPPD_' . date('Ymd') . '_' . $no_grup_perdin . '_' . $kode_tim_file->kode_tim_koor . '_sekdis.docx';
              $filename_pa_sekdis_simpan = 'SPPD_' . date('Ymd') . '_' . $no_grup_perdin . '_' . $kode_tim_file->kode_tim_koor . '_sekdis.docx';
              ...
              $bln_ttd = str_replace("Pebruari", "Februari", $bln_ttd); // Nama bulan
                  ...
                  foreach ($filtered_data as $index => $pegawai) {
                    ...
                    // Mengganti nama bulan dengan bulan dalam Bahasa Indonesia
 ...
 // Mengatur lokal ke Bahasa Indonesia
          ...
          if (in_array("1061", $pkepada)) {
            ...
            if ($tipe_undangan == 1) {
              ...
              $bln_ttd = str_replace("Pebruari", "Februari", $bln_ttd); // Nama bulan
                      ...
                      // var_dump($tgl_ttd ,$bln_ttd ,$tahun_text);die();
                ...
                $templateProcessor->setValue("brtmpt", $final_location_string);
                    ...
                    $templateProcessor->setValue("golongan#{$index}", $pegawai['golongan']); 
                      ...
                      $templateProcessor->deleteBlock('nomor_induk_pegawai_row');
                      // $filename_bukadis = 'assets/file_surat_perdin/kadis_sekdis/SPPD_' . date('YmdHis') . '_bu_kadis.docx';

                      //   $data = [
                      //     'file_srt' => $filename_bukadis,
                      //   ];
                      // $update_perdin = $this->m_perdin->update_e_perdin($pegawai['id_perdin'], $data);
                  }
                    $filename_bukadis = 'assets/file_surat_perdin/kadis_sekdis/SPPD_' . date('Ymd') . '_' . $no_grup_perdin . '_' . $kode_tim_file . '_kadis.docx';
                    $filename_bukadis_simpan = 'SPPD_' . date('Ymd') . '_' . $no_grup_perdin . '_' . $kode_tim_file . '_kadis.docx';
                    $data = [
              ...
              $bln_ttd = str_replace("Pebruari", "Februari", $bln_ttd); // Nama bulan
                ...
                $templateProcessor->setValue("brtmpt", $final_location_string);
                    ...
                    $filename_bukadis = 'assets/file_surat_perdin/visum_kadis/SPPD_' . date('Ymd') . '_' . $no_grup_perdin . '_' . $kode_tim_file . '_visum_kadis.docx';
                    $filename_bukadis_simpan = 'SPPD_' . date('Ymd') . '_' . $no_grup_perdin . '_' . $kode_tim_file . '_visum_kadis.docx';
              ...
              $bln_ttd = str_replace("Pebruari", "Februari", $bln_ttd); // Nama bulan
                ...
                $templateProcessor->setValue("brtmpt", $final_location_string);
                      ...
                      if (!empty($pegawai['pangkat_gol']) && strtolower($pegawai['pangkat_gol']) != 'tenaga kontrak') {
                        ...
                        $templateProcessor->setValue("nama_kolom_nip#{$index}", 'Nomor Induk Pegawai');
                        $templateProcessor->setValue("nip#{$index}", '-');
                        $pangkatGolongan = (isset($pegawai['pangkat_gol']) && isset($pegawai['golongan']) && $pegawai['pangkat_gol'] !== '' && $pegawai['golongan'] !== '') 
                            ? $pegawai['pangkat_gol'] . '/' . $pegawai['golongan'] 
                            : '';
                ...
                $templateProcessor->setValue("brtmpt", $final_location_string);
                    ...
                    if (!empty($pegawai['pangkat_gol']) && strtolower($pegawai['pangkat_gol']) != 'tenaga kontrak') {
                      ...
                      : 'Non ASN';
                                      ...
                                      $templateProcessor->setValue("Pangkat_golonga", $pangkatGolongan);
                        $templateProcessor->setValue("nama_kolom_nip", 'Nomor Induk Pegawai');
                        $templateProcessor->setValue("nip", $pegawai['nip']);
                    } else {
                      $templateProcessor->setValue("nama_kolom_nip#{$index}", 'Nomor Induk Pegawai');
        ...
        if (isset($_FILES["file_srt"]) && $_FILES["file_srt"]["name"] != "") {
            ...
            $file_srt = 'SPPD_' . date('Ymd') . '_' . $no_grup_perdin . '_' . $kode_tim_file->kode_tim_koor . '_pegawai_upload.'.$ext;
            ...
            foreach ($filtered_data as $index => $pegawai) {
              ...
              $update_perdin = $this->m_perdin->update_e_perdin($pegawai['id_perdin'], $data);
                ...
                if ($pegawai->id_pegawai == "31") {
                    $filename = 'assets/file_surat_perdin/kadis_sekdis/SPPD_' . date('Ymd') . '_' . $pegawai['no_grup_perdin'] . '_' . $kode_tim_file->kode_tim_koor . '_sekdis.docx';
                    $filename_simpan = 'SPPD_' . date('Ymd') . '_' . $pegawai['no_grup_perdin'] . '_' . $kode_tim_file->kode_tim_koor . '_sekdis.docx';
                } else {
                    $filename = 'assets/file_surat_perdin/SPPD_' . date('Ymd') . '_' . $pegawai['no_grup_perdin']. '_' . $kode_tim_file->kode_tim_koor . '_penomoran_pegawai.docx';
                    $filename_simpan = 'SPPD_' . date('Ymd') . '_' . $pegawai['no_grup_perdin']. '_' . $kode_tim_file->kode_tim_koor . '_penomoran_pegawai.docx';
                }
          ...
          $count = count($filtered_data);
            ...
            foreach ($filtered_data as $index => $pegawai) {
             ...
             // Format tanggal dengan strftime
              ...
              $templateProcessor->setValue("tgl_kepulangan#{$index}", $tglKepulangan);
            ...
            $templateProcessor->setValue('tgl_surat', "{$tgl_ttd} {$bln_ttd} {$tahun_text}");
              ...
              $templateProcessor->deleteBlock('nomor_induk_pegawai_row');
              $filename = 'assets/file_surat_perdin/SPPD_' . date('Ymd') . '_' . $no_grup_perdin . '_' . $kode_tim_file->kode_tim_koor . '_pegawai.docx';
    
              $filename_pegawai = 'SPPD_' . date('Ymd') . '_' . $no_grup_perdin . '_' . $kode_tim_file->kode_tim_koor . '_pegawai.docx';
  ...
  public function simpan_perdin() {
    ...
    function hitungHari($tgl_awal, $tgl_akhir) {
        ...
        return $selisih + 1; // Menambahkan 1 agar hari pertama dihitung
    }
    ...
    if (count($pkepada) > 4 ) {
      ...
      if (in_array("31", $pkepada) || in_array("1061", $pkepada)) {
            ...
            if (isset($_FILES["file_srt"]) && $_FILES["file_srt"]["name"] != "") {
              ...
              // var_dump($tipe_undangan);die();

                      $templateFile = 'assets/file_surat_perdin/template_surat_perdin/surat_perintah_template_4_orang.docx';
                  }
              } else {
                  $templateFile = 'assets/file_surat_perdin/template_surat_perdin/surat_perintah_template.docx';
              }
              // Memproses file template yang dipilih
              $templateProcessor = new \PhpOffice\PhpWord\TemplateProcessor($templateFile);
              ...
              // Menggabungkan semua elemen menjadi nomor dengan format yang diinginkan
              $nomor_format = $no_grup_perdin . '/LKK/' . $kode_tim_file . '/' . $kode_tim_file;
              ...
              foreach ($filtered_data as $index => $pegawai) {
                ...
                $templateProcessor->deleteBlock('nomor_induk_pegawai_row');
                $filename = 'assets/file_surat_perdin/SPPD_' . date('Ymd') . '_' . $no_grup_perdin . '_' . $kode_tim_file . '_pegawai.docx';
                $filename_pegawai = 'SPPD_' . date('Ymd') . '_' . $no_grup_perdin . '_' . $kode_tim_file . '_pegawai.docx';
                ...
                if ($tipe_undangan == 1) {
                    ...
                    $kode_tim = $kode_tim_file->kode_tim_ketua;
                      foreach ($filtered_data_bu_kadis as $index => $pegawai) {
                        ...
                        $filename_bukadis = 'assets/file_surat_perdin/kadis_sekdis/SPPD_' . date('Ymd') . '_' . $no_grup_perdin . '_' . $kode_tim_file->kode_tim_koor . '_kadis.docx';
                        $filename_bukadis_simpan = 'SPPD_' . date('Ymd') . '_' . $no_grup_perdin . '_' . $kode_tim_file->kode_tim_koor . '_kadis.docx';
                        ...
                        $templateProcessor->setValue("tgl_srt_undangan#{$index}", $tgl_srt_undangan);
                          ...
                          $filename_bukadis = 'assets/file_surat_perdin/visum_kadis/SPPD_' . date('Ymd') . '_' . $no_grup_perdin . '_' . $kode_tim_file->kode_tim_koor . '_visum_kadis.docx';
                          $filename_bukadis_simpan = 'SPPD_' . date('Ymd') . '_' . $no_grup_perdin . '_' . $kode_tim_file->kode_tim_koor . '_visum_kadis.docx';
                          $templateProcessor->saveAs($filename_bukadis);
        ...
        $count = count($filtered_data);
          ...
          foreach ($filtered_data as $index => $pegawai) {
           ...
           // Format tanggal dengan strftime
            ...
            // var_dump($tanggalBerangkat_1);die();
            ...
            if (count($kab_kota_array) == 1) {
                ...
                $templateProcessor->setValue("tglKeberangkatan_1", 'Kota Bandung');
                $templateProcessor->setValue("tglKeberangkatan_2", '');
                $templateProcessor->setValue("tglKeberangkatan_3", '');
