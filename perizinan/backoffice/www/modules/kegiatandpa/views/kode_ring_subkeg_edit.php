...
// var_dump($kodering);die();
  if (!empty($kodering)) {
    $id = $kodering->id;
    $id_kode_ring = $kodering->id_kode_ring;
    $kode_sub_ring = $kodering->kode_sub_ring;
    $uraian_sub_kegiatan = $kodering->uraian_sub_kegiatan;
    ...
    $r11 = $kodering->r11;
    $r12 = $kodering->r12;
    $keterangan = $kodering->keterangan;
  } else {
    $id_kode_ring = "";
    $kode_sub_ring = "";
    $uraian_sub_kegiatan = "";
...
<div id="content">
  <div class="post">
          ...
          <table cellpadding="0" cellspacing="0" border="0" class="display">
            <tbody>
              <tr>
                ...
                <td class="bg-grid">
                  <select class="pilihan" name="id_kode_ring" style="width:100%">
                      <?php foreach ($get_kode_ring as $kodering): ?>
                        <option value="<?php echo $kodering->kode_ring; ?>" <?php echo ($id_kode_ring == $kodering->kode_ring ? "selected" : ""); ?>><?php echo $kodering->kode_ring.' | '.$kodering->uraian_kegiatan; ?></option>
                      <?php endforeach ?>
              ...
              <tr>
                ...
                <td>
                  <input type="text" name="kode_sub_ring" style="width:100%" class="input-wrc" value="<?php echo $kode_sub_ring; ?>" required="required">
                </td>
              </tr>
              <tr>
                <td align="left" width="15%">
                  <b>Uraian Sub Kegiatan</b>
                </td>
                <td>
                  <input type="text" name="uraian_sub_kegiatan" style="width:100%" class="input-wrc" value="<?php echo $uraian_sub_kegiatan; ?>" required="required">
                </td>
              </tr>
              <tr>
                <td align="left" width="15%" class="bg-grid">
    ...
    <div class="entry" style="text-align: center;">
      <?php 
        if ($step == "kode_ring_subkeg_simpan") { ?>
      ...
      <span></span>
      <button name="button" type="button" class="button-wrc" onclick="parent.location='<?php echo site_url('kegiatandpa/kode_ring_subkeg'); ?>'">Batal</button>
    </div>
  </form>
  </div>
  <br style="clear: both;" />
