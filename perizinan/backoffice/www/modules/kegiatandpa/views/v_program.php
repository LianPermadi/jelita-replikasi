  ...
  <div class="post">
    ...
    <div class="entry">
      ...
      $img_cetak_excel = array('src' => base_url().'assets/images/icon/excel.png',
        ...
        if ($iduser == 553 || $iduser == 307) { //
          echo anchor(site_url('kegiatandpa/print_excel_renaksi').'/'.(!empty($tgla) && !empty($tglb) ? $tgla.'/'.$tglb : '0/0'), img($img_cetak_excel));
        }
        echo form_close();
      ?>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              ...
              ?>
              <?php 
                echo '<a href="'.base_url().'kegiatandpa/buat_renaksi/'.$row->id.'"><img src="'.base_url().'assets/images/icon/arrow_icon.png" alt="Teruskan ke Anggota" title="Buat Renaksi" border="0"></a>&nbsp;';
              ?>
              <?php if($admin) { ?>
