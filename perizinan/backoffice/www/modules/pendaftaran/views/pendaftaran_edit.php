<script>
    ...
    function validasi()
    {
        ...
        if(tgl2 < tgl1 && tgl2!=='')
        {
            $('#coba').html("<p id='eror'>Tanggal "+jn+" izin tidak boleh lebih kecil dari tanggal Penyerahan berkas ("+(dd + " " + m_names[mm] 
                + " " + yy)+")</p>");
        ...
        else if(tgl3 < tgl2)
        {
            ...
            $('#coba').html("<p id='eror'>Tanggal survei "+jn+" izin tidak boleh lebih kecil dari tanggal "+jn+" izin ("+(ddd + " " + m_names[mmm] 
                + " " + yyy)+")</p>");
            return false;
        }
        else
                ...
                <fieldset>
                    ...
                    <div id="statusRail">
                        ...
                        <div id="rightRail">
                            ...
                            ?>
                            <input type="hidden" value="<?php echo $tglsurvey; ?>" name="txttglselesai" id="txttglselesai" />
                ...
                if ($id_daftar) {
                    ...
                    <div id="tabs-1">
                        <div id="contentleft">
                            ...
                            echo $tgldaftar_input; //echo form_label('Tgl Terima Berkas ');
                            echo form_input($tgldaftar_input);
                            ?>
                                                        </div>
                                                        <br style="clear: both;" />-->
                        ...
                        <div id="contentright">
                            ...
                            <div class="contentForm">
                                ...
                                echo form_label('Alamat Pemohon<br />di Luar Negeri<br />(Qisikan jika ada)');
