...
/**
 * Description of Pendaftaran Perpanjangan Izin
 *
 * @author agusnur
 * Created : 25 Sep 2010
 */
class Perpanjangan extends WRC_AdminCont {
    ...
    public function __construct() {
        ...
        $this->jenis_id = "3"; // Perpanjangan Izin
    }
    ...
    public function index() {
        ...
        $js =  "
                ...
                $(document).ready(function() {
                    $('#izin_id').change(function(){
                            ...
                            $.post('". base_url() ."pendaftaran/perpanjangan/daftar_izin', {
        ...
        $this->session_info['page_name'] = "Permohonan Perpanjangan Izin";
        $this->template->build('perpanjangan_list', $this->session_info);
    }
    ...
    public function create() {
        ...
        $this->load->vars($data);
        $this->session_info['page_name'] = "Entry Data Permohonan Perpanjangan Izin";
        $this->template->build('perpanjangan_edit', $this->session_info);
    ...
    public function edit($no_daftar = NULL, $id_link = NULL) {
        ...
        $data['tgl_perpanjangan'] = $u_daftar->d_perpanjangan;
        $paralel_jenis = new trparalel();
        $data['jenis_paralel'] = $paralel_jenis->get_by_id($u_daftar->c_paralel);
        $data['no_refer'] = $p_pemohon->no_referensi;
        $data['nama_pemohon'] = $p_pemohon->n_pemohon;
        ...
        $this->load->vars($data);
        $this->session_info['page_name'] = "Edit Permohonan Perpanjangan Izin";
        $this->template->build('perpanjangan_edit', $this->session_info);
    ...
    public function save() {
        ...
        $permohonan->d_perpanjangan = $this->input->post('tgl_perpanjangan');
...
//        /* Input Data Tanggal Survey */
//        $tanggal_survey = new trtanggal_survey();
//        $data_lama->trtanggal_survey->get();
//        $tanggal_survey->get_by_id($data_lama->trtanggal_survey->id);
//        $tanggal_survey->date = $this->input->post('tgl_survey');
//        $tanggal_survey->save($permohonan_akhir);
        ...
        if(! $permohonan_akhir->save($jenis_permohonan)) {
            ...
            redirect('pendaftaran/perpanjangan');
        }
    }
...
//        /* Input Data Tanggal Survey */
//        $tanggal_survey = new trtanggal_survey();
//        $tanggal_survey->get_by_id($permohonan->trtanggal_survey->id);
//        $tanggal_survey->date = $this->input->post('tgl_survey');
//        $tanggal_survey->save();
        ...
        if($update) {
            ...
            else redirect('pendaftaran/perpanjangan');
        }
    }
