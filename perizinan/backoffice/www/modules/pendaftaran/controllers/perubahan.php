...
/**
 * Description of Pendaftaran Perubahan Izin
 *
 * @author agusnur
 * Created : 25 Sep 2010
 */
class Perubahan extends WRC_AdminCont {
    ...
    public function __construct() {
        ...
        $this->jenis_id = "2"; // Perubahan Izin
    }
    ...
    public function index() {        
        ...
        $js =  "
                ...
                $(document).ready(function() {
                    $('#izin_id').change(function(){
                            ...
                            $.post('". base_url() ."pendaftaran/perubahan/daftar_izin', {
        ...
        $this->session_info['page_name'] = "Permohonan Perubahan Izin";
    ...
    public function create() {
        ...
        $this->load->vars($data);
        $this->session_info['page_name'] = "Entry Data Permohonan Perubahan Izin";
        $this->template->build('perubahan_edit', $this->session_info);
    ...
    public function edit($no_daftar = NULL, $id_link = NULL) {
        ...
        $data['tgl_perubahan'] = $u_daftar->d_perubahan;
        $paralel_jenis = new trparalel();
        $data['jenis_paralel'] = $paralel_jenis->get_by_id($u_daftar->c_paralel);
        $data['no_refer'] = $p_pemohon->no_referensi;
        $data['nama_pemohon'] = $p_pemohon->n_pemohon;
        ...
        $this->load->vars($data);
        $this->session_info['page_name'] = "Edit Permohonan Perubahan Izin";
        $this->template->build('perubahan_edit', $this->session_info);
    ...
    public function save() {
        ...
        $permohonan->d_perubahan = $this->input->post('tgl_perubahan');
...
//        $tanggal_survey->save($permohonan_akhir);
        ...
        if(! $permohonan_akhir->save($jenis_permohonan)) {
            ...
            redirect('pendaftaran/perubahan');
        }
    }
...
//        $tanggal_survey->save();
        ...
        if($update) {
            ...
            else redirect('pendaftaran/perubahan');
        }
    }
