...
<form name="form1" method="post">
 ...
 <table  border="0" width="100%">
        <tr>
           ...
           <?php
                   ...
                   'src' => base_url().'assets/images/icon/back_alt.png',
                    ...
                    'title' => 'Kembali',
                    'onclick' => 'parent.location=\''. site_url('ikm/filterdata'). '\''
                    );
                    echo img($Back_data);
					$img_word= array(
                                                ...
                                                'alt' => 'Cetak Ke word',
                                                'title' => 'Cetak Ke word',
                                                 'onclick' => 'parent.location=\''. site_url('ikm/lwview').'/'.$bidangizin .'/'.$tgla.'/'.$tgla.'\''
                                            );
                                            echo img($img_word);
											  $img_excel = array(
                                               ...
                                               'onclick' => 'parent.location=\''. site_url('ikm/leview').'/'.$bidangizin .'/'.$tgla.'/'.$tgla.'\''
                                            );
                                            echo img($img_excel);
            ?>
  ...
  <table cellpadding="1" cellspacing="0" border="1" class="display" id="reportgridx">
	...
	<tr>
	<th rowspan="2"><font  size="1" color="#1A1A1A"><b>Nilai Rata Rata</b></font></th>
	<th rowspan="2"><font  size="1" color="#1A1A1A"><b>Kinerja</b></font></th>
	<th rowspan="2"><font  size="1" color="#1A1A1A"><b>Nilai Rata Rata</b></font></th>
	<th rowspan="2"><font  size="1" color="#1A1A1A"><b>kinerja</b></font></th>
	</tr>
	</thead>
<!---------------------------------------------------------------------------------------------------.-->
		 ...
		 <tr>
                       <!-- <td align="center"><?php echo '1' ; ?></td>-->
                        ...
                        <td align="center"><?php echo number_format($s1,2); ?></td>
                        <td align="center">
						<?php 
						if($s1 > 0 and $s1<=1.75){
						$kinerja1= 'TIDAK BAIK';
						...
						<td align="center"><?php echo number_format($ss1,2); ?></td>
					<td align="center">
						<?php 
					 ...
					 <tr>
                        ...
                        <td align="center"><?php echo number_format($s2,2); ?></td>
						<td align="center">
						<?php 
						if($s2 > 0 and $s2<=1.75){
						$kinerja2= 'TIDAK BAIK';
					...
					<td align="center"><?php echo number_format($ss2,2); ?></td>
					<td align="center">
						<?php 
					 ...
					 <tr>
                        ...
                        <td align="center"><?php echo number_format($s3,2);?></td>
						<td align="center">
						<?php 
						if($s3 > 0 and $s3<=1.75){
						$kinerja3= 'TIDAK BAIK';
					...
					<td align="center"><?php echo number_format($ss3,2);?></td>
					<td align="center">
						<?php 
					 ...
					 <tr>
                       <!-- <td align="center"><?php echo '4'; ?></td>-->
                        ...
                        <td align="center"><?php echo number_format($s4,2); ?></td>
						<td align="center">
						<?php 
						if($s4 > 0 and $s4<=1.75){
						$kinerja4= 'TIDAK BAIK';
					...
					<td align="center"><?php echo number_format($ss4,2);?></td>
					<td align="center">
						<?php 
					 ...
					 <tr>
                        ...
                        <td align="center"><?php echo number_format($s5,2); ?></td>
						<td align="center">
						<?php 
						if($s5 > 0 and $s5<=1.75){
						$kinerja5= 'TIDAK BAIK';
					...
					<td align="center"><?php echo number_format($ss5,2);?></td>
					<td align="center">
						<?php 
					 ...
					 <tr>
                        ...
                        <td align="center"><?php echo number_format($s6,2); ?></td>
						<td align="center">
						<?php 
						if($s6 > 0 and $s6<=1.75){
						$kinerja6= 'TIDAK BAIK';
					...
					<td align="center"><?php echo number_format($ss6,2);?></td>
					<td align="center">
						<?php 
					 ...
					 <tr>
                        ...
                        <td align="center"><?php echo number_format($s7,2); ?></td>
						<td align="center">
						<?php 
						if($s7 > 0 and $s7<=1.75){
						$kinerja7= 'TIDAK BAIK';
                       ...
                       <td align="center"><?php echo number_format($ss7,2);?></td>
					   <td align="center">
						<?php 
					 ...
					 <tr>
                       <!-- <td align="center"><?php echo '8'; ?></td>-->
                        ...
                        <td align="center"><?php echo number_format($s8,2); ?></td>
						<td align="center">
						<?php 
						if($s8 > 0 and $s8<=1.75){
						$kinerja8= 'TIDAK BAIK';
						...
						<td align="center"><?php echo number_format($ss8,2);?></td>
					<td align="center">
						<?php 
					 ...
					 <tr>
                       <!-- <td align="center"><?php echo '9'; ?></td>-->
                        ...
                        <td align="center"><?php echo number_format($s9,2); ?></td>
						<td align="center">
						<?php 
						if($s9 > 0 and $s9<=1.75){
						$kinerja9= 'TIDAK BAIK';
						...
						<td align="center"><?php echo number_format($ss9,2);?></td>
						<td align="center">
						<?php 
					 ...
					 <tr>
                        ...
                        <td align="center"><?php echo number_format($s10,2); ?></td>
						<td align="center">
						<?php 
						...
						<td align="center"><?php echo number_format($ss10,2);?></td>
						<td align="center">
						<?php 
					 ...
					 <tr>
                        ...
                        <td align="center"><?php echo number_format($s11,2); ?></td>
						<td align="center">
						<?php 
						...
						<td align="center"><?php echo number_format($ss11,2);?></td>
						<td align="center">
						<?php 
					 ...
					 <tr>
                       <!-- <td align="center"><?php echo '12'; ?></td>-->
                        ...
                        <td align="center"><?php echo number_format($s12,2); ?></td>
						<td align="center">
						<?php 
						...
						<td align="center"><?php echo number_format($ss12,2);?></td>
						<td align="center">
						<?php 
					 ...
					 <tr>
                        ...
                        <td align="center"><?php echo number_format($s13,2); ?></td>
						<td align="center">
						<?php 
						...
						<td align="center"><?php echo number_format($ss13,2);?></td>
						<td align="center">
						<?php 
					 ...
					 <tr>
                       <!-- <td align="center"><?php echo '14'; ?></td>-->
                        ...
                        <td align="center"><?php echo number_format($s14,2); ?></td>
						<td align="center">
						<?php 
						...
						<td align="center"><?php echo number_format($ss14,2);?></td>
						<td align="center">
						<?php 
					...
					<tr>
					   ...
					   <td align="center"><b><?php 
						...
						echo number_format($nilais1,2);  ?></b></td>
						<td align="center"><b></td>
						<td align="center"><b>
						<?php 
