...
//                                    echo 'Realisasi Penerimaan Tahun '.$list_tahun->d_tahun;
								...
								<table align="center" width="90%" border="1" class="display" cellpadding="1" cellspacing="0" id="roygridx">
                                    <thead><tr class="title">
                                        ...
                                        <th width="35%" align="center" ><font  size="2" color="#1A1A1A"><b>Sektor Perizinan</b></font></th>
...
$query_data4="$query_datastatus and d.status_bap='1'";
										...
										<td  align="center"><?php echo round($persentase);echo ' %'; ?></b></td>
										<?
                                        }
										if($f_total2==0){
										$totalpersen=0;
...
$tanggalikm =$tanggal[1];
	 ...
	 <td align="center"><b><?php echo round($totalpersen); echo ' %';?></td>
	 <td align="center"><b><?php 
	 if(($totalterima+$totaltolak)==0 or $tt2==0){
	 $totalpersenketepatan=0;
	 }else{
	 $totalpersenketepatan=$tt2/($totalterima+$totaltolak)*100;
	 }
	 echo round($totalpersenketepatan); echo ' %';?></td>
	...
	echo round($totalpersenkecepatan); echo ' %';
	 ?>
