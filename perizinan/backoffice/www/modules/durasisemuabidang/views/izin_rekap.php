<script language="javascript" type="text/javascript">
    ...
    <div class="post">
		...
		$q = "Select * from trsektor where id='$bidangizin' order by id asc";
                    $exe = mysql_query($q);
 ...
 <table align=left>
   ...
   <table cellpadding="0" cellspacing="0" border="0" class="display" id="reportgrid" >
        <thead><tr class="title">
           ...
           <th rowspan="2"><font  size="1" color="#1A1A1A"><b>Tingkat Kecepatan</b></font></th>
		   <!--<th rowspan="2"><font  size="1" color="#1A1A1A"><b>Jmlh Tidak Sesuai Durasi</b></font></th>-->
		   <th rowspan="2"><font  size="1" color="#1A1A1A"><b>Tingkat <?php echo br();?> Ketepatan</b></font></th>
