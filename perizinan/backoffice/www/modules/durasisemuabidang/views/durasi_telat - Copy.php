...
<body>
    ...
    <div class="post">
		...
		?>
		<div align="center"><h2><b><?php echo 'Daftar Jumlah Izin Tidak Sesuai Durasi Bidang '; echo $a;?></h2></b></div>
		<?php
		}
		?>
        </div>
...
<!---------------------------------------------------------------------------------------------------.-->
			   ...
			   //$bidangizin=$this->input->post('id');
					...
					$i = NULL;
                    $query_data = "
					select  a.pendaftaran_id no,e.n_perizinan jenis,a.d_terima_berkas terima,a.d_selesai_proses selesai,i.tgl_surat,
					i.tgl_surat_edit,e.v_hari durasi,a.a_izin,a.keterangan,
