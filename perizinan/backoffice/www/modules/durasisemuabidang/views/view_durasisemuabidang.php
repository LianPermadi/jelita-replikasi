...
//----------------------------------sesuai durasi----------------------------------
											...
											<td align="center"><b> 
                                                <?php if(substr($tgla,0,4)=='2013' and substr($tglb,0,4)=='2013' and $persen < 87){ ?>        <font size="2" color="red">
    				                            <?php }else if(substr($tgla,0,4)=='2013' and substr($tglb,0,4)=='2013' and $persen >= 87){ ?> <font  size="2" color="green">
	    			                            <?php }else if(substr($tgla,0,4)=='2014' and substr($tglb,0,4)=='2014' and $persen < 87){ ?>  <font  size="2" color="red">
		    		                            <?php }else if(substr($tgla,0,4)=='2014' and substr($tglb,0,4)=='2014' and $persen >= 87){ ?> <font  size="2" color="green">
                                                <?php }else if(substr($tgla,0,4)=='2015' and substr($tglb,0,4)=='2015' and $persen < 91){ ?>  <font  size="2" color="red">
                                                <?php }else if(substr($tgla,0,4)=='2015' and substr($tglb,0,4)=='2015' and $persen >= 91){ ?> <font  size="2" color="green">
                                                <? }else if(substr($tgla,0,4)=='2016' and substr($tglb,0,4)=='2016' and $persen < 92){ ?>  <font  size="2" color="red">
                                                <?php }else if(substr($tgla,0,4)=='2016' and substr($tglb,0,4)=='2016' and $persen >= 92){ ?> <font  size="2" color="green">
                                                <?php }else if(substr($tgla,0,4)=='2017' and substr($tglb,0,4)=='2017' and $persen < 93){ ?>  <font  size="2" color="red">
                                                <?php }else if(substr($tgla,0,4)=='2017' and substr($tglb,0,4)=='2017' and $persen >= 93){ ?> <font  size="2" color="green">
                                                <?php }else if(substr($tgla,0,4)=='2018' and substr($tglb,0,4)=='2018' and $persen < 94){ ?>  <font  size="2" color="red">
                                                <?php }else if(substr($tgla,0,4)=='2018' and substr($tglb,0,4)=='2018' and $persen >= 94){ ?> <font  size="2" color="green">
                                                <?php }else{ ?>                                                                               <font  size="2" color="grey">
                                                <?php }
								...
								<tr bgcolor="#d5dffe">
									...
									<td  align="center"><font  size="2" color="#1A1A1A"><b>
									    <?php if(substr($tgla,0,4)=='2013' and substr($tglb,0,4)=='2013' and $persentotal < 87){ ?>        <font  size="2" color="red">
                                        <?php }else if(substr($tgla,0,4)=='2013' and substr($tglb,0,4)=='2013' and $persentotal >= 87){ ?> <font  size="2" color="green">
                                        <?php }else if(substr($tgla,0,4)=='2014' and substr($tglb,0,4)=='2014' and $persentotal < 87){ ?>  <font  size="2" color="red">
                                        <?php }else if(substr($tgla,0,4)=='2014' and substr($tglb,0,4)=='2014' and $persentotal >= 87){ ?> <font  size="2" color="green">
                                        <?php }else if(substr($tgla,0,4)=='2015' and substr($tglb,0,4)=='2015' and $persentotal < 91){ ?>  <font  size="2" color="red">
                                        <?php }else if(substr($tgla,0,4)=='2015' and substr($tglb,0,4)=='2015' and $persentotal >= 91){ ?> <font  size="2" color="green">
                                        <?php }else if(substr($tgla,0,4)=='2016' and substr($tglb,0,4)=='2016' and $persentotal < 92){ ?>  <font  size="2" color="red">
                                        <?php }else if(substr($tgla,0,4)=='2016' and substr($tglb,0,4)=='2016' and $persentotal >= 92){ ?> <font  size="2" color="green">
                                        <?php }else if(substr($tgla,0,4)=='2017' and substr($tglb,0,4)=='2017' and $persentotal < 93){ ?>  <font  size="2" color="red">
                                        <?php }else if(substr($tgla,0,4)=='2017' and substr($tglb,0,4)=='2017' and $persentotal >= 93){ ?> <font  size="2" color="green">
                                        <?php }else if(substr($tgla,0,4)=='2018' and substr($tglb,0,4)=='2018' and $persentotal < 94){ ?>  <font  size="2" color="red">
                                        <?php }else if(substr($tgla,0,4)=='2018' and substr($tglb,0,4)=='2018' and $persentotal >= 94){ ?> <font  size="2" color="green">
                                        <?php }else{ ?>                                                                                    <font  size="2" color="grey">
				                        <?php }
