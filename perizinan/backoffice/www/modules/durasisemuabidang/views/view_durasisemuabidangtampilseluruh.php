...
//                                    echo 'Realisasi Penerimaan Tahun '.$list_tahun->d_tahun;
								...
								<th>Jumlah Sesuai Target</th>
								<th>total persen Kecepatan</th>
<?php
$i=1;
$jumlah=0;
$tt=0;
...
$tt=0;
	...
	//$date1 = new DateTime("2010-10-02");
//$date2 = new DateTime("2012-09-20");
//$interval = $date1->diff($date2);
//echo "Perbedaan Tanggal : " . $interval->y . " tahun, " .
  //       $interval->m." bulan, ".$interval->d." hari ";
//echo '<hr/>';
//echo "Beda Jumlah Hari : " . $interval->format('%R%');
