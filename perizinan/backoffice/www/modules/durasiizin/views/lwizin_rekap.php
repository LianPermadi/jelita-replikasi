...
<?php
       ...
       // header("Content-disposition: attachment; filename=Perngaduan Pertriwulan Tahun '.  $this->input->post('tgla').doc");
        header("Content-disposition: attachment; filename=Ketepatan Perizinan Per Bidang $a $tgla-$tglb.doc");
...
<body>
    ...
    <div class="post">
		...
		<div align="center"><font  size="12px" color="#1A1A1A"><h3><b><?php echo 'Bidang :  '; echo $a;?></h3></b></div>
		<?php
		}
		?>
        </div>
