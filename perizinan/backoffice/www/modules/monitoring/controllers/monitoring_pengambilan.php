 ...
 *
 */
class Monitoring_pengambilan extends WRC_AdminCont {
    ...
    public function filterdata() {
	 ...
	 $idizin = $this->input->post('jenis_izin');
        ...
        $nama_surat = "cetak_monitoring_blnpengambilan_generic";
...
//        $odf->setImage('header', 'assets/css/' . $app_folder . '/images/dinas_1.jpg', '17.5', '3.5');
        ...
        $odf->setVars('title','Monitoring Per Bulan Pengambilan Izin');
        $odf->setVars('jenis',$list->n_perizinan);
	...
	where a.d_ambil_izin >= '".$tgla."'
	and  a.d_ambil_izin <= '".$tglb."'
	and c.id = ".$id."";  
