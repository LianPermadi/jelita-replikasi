 ...
 *
 */
class Monitoring_perusahaan extends WRC_AdminCont {
    ...
    public function filterdata() {
	 ...
	 $idizin = $this->input->post('nama_perusahaan');
        ...
        $nama_surat = "cetak_monitoring_perusahaan_generic";
...
//        $odf->setImage('header', 'assets/css/' . $app_folder . '/images/dinas_1.jpg', '17.5', '3.5');
        ...
        $odf->setVars('title','Monitoring Per Nama Perusahaan');
        ...
        $listeArticles3 = array(
                array(	'property' =>  $i,
                        ...
                        'content4' =>  $data_relasi->n_perusahaan,
	...
	left join tmpermohonan_tmperusahaan as m on m.tmpermohonan_id = a.id
	left join tmperusahaan as n on n.id = m.tmperusahaan_id
	where a.d_terima_berkas >= '".$tgla."'
	and  a.d_terima_berkas <= '".$tglb."'
	and n.n_perusahaan like '%".$id."%'";  
