 ...
 *
 */
class Monitoring_pemohon extends WRC_AdminCont {
    ...
    public function filterdata() {
	 ...
	 $idizin = $this->input->post('nama');
        ...
        $nama_surat = "cetak_monitoring_nama_generic";
...
//        $odf->setImage('header', 'assets/css/' . $app_folder . '/images/dinas_1.jpg', '17.5', '3.5');
        ...
        $odf->setVars('title','Monitoring Per Nama Pemohon');
