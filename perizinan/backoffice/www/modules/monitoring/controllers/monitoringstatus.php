...
class Monitoringstatus extends WRC_AdminCont {
	...
	public function cetak_monitoring_ambil() {
        ...
        $gerai = $this->input->post('list_asal');
...
//        $odf->setVars('status',$list_status->n_sts_permohonan);
		$odf->setVars('status',$list_status->a_izin);
        $odf->setVars('asal',$gerai);
		...
		$list_relasi = $this->getTabel($tgla, $tglb, $idizin, $gerai);
            ...
            foreach ($list_relasi as $data_relasi){
                ...
                $listeArticles3 = array(
                    array(	'property' =>  $i,
                        ...
                        'content5' =>  $data_relasi->a_izin, // $data_relasi->n_sts_permohonan,
                        'content6' =>  $data_relasi->a_pemohon,
                        'content7' =>  $data_relasi->kd_gerai,
//						'content7' =>  $data_relasi->n_kelurahan,
	...
	public function getTabel($tgla,$tglb,$id,$gerai)
	{
		
	$sql = "select a.pendaftaran_id, a.d_entry, b.n_pemohon, c.n_perizinan , c.id, a.d_terima_berkas, d.n_sts_permohonan, b.a_pemohon, l.n_kelurahan, a.kd_gerai , a.a_izin
