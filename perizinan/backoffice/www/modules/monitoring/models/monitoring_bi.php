...
class Monitoring_bi extends DataMapper {
    ...
    function get_total_perizinan($cari=NULL, $first_date=NULL, $second_date=NULL, $jenis_izin=0, $lokasi=NULL, $cek_sektor=NULL) {
    ...
    function get_total_kecamatan($cari=NULL, $first_date=NULL, $second_date=NULL, $kelurahan_id=NULL, $lokasi=NULL, $cek_sektor=NULL) {
        $sql = $this->sql();
        $sql.=" where t7.id <> 1 ";
        if (($first_date != NULL) && ($first_date != 0) && ($second_date != NULL) && ($second_date != 0)) {
            $sql.=" AND t1.d_terima_berkas BETWEEN '$first_date' and '$second_date' ";
    ...
    function get_total_pemohon($cari=NULL, $first_date=NULL, $second_date=NULL, $nama=NULL, $lokasi=NULL, $cek_sektor=NULL) {
        $sql = $this->sql();
        $sql.=" where t7.id <> 1 ";
        if (($first_date != NULL) && ($first_date != 0) && ($second_date != NULL) && ($second_date != 0)) {
            $sql.=" AND t1.d_terima_berkas BETWEEN '$first_date' and '$second_date' ";
    ...
    function get_total_perusahaan($cari=NULL, $first_date=NULL, $second_date=NULL, $nama_perusahaan, $lokasi=NULL, $cek_sektor=NULL) {
    ...
    function get_total_Per_Bulan_Pengambilan_Izin($cari=NULL, $first_date=NULL, $second_date=NULL, $jenis_izin=NULL, $lokasi=NULL, $cek_sektor=NULL) {
        //$jenis_izin = $this->input->post('jenis_izin');
        $sql = $this->sql();
        $sql.=" where t7.id <> 1  ";
        if (($first_date != NULL) && ($first_date != 0) && ($second_date != NULL) && ($second_date != 0)) {
    ...
    function get_total_perstatus($cari=NULL, $first_date=NULL, $second_date=NULL, $list_status=NULL, $lokasi=NULL, $cek_sektor=NULL) {
