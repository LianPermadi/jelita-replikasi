<div id="content">
    <div class="post">
        ...
        <fieldset id="half">
			...
			//						 'Gerai Cirebon' => "Gerai Cirebon",'SMS' => "SMS",'Surat' => "Surat");
		   ...
		   <table>
		        ...
		        <tr>
		   		    <td> <?php echo form_label('Periode Cetak Awal', 'd_tahun'); ?> </td>
			    	<td> <?php echo form_input($periodeawal_input); ?> </td>
                </tr>
		        <tr>
		   		     <td> <?php echo form_label('Periode Cetak Akhir', 'd_tahun'); ?> </td>
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="monitoring">
                <thead>
                    <tr>
						...
						<th width="10%">Masa Berlaku SK</th>
                        <th width="16%">Nomor KP</th>
                        <th width="10%">Tanggal KP</th>
						<th width="10%">Masa Berlaku KP</th>
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                <td><?php echo $i; ?></td>
       							<td><?php echo $b . $data->no_kend . $be; ?></td>
	        					<td><?php echo $b . $data->no_uji . $be; ?></td>
			        			<td><?php echo $b . $data->no_sk . $be; ?></td>
       							<td><?php echo $b . $this->lib_date->mysql_to_human($data->tgl_sk) . $be; ?></td>
	        					<td><?php echo $b . $this->lib_date->mysql_to_human($data->masa_berlaku) . $be; ?></td>
			        			<td><?php echo $b . $data->no_kp . $be; ?></td>
					        	<td><?php echo $b . $this->lib_date->mysql_to_human($data->tgl_kp_awal) . $be; ?></td>
       							<td><?php echo $b . $this->lib_date->mysql_to_human($data->tgl_kp_akhir) . $be; ?></td>
