                    ...
                    ?>
                            <tr>
			        			...
			        			<td><?php echo $b . $data->no_sk . $be; ?></td>
       							<td><?php echo $b . $this->lib_date->mysql_to_human($data->tgl_sk).'<br>'.$this->lib_date->mysql_to_human($data->masa_berlaku).$be; ?></td>
			        			<td><?php echo $b . $data->no_kp . $be; ?></td>
					        	<td><?php echo $b . $this->lib_date->mysql_to_human($data->tgl_kp_awal).'<br>'.$this->lib_date->mysql_to_human($data->tgl_kp_akhir).$be; ?></td>
