<?php
   ...
   header("Content-disposition: attachment; filename= Resume Evaluasi Perbulan $tgla.xls");
		 ...
		 ?>
					...
					if($ratanilais2 > 0 and $ratanilais2<=43.75){
						...
						//echo $mutu2;  ?></b>
									...
									<td align="center"><?php echo round($totalnilaiikm); ?></td>
									</tr>
					<!--------------------------------------------------- akhir IKM --------------------------------------->				
								</table>
