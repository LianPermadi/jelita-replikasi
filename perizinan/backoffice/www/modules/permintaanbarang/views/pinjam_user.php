...
<!--                         <select class="pilihan" name="peminjam" style="width:100%">
                        ...
                        <?php echo $nama; ?>
                        <input type="hidden" name="saatini" value="<?php echo $nama; ?>">
                      </td>
                    </tr>
                    <tr>
...
<!--                         <select class="pilihan" name="peminjam" style="width:100%">
    ...
    <div class="entry" style="text-align: center;">
      ...
      <span></span>
      <button name="button" type="button" class="button-wrc" onclick="parent.location='<?php echo site_url('permintaanbarang/pengajuan_barang'); ?>'">Batal</button>
    </div>
  </form>
  </div>
  <br style="clear: both;" />
