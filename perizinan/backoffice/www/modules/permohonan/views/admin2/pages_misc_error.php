  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        ...
        <a href="https://dpmptsp.jabarprov.go.id/kemitraan/admin/index" class="btn btn-primary">Back to home</a>
        <div class="mt-3">
          <img
            ...
            width="500"
            class="img-fluid"
            data-app-dark-img="<?php echo base_url('assets/admin/assets/img/illustrations/page-misc-error-dark.png'); ?>"
            data-app-light-img="<?php echo base_url('assets/admin/assets/img/illustrations/page-misc-error-light.png'); ?>"
          />
        </div>
      </div>
    </div>
