            ...
            <div id="tabs">
                ...
                <div id="tabs-1">
                    <div id="contentleft">
                        ...
                        <div class="contentForm">
                            <?php
                                $memperhatikan1_input = array(
                                    'name' => 'memperhatikan1',
                                    'value' => $memperhatikan1,
                                    'class' => 'input-area-wrc',
									'style' => 'min-width:450pt'
								);
                                echo form_label('Memperhatikan  1');
                                echo form_textarea($memperhatikan1_input);
                            ?>
                        </div>

						 <div class="contentForm">
                            <?php
                                $memperhatikan2_input = array(
                                    'name' => 'memperhatikan2',
                                    'value' => $memperhatikan2,
                                    'class' => 'input-area-wrc',
									'style' => 'min-width:450pt'
								);
                                echo form_label('Memperhatikan  2');
                                echo form_textarea($memperhatikan2_input);
                            ?>
                        </div>

						 <div class="contentForm">
                            <?php
                                $memperhatikan3_input = array(
                                    'name' => 'memperhatikan3',
                                    'value' => $memperhatikan3,
                                    'class' => 'input-area-wrc',
									'style' => 'min-width:450pt'
								);
                                echo form_label('Memperhatikan  3');
                                echo form_textarea($memperhatikan3_input);
                            ?>
                        </div>
                    ...
                    <div id="contentright">
						...
						<div class="contentForm">
                            <?php
                                $content4_input = array(
                                    'name' => 'content4',
                                    'value' => $content4,
                                    'class' => 'input-area-wrc',
                                    'style' => 'min-width:300pt'
                                );
                                echo form_label('Content 4');
                                echo form_textarea($content4_input);
                            ?>
                        </div>
						<div class="contentForm">
                            <?php
                                $content5_input = array(
                                    'name' => 'content5',
                                    'value' => $content5,
                                    'class' => 'input-area-wrc',
                                    'style' => 'min-width:300pt'
                                );
                                echo form_label('Content 5');
                                echo form_textarea($content5_input);
                            ?>
                        </div>
						<div class="contentForm">
                            <?php
                                $content6_input = array(
                                    'name' => 'content6',
                                    'value' => $content6,
                                    'class' => 'input-area-wrc',
                                    'style' => 'min-width:300pt'
                                );
                                echo form_label('Content 6');
                                echo form_textarea($content6_input);
                            ?>
                        </div>
						<div class="contentForm">
                            <?php
                                $content7_input = array(
                                    'name' => 'content7',
                                    'value' => $content7,
                                    'class' => 'input-area-wrc',
                                    'style' => 'min-width:300pt'
                                );
                                echo form_label('Content 7');
                                echo form_textarea($content7_input);
                            ?>
                        </div>
						<div class="contentForm">
                            <?php
                                $content8_input = array(
                                    'name' => 'content8',
                                    'value' => $content8,
                                    'class' => 'input-area-wrc',
                                    'style' => 'min-width:300pt'
                                );
                                echo form_label('Content 8');
                                echo form_textarea($content8_input);
                            ?>
                        </div>
						<div class="contentForm">
                            <?php
                                $content9_input = array(
                                    'name' => 'content9',
                                    'value' => $content9,
                                    'class' => 'input-area-wrc',
                                    'style' => 'min-width:300pt'
                                );
                                echo form_label('Content 9');
                                echo form_textarea($content9_input);
                            ?>
                        </div>
						<div class="contentForm">
                            <?php
                                $content10_input = array(
                                    'name' => 'content10',
                                    'value' => $content10,
                                    'class' => 'input-area-wrc',
                                    'style' => 'min-width:300pt'
                                );
                                echo form_label('Content 10');
                                echo form_textarea($content10_input);
                            ?>
                        </div>
                        <div class="contentForm">
                            <?php
                        ...
                        <div class="contentForm">
                            <?php
                                ...
                                echo form_label('Tembusan 5');
                                echo form_input($salinan5_input);
                            ?>
                        </div>
						<div class="contentForm">
                            <?php
                                $salinan6_input = array(
                                    'name' => 'salinan6',
                                    'value' => $salinan6,
                                    'class' => 'input-wrc'
                                );
                                echo form_label('Tembusan 6');
                                echo form_input($salinan6_input);
                            ?>
                        </div>
                        <div class="contentForm">
                            <?php
                                $salinan7_input = array(
                                    'name' => 'salinan7',
                                    'value' => $salinan7,
                                    'class' => 'input-wrc'
                                );
                                echo form_label('Tembusan 7');
                                echo form_input($salinan7_input);
                            ?>
                        </div>
						<div class="contentForm">
                            <?php
                                $salinan8_input = array(
                                    'name' => 'salinan8',
                                    'value' => $salinan8,
                                    'class' => 'input-wrc'
                                );
                                echo form_label('Tembusan 8');
                                echo form_input($salinan8_input);
                            ?>
                        </div>
						<div class="contentForm">
                            <?php
                                $salinan9_input = array(
                                    'name' => 'salinan9',
                                    'value' => $salinan9,
                                    'class' => 'input-wrc'
                                );
                                echo form_label('Tembusan 9');
                                echo form_input($salinan9_input);
                            ?>
                        </div>
						<div class="contentForm">
                            <?php
                                $salinan10_input = array(
                                    'name' => 'salinan10',
                                    'value' => $salinan10,
                                    'class' => 'input-wrc'
                                );
                                echo form_label('Tembusan 10');
                                echo form_input($salinan10_input);
                            ?>
                        </div>
                    </div>
                    <br style="clear: both;" />
