					...
					<div class="col-md-12">
						<form role="form" method="post" enctype="multipart/form-data" action="<?php echo base_url() . 'main/user/doeditdokumen'; ?>">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="file" name="akta" class="uploadakta" accept=".pdf,.PDF">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="file" name="npwp" class="uploadgambar" accept=".jpg,.jpeg,.png,.JPG,.JPEG,.PNG">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input type="file" name="ktp" class="uploadgambar" accept=".jpg,.jpeg,.png,.JPG,.JPEG,.PNG">
