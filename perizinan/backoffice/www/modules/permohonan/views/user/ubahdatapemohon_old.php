	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<div class="row">
						<div class="col-md-10">Data Pemohon</div>
						<div class="col-md-2">
					...
					<div class="col-md-12">
						<form role="form" method="post" action="<?php echo base_url() . 'main/user/doeditdata'; ?>">
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input class="form-control" placeholder="Nama Pemegang Kuasa" name="nama_pemegang_kuasa" value="<?php echo $data->namaPemohon; ?>" required><br>
								</div>
							</div>
							...
							<div class="form-group">
								<label class="col-md-3 text">
									...
									*HUSUS UNTUK PERUSAHAAN
								</label>
								<div class="col-md-9">
									<input class="form-control" placeholder="No Akta Pemohon" name="no_akta_pemohon" value="<?php echo $data->aktaPerusahaan; ?>"><br>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-9">
									<input class="form-control" name="fax_pemohon" placeholder="Fax Pemohon" value="<?php echo $data->faxPerusahaan; ?>" required><br>
								</div>
							</div>
