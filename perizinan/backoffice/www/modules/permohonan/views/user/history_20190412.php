                  ...
                  <tr>
                    <td>
                      ...
                      if (!empty($data->status_berkas) && $data->status_berkas == "Izin Ditolak") {
                        // echo "<a href='https://dpmptsp.jabarprov.go.id/sicantik/backoffice/permohonan/penetapan/ctk_pengembalian/144566/494' class='btn btn-block btn-primary'>Cetak Surat Penolakan</a>";
