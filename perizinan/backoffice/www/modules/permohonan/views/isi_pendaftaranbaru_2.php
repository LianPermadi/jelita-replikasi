...
<form method="post" class="form-horizontal" action="<?php echo base_url() . 'main/pendaftaranbaru/dopendaftaran'; ?>">
	...
	<div class="form-group">
		<label class="col-sm-4 control-label" id="tipepemohon">NIK Pemohon :</label>
		<div class="col-sm-8">
			<input type="text" id="" name="ktpPemohon" class="validate[required] text-input form-control"  value="" required>
			<i><p id="ktpPemohon"> *NIK Sesuai Kartu Identitas</p></i>
		</div>
	</div>

	<div class="form-group" style="display:none" id="direktur">
		<label class="col-sm-4 control-label">NIK Perusahaan :</label>
		<div class="col-sm-8">
			<input type="text" id="direktur2" name="ktpPerusahaan" class="validate[required] text-input form-control" value=""> 
			<i><p id="ketpemohon"> *NIK Perusahaan Sesuai Kartu Identitas</p></i>
		</div>
	</div>
		...
		<div class="col-sm-8">
			<select name="provinsi" class="provinsi form-control" required>
				<?php foreach($provinsi as $prov){ ?>
					<option value="<?php echo $prov->kd_prov; ?>" <?php if($prov->kd_prov==34){ echo "selected";} ?>><?php echo $prov->n_propinsi; ?></option>
				<?php } ?>
			</select>
		</div>
	</div>
