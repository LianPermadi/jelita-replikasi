            ...
            <form role="form" method="post" action="<?php echo base_url() . 'main/permohonan/savestep3/'.$id.''; ?>">
              ...
              <div class="form-group">
                ...
                <div class="col-md-9">
                  ...
                  <br><small>Geser lalu klik penanda merah pada Map untuk memilih Longitude / Latitude lokasi anda</small>
                </div>
              </div>
              <br>
              <div class="form-group">
                ...
                <div class="col-md-4">
                  <input type="text" id="maps_longitude" name="maps_longitude" class="form-control" readonly="readonly">
                </div>
                <div class="col-md-4">
                <input type="text" id="maps_latitude" name="maps_latitude" class="form-control" readonly="readonly">
                <br><small>&nbsp;</small>
                </div>
              </div>
                <br>
