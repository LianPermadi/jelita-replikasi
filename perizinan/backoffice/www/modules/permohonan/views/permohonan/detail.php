  ...
  <div class="row">
    <div class="col-lg-12">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <table data-toggle="table"  data-search="true" data-pagination="true" data-sort-name="tanggal" data-sort-order="asc">
            <thead>
            <tr>
          ...
          <hr>
          <?php
          if(empty($permohonan->no_permohonan) && $belakang==1 && !empty($asistensi)){ 
          ?>
                ...
                <tr>
                  ...
                  <td align="center">
                    ...
                    if (file_exists($base_url.$data->id.".pdf")) {
                       echo anchor($base_url.$data->id.".pdf?q=".microtime(true), "Download",array("target"=>"_blank"));
                     } elseif (file_exists($base_url.$data->id.".jpg")) {
                       echo anchor($base_url.$data->id.".jpg?q=".microtime(true), "Download",array("target"=>"_blank"));
                     } elseif (file_exists($base_url.$data->id.".rar")) {
                       echo anchor($base_url.$data->id.".rar?q=".microtime(true), "Download",array("target"=>"_blank"));
                     } elseif (file_exists($base_url.$data->id.".jpeg")) {
                      echo anchor($base_url.$data->id.".jpeg?q=".microtime(true), "Download",array("target"=>"_blank"));
                     }
