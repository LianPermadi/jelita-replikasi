  ...
  <div class="post">
    ...
    <div class="entry">
      <fieldset id="half">
        ...
        <?php echo form_open('permohonan/pencabutan'); ?>
        <div id="statusRail">
          <div id="rightRail">
            <div id="leftRail">
    ...
    <div class="entry">
      <fieldset id="half">
        ...
        <?php
        echo form_open('permohonan/pencabutan');
        ?>
        <div id="statusRail">
          <div id="leftRail">
            <?php
            ...
            <tr>
              ...
              <td valign='top'>
                ...
                $img_edit = array('src' => 'assets/images/icon/property.png',
                                  'alt' => 'Proses Pencabutan',
                                  'title' => 'Proses Pencabutan',
                                  'border' => '0');
                echo anchor(site_url('permohonan/pencabutan/edit') .'/'.$rows['id'], img($img_edit))."&nbsp;";
                ?>
              </td>
            </tr>
            <?php
