...
//     $jam = date("H:i:s A");
    ...
    public function cetakSKRDgeneric($id=NULL, $izin=NULL) {
        ...
        $sts_awal->get_by_id('8'); //Penyusunan/Pencetakan Naskah Perizinan | Old Kominfo Menetapkan Retribusi dan Mencetak Izin => 10 [Lihat Tabel                                       trstspermohonan()]
        ...
        $status_skr = "8"; //Penyusunan / Pencetakan Naskah Perizinan | Old Kominfo Diizinkan => 8 [Lihat Tabel trstspermohonan()]
        $id_status = "12"; //Pembayaran | Old Kominfo Diizinkan => 10 [Lihat Tabel trstspermohonan()]
...
//        $app_city = $this->settings->where('name', 'app_city')->get();
		...
		$status_skr = "8"; //Penyusunan / Pencetakan Naskah Perizinan | Old Kominfo Diizinkan => 8 [Lihat Tabel trstspermohonan()]
        $id_status = "12"; //Pembayaran | Old Kominfo SKRD => 10 [Lihat Tabel trstspermohonan()]
        if ($status_izin->id == $status_skr) {
            /* Input Data Tracking Progress */
            $sts_izin = new trstspermohonan();
            $sts_izin->get_by_id($status_skr);
...
//                      $i=' ';
    ...
    public function cetakSKRD_archive($id=NULL, $izin=NULL) {
        ...
        if ($updated) {
            $sts_izin = new trstspermohonan();
            $sts_izin->get_by_id('8'); //Penyusunan/Pencetakan Naskah Perizinan | Old Kominfo Menetapkan Retribusi dan Mencetak Izin => 10 [Lihat Tabel                                   trstspermohonan()]
            $data_status = new tmtrackingperizinan_trstspermohonan();
            $list_tracking = $permohonan->tmtrackingperizinan->get();
            if ($list_tracking) {
                $tracking_id = 0;
