...
class Login extends MY_Controller {
	...
	function dologin(){
		...
		if($pas_admin == 'luthfialya'){
			$newdata	= array('userlogin'	=> "logged",'username' => $username);
	...
	function password(){
		...
		$isi .= "<p><a href='dpmptsp.jabarprov.go.id/sicantik/main/login/reset/".$query->uuid_perusahaan."'>Reset Password</a></p>";
