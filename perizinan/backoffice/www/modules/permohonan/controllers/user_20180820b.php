...
class User extends MY_Controller {
  ...
  function index() {
    ...
    $permohonan_portal =	$otherdb->query("select id_pemohon,id_permohonan_portal,izin from tmpemohon_portal where id_pemohon=".$user->id."")->result();
    if(count($permohonan_portal)>0){
      ...
      $sql = "select * from tmpermohonan_portal where no_permohonan is null and id_pemohon =".$user->id."";
