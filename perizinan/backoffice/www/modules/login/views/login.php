...
<html>
  <head>
    ...
    <link rel='icon' type='image/png' href="<?php echo site_url('assets/images/icon/Logo_Jabar_Clr.png'); ?>" > 
  ...
  <body>
    <div id="stylized">
      <div class="loginform">
        ...
        <div class="form">
          <ul>
            <li><h2>Masukkan Nama Petugas</h2>&nbsp;<input type="text" name="username" id="username" /></li>
          </ul>
          <ul>
            <li><h2><?php echo $kata_sandi ?></h2>&nbsp;<input type="password" name="password" id="password" /></li>
          </ul>
          <ul>
