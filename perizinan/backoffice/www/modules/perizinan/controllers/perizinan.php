...
class Perizinan extends WRC_AdminCont {
  ...
  public function edit($id_jnsizin = NULL) {
    ...
    //$data['integrasi'] = $this->perizinan->integrasi;
    ...
    $data['pt_ttd'] = $this->perizinan->pt_ttd;
    $data['pt_sertifikat'] = $this->perizinan->pt_sertifikat;
  ...
  public function save() {
    ...
    $perizinan->pt_ttd = $this->input->post('pt_ttd');
    $perizinan->pt_sertifikat = $this->input->post('pt_sertifikat');
    ...
    //$perizinan->integrasi = $this->input->post('integrasi');
  ...
  public function update() {
    ...
    $update = $this->perizinan
                   ...
                   ->update(array('kd_izin'  => $this->input->post('kd_izin'),
                                  ...
                                  'pt_ttd' => $this->input->post('pt_ttd'),
                                  'pt_sertifikat' => $this->input->post('pt_sertifikat'),
