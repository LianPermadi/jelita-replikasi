...
//                ->get();
    ...
    public function detail($no_daftar = NULL, $asal_menu = NULL) {
        ...
        $data['list_tracking'] = $p_daftar->tmtrackingperizinan->order_by('id', 'DESC')->get();
    ...
    private function list_data_output($obj) {
        ...
        foreach ($obj as $list) {
            ...
            $action .= anchor(site_url('info/infotracking/detail') .'/0/'. $list->id, img($img_info));  // 0 = asal menu
