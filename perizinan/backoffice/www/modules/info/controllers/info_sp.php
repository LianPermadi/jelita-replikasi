...
/**
   * Description of Informasi Standar Pelayanan
   * @author agusnur ; Created : 08 Okt 2010
   * @edit PBS       ; Created : 12 Juni 2024
*/

class Info_sp extends WRC_AdminCont {
  ...
  public function index() {
  	$list_data = $this->dbmodel_portal->dbportal_sql("select * from daftar_standar_pelayanan");
    $data['list'] = $list_data;
    $this->load->vars($data);
    ...
    $this->session_info['page_name'] = "Informasi Standar Operasional Prosedur (SOP)";
    $this->template->build('info_sp_list', $this->session_info);
  }
    ...
    public function detail($no_izin = NULL) {
        ...
        $this->template->set_metadata_javascript($js);
        $this->session_info['page_name'] = "Informasi Standar Operasional Prosedur";
        $this->template->build('info_sp_detail', $this->session_info);
    }
