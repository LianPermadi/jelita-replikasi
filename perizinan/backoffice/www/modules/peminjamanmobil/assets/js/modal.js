     ...
     */
     ...
     Array.from(n.keys())[0]
           ...
           class st extends B {
               constructor(t, e) {
                   ...
                   (this._indicatorsElement=V.findOne(".carousel-indicators",
                           this._element)),
               ...
               _addTouchEventListeners() {
                   ...
                   n=(e)=> {
                       ...
                       "hover"===this._config.pause && (this.pause(),
                           ...
                           (this.touchTimeout=setTimeout((t)=> this.cycle(t),
           ...
           class pt extends B {
               ...
               show() {
                   ...
                   if (this._config.parent) {
                       ...
                       e=V.find(".collapse.show, .collapse.collapsing",
                           this._config.parent).filter((e)=> !t.includes(e));
                   }
     ...
     this._element.getBoundingClientRect()[t]
           ...
           (((T= {})[v]=_ ? "0" : ""),
               (T[b]=g ? "0" : ""),
               (T.transform=(y.devicePixelRatio || 1) <=1 ? "translate(" + f + "px, " + m + "px)"
           ...
           je= {
               ...
               A=e.rects.reference,
               T=e.rects.popper,
               O="function"==typeof m ? m(Object.assign({}
           ...
           class hi extends B {
               ...
               _getConfig(t) {
                   if (((t= {
                           ...
                           "object"==typeof t.reference && !o(t.reference) && "function" !=typeof t.reference.getBoundingClientRect)) throw new TypeError(`${Ue.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`);
                   return t;
               }
           ...
           _selectMenuItem({
               ...
               const i=V.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)",
                   this._menu).filter(l);
           ...
           class un extends B {
               ...
               setElementContent(t, e) {
                   if (null !==t) return o(e) ? ((e=r(e)),
                       void (this._config.html ? e.parentNode !==t && ((t.innerHTML=""), t.append(e)) : (t.textContent=e.textContent))) : void (this._config.html ? (this._config.sanitize && (e=Yi(e, this._config.allowList, this._config.sanitizeFn)),
               ...
               _initializeOnDelegatedTarget(t, e) {
                   return (e || this.constructor.getOrCreateInstance(t.delegateTarget,
