...
if (!empty($id_surat_mobil)) {
    ...
    // var_dump($peminjam);die();
        ...
        <td valign='top'>
          ...
          <td>
            <!-- <a href="peminjamanmobil/approve/<?php echo $row->id; ?>"><button class="button-wrc" onclick="return confirm('Apa Anda Yakin Approve Mobil <?php echo $nama_mobil.' - '.$plat;; ?>?')">Approve</button></a> -->
            ...
            if($idpegawai == $id_mobil){

            ?>
    <button id="showModalBtn<?php echo $i; ?>" class="button-wrc">Approve(TTE)</button>
            <a href="peminjamanmobil/reject/<?php echo $row->id; ?>"><button class="button-wrc" onclick="return confirm('Apa Anda Yakin reject Mobil <?php echo $nama_mobil.' - '.$plat;; ?>?')">Reject</button></a>
...
<td>
  ...
  <?php if($row->status == 10){ ?>
    <span style="color:red;">Menunggu TTE peminjam</span>
  <?php } ?>
          </td>
          </tr>
          </table>
