  ...
  margin-top: 20px;
    ...
    <div id="content">
        <div class="post">
            ...
            <h2>Form Input Pulang</h2>

                <form action='/jelita/backoffice/peminjamanmobil/mobil_kembali_proses/<?php echo $id; ?>/<?php echo $id_pengawas; ?>' method="POST" enctype="multipart/form-data">                
                <label for="">Bensin Pulang</label>
                ...
                <input type="hidden" id="0" name="id_peminjam" value="<?php echo $id_peminjam; ?>" onchange="updateFuelLevel()">
                <br>
                
                <label for="">Bensin Kembali</label>
                <table>
                    <tr>
                        <td>
                            <span>0</span>
                ...
                <label for="">Catatan Pulang</label>
