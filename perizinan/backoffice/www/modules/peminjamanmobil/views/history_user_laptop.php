  ...
  <div class="post">
    ...
    <div class="entry"> 
      ...
      $ctk_list = array('name' => 'button',
                        ...
                        'value' => 'Back',
                        'class' => 'button-wrc',
                        'onclick' => 'parent.location=\''.site_url('peminjamanmobil/peminjaman_laptop').'\''
                       );
        ...
        <td valign='top'>
          ...
          <td>
            ...
            <img src="https://cdn-icons-png.flaticon.com/512/337/337946.png" alt="Preview Surat" title="Preview Surat Draft" border="0" width="25px"></a>
                ...
                ?>
            <a href="peminjamanmobil/kembali_laptop/<?php echo $row->id; ?>"><button class="button-wrc" title="Konfirmasi Kembalikan Mobil">Selesai</button></a>
            <?php
...
?>
    ...
    <!-- <button id="showModalBtn<?php echo $i; ?>" class="button-wrc"><img src="https://cdn.icon-icons.com/icons2/2622/PNG/512/gui_signature_icon_157586.png" alt="TTE" title="TTE" width="25px"></button> -->
    <a href="/jelita/backoffice/peminjamanmobil/edit_pemohonan/<?php echo $row->id; ?>" onclick="return confirm('Apa Anda Yakin Edit Mobil <?php echo $nama_mobil.' - '.$plat;; ?>?')">
    ...
    <form action="peminjamanmobil/update_multiple_laptop" method="post">
        <div id="myModal<?php echo $i; ?>" class="modal">
            <div class="modal-content">
                ...
                <center>
                    ...
                    <input type="hidden" value="<?php echo $row->id; ?>" name="id_permintaan_mobil">
...
?>
            ...
            ?>
            <a href="<?php echo $master_url; ?>/<?php echo $routees; ?>peminjamanmobil/hapus_pengajuan/<?php echo $row->id; ?>/1" title='batal'><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Antu_task-reject.svg/2048px-Antu_task-reject.svg.png" width='30px'></a>
            <?php 
          }elseif($row->status == 11){
            ?>
            <a href="<?php echo $master_url; ?>/<?php echo $routees; ?>persuratan/mobil/<?php echo $row->id; ?>"><button class="button-wrc">Kirim Surat</button></a>
            <?php
          }
            ?>
          </td>
