          ...
          <table cellpadding="0" cellspacing="0" border="0" class="display">
            <tbody>
              <tr>
                ...
                <td class="bg-grid">
                  <input type="text" name="nama_mobil" style="width:10%" class="input-wrc" required>
                </td>
              </tr>
              <tr>
                <td align="left" width="15%" class="bg-grid">
                ...
                <td class="bg-grid">
                  ...
                  <input type="hidden" name="ketegori_jenis" value="laptop">
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input type="text" name="plat" style="width:10%" class="input-wrc" required>
                </td>
              </tr>
              <tr>
                <td align="left" width="15%" class="bg-grid">
                ...
                <td class="bg-grid">
                  <input type="text" name="kapasitas" style="width:50%" class="input-wrc" required>
              ...
              <tr>
                ...
                <td>
                  <input type="number" name="tahun" style="width:10%; background-color: white;  border: 1px solid blue;" class="input-wrc" required>
                </td>
              </tr>
              <tr>
                <td align="left" width="15%" class="bg-grid">
                ...
                <td class="bg-grid">
                  <select class="pilihan" name="kondisi" style="width:20%" class="input-wrc" required onchange="showInput(this)">
                    <option value="-" >-</option>
                    <option value="0">Dalam Kondisi Tidak Baik (OFF)</span></option>
                    <option value="1">Dalam Kondisi Baik (ON)</span></option>
                  </select>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <input type="number" name="harga" style="width:10%; background-color: white;  border: 1px solid blue;" class="input-wrc"  required>
                </td>
              </tr>
              <tr>
                <td align="left" width="15%" class="bg-grid">
                ...
                <td class="bg-grid">
                  <input type="number" name="jumlah" style="width:10%; background-color: white;  border: 1px solid blue;" class="input-wrc"  required>
                </td>
              </tr>
              <!--    
              <tr>
              ...
              <tr>
                ...
                <td class="bg-grid">
                  <input type="text" name="kategori" style="width:50%" class="input-wrc" required>
                </td>
              </tr>
            </tbody>
          </table>
