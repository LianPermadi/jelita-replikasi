...
<div id="content">
  <div class="post">
    ...
    <div class="entry">
      <iframe src="https://dpmptsp.jabarprov.go.id/jelita/backoffice/peminjamanmobil/preview_peminjaman_mobil/<?php echo $id; ?>" height="590px" width="100%"></iframe>
      <!-- <a href="https://dpmptsp.jabarprov.go.id/schedule/"><button class="button-wrc">Full Screen</button></a> -->
      <h1>Fitur Jelita</h1>
      <!-- <img src="https://dpmptsp.jabarprov.go.id/jelita/backoffice/peminjamanmobil/preview_peminjaman_mobil/10654" width="100%"> -->
