...
<div id="content">
  <div class="post">
    <div class="title"> <?php echo $this->lib_date->view_title($page_name); ?> </div> <?php 
    ...
    ?> <table width="100%">
        ...
        <tr>
          <td bgcolor="#FFFBE7" width="25%">
            <form action="peminjamanmobil/check_mobil/mobil" method="post">
              <table>
                <tr>
                  <td>
        ...
        <tr>
          <td colspan="2">
                  <input type="hidden" name="kategori" value="mobil" class="input-wrc">
      ...
      ?> <h1 style="margin: 1px;">Pilih Mobil Untuk Mengetahui Jadwal Yang Tersedia</h1> <?php
    }
  }
      ...
      if($langkah != 1){
        ...
        $uniqueArray = array_unique($mergedArray);
              ...
              $tanggalsekarang = date('Y-m-d g:i:s');
                    ...
                    if($row->on_off == '1'){
          ?> <div>
              <figure class="snip1527" style="min-width: 270px; max-width: 270px;max-height: 440px;min-height: 440px;"> <?php if($row->foto == NULL || $row->foto == '0' || $row->foto == ''){ ?> <div class="image"><img src="https://asset.kompas.com/crops/NEY_Pu1nQSWRYWCMAJwBfI_kIEE=/76x50:800x533/750x500/data/photo/2023/01/06/63b7fd75d8678.jpg" alt="pr-sample23" style="min-width: 300px;max-width: 300px;max-height: 210px; min-height:210px; object-fit: cover; object-position: center;" />
                ...
                </div> <?php } ?> <figcaption style="height: 230px; width:100%;">
                  <div class="date"> <?php 
                  $kondisi = $row->kondisi; 
                  if($kondisi == '1'):
...
<span style="color:rgb(253,0,253); font-weight:bold; display:inline-block; animation: berjalan 5s linear infinite, jedagJedug 0.5s infinite alternate;">!!Mobil Khusus Dalam Kota!!</span>'.$ttp;
  ...
  if($langkah != '6'){
    ...
    if($kondisi == '1'){
      ?> <a href="peminjamanmobil/pinjam_mobil/<?php echo $row->id; ?>"></a> <?php
    }elseif($kondisi == '3'){ 
      ?> <a href="peminjamanmobil/pinjam_mobil/<?php echo $row->id; ?>"></a> <?php
    }elseif($anggota_tim){
      ?> <a href="peminjamanmobil/pinjam_mobil/<?php echo $row->id; ?>"></a> <?php }else{ ?> <a href="peminjamanmobil/detail_mobil/<?php echo $row->id; ?>" target="_blank"></a> <?php
    }
  }else{
