...
<div id="content">
    <div class="post">
        ...
        <div class="entry">
            <div id="tabs">
                <ul>
                    <li><a href="#tabs-1">Input Peminjaman Mobil</a></li>
                </ul>
                <div id="tabs-1">
                    <form action="<?php echo '/'.$routees; ?>peminjamanmobil/pinjammobil/<?php echo $id; ?>" method="post" enctype="multipart/form-data">
                        <table cellpadding="0" cellspacing="0" border="0" class="display">
                            <tbody>
                                ...
                                ?>
                                <h4>Merk Kendaraan : <?php echo $row->nama_mobil; ?></h4>
                                <h4>Nomor Polisi : <?php echo $row->plat; ?></h4>
                                <h4>Tahun Kendaraan : <?php echo $row->tahun; ?></h4>
                                <h4>Jenis : <?php echo $row->jenis; ?></h4>
                                <h4>Bahan Bakar : <?php echo $row->bahan_bakar; ?></h4>
                                <h4>Kapasitas Angkutan : <?php echo $row->kapasitas; ?></h4>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <select name="bagian" id="select-bidang" class="input-wrc" onchange="toggleInputLainnya(this)">
                                        ...
                                        <!-- Input bidang manual, sembunyi dulu -->
                                        <input type="text" name="bagian_lainnya" id="input-lainnya" class="input-wrc" placeholder="Tulis bidang lainnya..." style="display:none; margin-top:5px;" />
                                        <script>
