...
//		$hari = $libur->where("date >= '$tgl_entry' and date <= '$tgl_selesai'")->count();
	...
	//	$durasi = $lama_hari - $hari_libur;
							...
							<div id="statusRail" style="font-weight: bold">
                                ...
                                <div id="rightRail" class="bg-grid">
                                    <?php echo $this->lib_date->mysql_to_human($tgl_sk); ?>
                                </div>
                            </div>
                    ...
                    <div id="tabs-1">
                        <div id="contentleft">
							...
							<table cellpadding="0" cellspacing="0" border="0" class="display">
								...
								echo "<tr>";
							    echo "<td align='left'    valign='top' width='22%'><b>".'Nomor Kontak Perantara'."</b></td>"."";
							    echo "<td align='left'    valign='top' width='2%'><b>".': '."</b></td>"."";
...
//                                            echo $total_hari."<br>";
                    ...
                    <div id="tabs-6">
                        ...
                        ?>
                            <div style="text-align:center">
                                <?php
							    if($stat_posisi) $item_combo = $nama_file;
                                $image_properties = array(
                                    'src' => base_url().'doc-izin/'.$item_combo,
        ...
        <div class="entry" style="text-align: center;">
            ...
            switch ($asal_menu) {
                ...
                case 3; // dari menu Laporan/Rekapitulasi Perizinan/List data perizinan
                    $link = site_url('rekapitulasi/izin/list_data_next');
    				$text = 'Kembali';
                    break;
				case 4; // dari menu Permohonan/Views/sk_list
    				...
    				$text = 'Kembali';
                    break;
				case 5; // belum dipakai {buat case berurutan}
                    break;
            }
