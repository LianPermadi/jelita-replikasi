...
<img src="<?php echo base_url().'assets/images/icon/Logo_tasikmalaya_Clr.png' ?>" width="90%" height="100%">
   ...
   <center style="font-size : 14px; font-weight: bold;"> <br>PEMERINTAH PROVINSI TASIKMALAYA<br> 
...
<center>Nomor : <?php echo $NOMOR_KP;?></center>
<p>Berdasarkan Keputusan Kadis Penanaman Modal dan Pelayanan terpadu Satu Pintu Kabupaten Tasikmalaya <br>Nomor: <?php echo $NO_SK;?> tanggal <?php echo tanggal_indo($TG_MULAI);?> tentang Izin Trayek Angkutan Penumpang Umum, diberikan Kartu Pengawasan kepada  <?php echo $NAMA_PERUS; ?> yang dipimpin oleh <?php echo $NAMA_PEMIL;?> alamat <?php echo $ALAMAT_PEM; ?> Dari Tanggal <?php echo tanggal_indo($TG_MULAI);?> sampai dengan tanggal <?php echo tanggal_indo($TG_AKHIR);?> <br>
