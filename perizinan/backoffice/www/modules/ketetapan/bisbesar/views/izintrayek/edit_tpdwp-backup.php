...
function goBack() {
 ...
 <label>NAMA PERUSAHAAN</label>: <?php echo $NAMA_PERUS; ?>
             <input type="hidden" name ="" class="form-control" value="<?php echo $NAMA_PERUS; ?>" readonly required>  
             <br style="clear: both" />
             <label>ALAMAT</label> : <?php echo $ALAMAT_PER;?>
             <input type="hidden" style="width: 600px;" name ="" class="form-control" value="<?php echo $ALAMAT_PER; ?>" readonly required>
           <!-- <textarea  class="input-area-wrc" name = "ALAMAT_PER" readonly="true"><?php echo $ALAMAT_PER;?></textarea>-->
             ...
             <input type="hidden" name ="" class="form-control" value="<?php echo $NO_MOBIL; ?>" readonly required> <!--&nbsp; / &nbsp; -->
               <input type="hidden" name ="" class="form-control" value="<?php echo $NO_UJI; ?>" readonly required>
             <br style="clear: both" />
             ...
             <input type="hidden"  name ="" class="form-control" value="<?php echo tanggal_indo($TG_MULAI); ?>" readonly required>
              s/d 
             <input type="hidden" name ="" class="form-control" value="<?php echo tanggal_indo($TG_AKHIR);?>" readonly required>
             <br style="clear: both" />

             <label>KODE TRAYEK </label>:  <?php echo $KODE_TRAYE; ?> - <?php echo $NAMA_TRAYE;?>
             <input type="hidden" name ="" class="form-control" value="<?php echo $KODE_TRAYE; ?>" readonly required>
             <br style="clear: both" />
            ...
            <label>NO SK </label> : <?php echo  $NO_SK; ?>
             <input type="hidden" name ="" class="form-control" value="<?php echo  $NO_SK; ?>" readonly required>
             <br style="clear: both" />

             <label>TANGGAL SK </label> : <?php echo $TG_SK; ?>
             <input type="hidden" name ="" class="form-control" value="<?php echo $TG_SK; ?>" readonly required>
             <br style="clear: both" />
...
<script type='text/javascript'>
 var u = jQuery.noConflict();
   ...
   <input type="text" name="TERMINAL_I" id="<?php echo $y;?>" readonly="true" style=" width:50px;" value="<?php echo $u2->TERMINAL_I; ?>">
<input type="text" name="NAMA_TERM3" class='<?php echo $y;?>' id="autocomplete1" style=" width:150px;" value="<?php echo $u2->NAMA_TERM3;  ?>">
            </td>
...
<input name="KP_ID" value="<?php echo $u2->KP_ID;?>" type="hidden" style=" width:40px;">
         <input name="PP1_1" value="<?php echo $u2->PP1_1;?>"  id="<?php echo 'pp1_1'.$y;?>" type="text" style=" width:40px;">
<span id="<?php echo 'pesan'.$y;?>"></span>
         </td>
            <td><input name="PP1_2" value="<?php echo $u2->PP1_2;?>" id="<?php echo 'pp1_2'.$y;?>" type="text" style=" width:40px;">
                <span id="<?php echo 'pesan1_2'.$y;?>"></span>
            </td>
            <td>
                <input name="PP2_1" value="<?php echo $u2->PP2_1;?>" id="<?php echo 'pp2_1'.$y;?>" type="text" style=" width:40px;">
                <span id="<?php echo 'pesan2_1'.$y;?>"></span>
            </td>
            <td>
                <input name="PP2_2" value="<?php echo $u2->PP2_2;?>" id="<?php echo 'pp2_2'.$y;?>" type="text" style=" width:40px;">
                <span id="<?php echo 'pesan2_2'.$y;?>"></span>
            </td>
            <td>
                <input name="PP3_1" value="<?php echo $u2->PP3_1;?>" id="<?php echo 'pp3_1'.$y;?>" type="text" style=" width:40px;">
                 <span id="<?php echo 'pesan3_1'.$y;?>"></span>

            </td>
            <td>
                <input name="PP3_2" value="<?php echo $u2->PP3_2;?>" id="<?php echo 'pp3_2'.$y;?>" type="text" style=" width:40px;">
                <span id="<?php echo 'pesan3_2'.$y;?>"></span>
            </td>
            <td>
                <input name="PP4_1" value="<?php echo $u2->PP4_1;?>" type="text" id="<?php echo 'pp4_1'.$y;?>" style=" width:40px;">
                <span id="<?php echo 'pesan4_1'.$y;?>"></span>
            </td>
                <td><input name="PP4_2" value="<?php echo $u2->PP4_2;?>" id="<?php echo 'pp4_2'.$y;?>" type="text" style=" width:40px;">
                <span id="<?php echo 'pesan4_2'.$y;?>"></span>
            </td>
            <td>
                <input name="PP5_1" value="<?php echo $u2->PP5_1;?>" id="<?php echo 'pp5_1'.$y;?>" type="text" style=" width:40px;">
                <span id="<?php echo 'pesan5_1'.$y;?>"></span>
            </td>
            <td>
                <input name="PP5_2" value="<?php echo $u2->PP5_2;?>" id="<?php echo 'pp5_2'.$y;?>" type="text" style=" width:40px;">
                <span id="<?php echo 'pesan5_2'.$y;?>"></span>
            </td>
            <td>
                <input name="PP6_1" value="<?php echo $u2->PP6_1;?>" id="<?php echo 'pp6_1'.$y;?>" type="text" style=" width:40px;">
                <span id="<?php echo 'pesan6_1'.$y;?>"></span>
            </td>
            <td>
                <input name="PP6_2" value="<?php echo $u2->PP6_2;?>" id="<?php echo 'pp6_2'.$y;?>" type="text" style=" width:40px;">  
...
<input type="text" name="xTERMINAL_I" id="t" readonly="true" style=" width:50px;">
        ...
        <input name="xJARAK" type="text" style=" width:40px;" ></td>
            <td><!--<input name="xPP1_1" type="text" class='autocompletex' id="autocomplete1x" style=" width:40px;">-->
            <input name="xPP1_1" type="text"  id="a1" style=" width:40px;"><br>
 <span style="color:red; width:40px" style="color:red;" id="p1"></span>  
            </td>
            <td><!--<input name="xPP1_2" class="auto_PP1_2" type="text" style=" width:40px;">-->
                <input name="xPP1_2" id="a2" type="text" style=" width:40px;">
                <span style="color:red;"" id="p2"></span>  

            </td>
            <td><input name="xPP2_1" id="a3"  type="text" style=" width:40px;"> <span style="color:red; " id="p3"></span></td>
            <td><input name="xPP2_2" id="a4" type="text" style=" width:40px;"> <span style="color:red; " id="p4"></span></td>
            <td><input name="xPP3_1" id="a5" type="text" style=" width:40px;"> <span style="color:red; " id="p5"></span></td>
            <td><input name="xPP3_2" id="a6" type="text" style=" width:40px;"> <span style="color:red; " id="p6"></span></td>
            <td><input name="xPP4_1" id="a7" type="text" style=" width:40px;"> <span style="color:red; " id="p7"></span></td>
            <td><input name="xPP4_2" id="a8" type="text" style=" width:40px;"> <span style="color:red; " id="p8"></span></td>
            <td><input name="xPP5_1" id="a9" type="text" style=" width:40px;"> <span style="color:red; " id="p9"></span></td>
            <td><input name="xPP5_2" id="10" type="text" style=" width:40px;"> <span style="color:red; " id="p10"></span></td>
            <td><input name="xPP6_1" id="11" type="text" style=" width:40px;"> <span style="color:red;" id="p11"></span></td>
            <td><input name="xPP6_2" id="12" type="text" style=" width:40px;"> <span style="color:red;" id="p12"></span></td>
            <td>
