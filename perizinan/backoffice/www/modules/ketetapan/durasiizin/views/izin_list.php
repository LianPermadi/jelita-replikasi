...
<!--                    <tr>
                        ...
                        <td align="right"> <?php echo anchor(site_url('durasiizin/izin/pick_pendaftar_list'.'/'.$data->id), $juma+$jumb+$jumx, 'class="link2-wrc" rel="pendaftar_box"');?></td>
                        <td align="right"><?php echo anchor(site_url('durasiizin/izin/pick_pendaftar2_list'.'/'.$data->id),$juma,'class="link2-wrc" rel="pendaftar_box"');?></td>
                        <td align="right"><?php echo $jumc;?></td>
                        <td align="right"><?php echo $juma - $jumc;?></td>
                        <td align="right">&nbsp;</td>
                        <td align="right"><?php echo anchor(site_url('durasiizin/izin/pick_pendaftar3_list'.'/'.$data->id),$jumb,'class="link2-wrc" rel="pendaftar_box"');?></td>
