                  ...
                  <tbody>
                    ...
                    <!-- <tr>
                      ...
                      <tr>
                        ...
                        <td class="bg-grid">
                          <?php 
                            if (file_exists('assets/pdf-surat-masuk/SRT_'.$id.'.pdf')) {
                              echo "<a href='".base_url()."persuratan/unduh_masuk/".$id."' style='color:blue;' target='_blank' title='Unduh Berkas'>Berkas Siap</a>&nbsp;"; ?>
                              <button name="button" type="button" class="button-wrc" onclick="if (confirm('Yakin Hapus Berkas Docx?')) parent.location='<?php echo base_url(). "persuratan/hapus_masuk/".$id; ?>'">X</button>
                            <?php 
                            } else { ?>
                              <input type="file" name="file_srt" id="fileToUpload" class="submit-wrc" value="Pilih file" accept=".pdf" required>
                            <?php } ?>
                        </td>
                      </tr>
                  </tbody>
