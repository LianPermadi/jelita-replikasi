...
<html>
<head>
<title>Daftar Rekap Izin Terbit</title>
</head>
...
<body>
    ...
    <div class="post">
		...
		?>
		 ...
		 <h2><b><?php echo $page_name;  echo ' Bidang :  '; echo $a;?></b></h2>
        ...
        <tr align="left">
         ...
         $Back_data = array(
           ...
           $img_word= array(
                                                ...
                                                'alt' => 'Cetak Ke word',
                                                'title' => 'Cetak Ke word',
                                                 'onclick' => 'parent.location=\''. site_url('kinerjasemuabidang/lwizinterbit').'/'.$bidangizin .'/'.$tgla.'/'.$tglb.'\''
                                            );
                                            echo img($img_word);
											  $img_excel = array(
                                               ...
                                               'onclick' => 'parent.location=\''. site_url('kinerjasemuabidang/leizinterbit').'/'.$bidangizin .'/'.$tgla.'/'.$tglb.'\''
                                            );
                                            echo img($img_excel);
