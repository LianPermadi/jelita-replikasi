<?php
    ...
    header("Content-disposition: attachment; filename=Tingkat Penyelesaian Perjenis Perizinan $tgla-$tglb.xls");
...
<body>
    ...
    <div class="post">
		...
		<div align="center"><font size="12px"><b>
		<?php 
		echo br();
		 $img_cetak = array(
...
<form name="form1" method="post">
    ...
    <table width="80%" cellpadding="1" cellspacing="0" border="1" class="display" id="report">
	<thead>
        <tr bgcolor="#d5dffe">
