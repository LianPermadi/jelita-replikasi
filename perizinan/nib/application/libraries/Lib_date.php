...
// var_dump(query($sql, array($id, $tglawal, $tglakhir)));die();
  ...
  // Public function postWaSms($n_hp=null,$n_pesan=null){
  ...
  //     $url = 'http://103.122.5.111/eskalasi/public/messaging/request?username='.$username.'&password='.$password.'&sender=DPMPTSP+JBR&msisdn='.$receiver.'&message='.$message;
  ...
  //      	    return;
  //         }else{
  //           echo "Ada Yang Error Kirim SMS Gan: " . $json->message . " " . $json->status;die;
  //         }
  //       }
  //     }
  //   }
