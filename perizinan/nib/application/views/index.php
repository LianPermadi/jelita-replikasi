...
// var_dump($_SERVER['REQUEST_URI'].'/home/proses_form');die();
?>

<form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>home/proses_form" enctype="multipart/form-data">
...
document.getElementById('layanan').addEventListener('change', function () {
    ...
    // Periksa apakah elemen ada sebelum mengakses properti
    if (nibInput && AgenNib) {
        if (selectedOption === "Pelayanan Pembuatan Nomor Induk Berusaha(NIB)(Tidak Langsung)" ||
            selectedOption === "Gerakan Pelayanan Terpadu (GPT)") {
        ...
        console.error("Elemen dengan ID 'nib_input' atau 'agen_nib_kondisi' tidak ditemukan.");
    }
});
